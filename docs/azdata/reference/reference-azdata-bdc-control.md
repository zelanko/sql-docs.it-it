---
title: Informazioni di riferimento su azdata bdc control
titleSuffix: SQL Server big data clusters
description: Usare questo articolo di riferimento per comprendere i comandi SQL dello strumento azdata, in particolare il comando bdc control.
author: MikeRayMSFT
ms.author: mikeray
...
| Comando | Descrizione |
| --- | --- |
[azdata bdc control status](reference-azdata-bdc-control-status.md) | Comandi relativi allo stato del servizio di controllo.
