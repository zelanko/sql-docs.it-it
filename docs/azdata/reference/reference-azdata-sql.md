...
| Comando | Descrizione |
| --- | --- |
[azdata sql shell](#azdata-sql-shell) | L'interfaccia della riga di comando dei database SQL consente agli utenti di interagire con SQL Server via T-SQL.
[azdata sql query](#azdata-sql-query) | Il comando di query consente l'esecuzione di una query T-SQL.
## <a name="azdata-sql-shell"></a>azdata sql shell
L'interfaccia della riga di comando dei database SQL consente agli utenti di interagire con SQL Server via T-SQL.
```bash
azdata sql shell 
```
