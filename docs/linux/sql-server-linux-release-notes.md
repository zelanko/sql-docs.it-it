...
- Rilasciare gli aggiornamenti per la versione GA di [!INCLUDE[ssSQL17](../includes/sssql17-md.md)] sono supportati solo da CTP 2.1 o versione successiva. 
