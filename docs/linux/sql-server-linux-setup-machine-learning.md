...
ms.locfileid: "70913556"
---
# <a name="install-sql-server-machine-learning-services-r-python-on-linux"></a>Installare SQL Server Machine Learning Services (R, Python) in Linux
