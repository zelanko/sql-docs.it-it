...
- Assicurarsi che siano soddisfatti i requisiti minimi di memoria e disco specificati nella [prerequisiti](quickstart-install-connect-docker.md#requirements) sezione dell'articolo della Guida introduttiva.
