---
title: SQLSetConnectOption (driver di Excel) Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|SQL_AUTOCOMMIT|Il driver di Microsoft Excel supporta solo SQL_AUTOCOMMIT impostato su ON (stato predefinito), perché non supporta le transazioni.|  
