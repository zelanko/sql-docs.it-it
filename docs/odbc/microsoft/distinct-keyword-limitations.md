---
title: Limitazioni della parola chiave DISTINCT | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "63128062"
---
# <a name="distinct-keyword-limitations"></a>Limitazioni della parola chiave DISTINCT
Non è supportato per i campi di testo lungo (Microsoft Access) o i campi di tipo Memo (dBASE).
