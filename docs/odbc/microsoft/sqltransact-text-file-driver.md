---
description: SQLTransact (driver file di testo)
title: SQLTransact (driver file di testo) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88339685"
---
# <a name="sqltransact-text-file-driver"></a>SQLTransact (driver file di testo)
> [!NOTE]  
