---
title: Opzioni supportate (driver ODBC per Oracle) Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
>  Questa funzionalità verrà rimossa in una versione futura di Windows. Evitare di usare questa funzionalità in un nuovo progetto di sviluppo e prevedere interventi di modifica nelle applicazioni in cui è attualmente implementata. Utilizzare invece il driver ODBC fornito da Oracle.  
 ...
 Il driver ODBC per Oracle supporta le opzioni seguenti per le funzioni SQLGetConnectOption( ) e SQLSetConnectOption( ) livello 1:  
...
-   [SQL_TXN_ISOLATION](../../odbc/microsoft/connect-options.md)  
 ...
 Il driver ODBC per Oracle supporta le opzioni seguenti per le funzioni SQLGetStmtOption( ) e SQLSetStmtOption( ) livello 1:  
