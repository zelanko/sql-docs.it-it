...
|*SzTableType*|"TABLE" è l'unico tipo di tabella supportato.<br /><br /> Quando si usa il driver di testo, l'elenco dei file restituite da **SQLTables** è determinato dalle estensioni per il file nei **elenco di estensioni** nella casella il **il programma di installazione di ODBC testo** nella finestra di dialogo.|
