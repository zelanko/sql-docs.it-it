...
## <a name="specifying-the-file-name"></a>Specifica del nome file  
 La prima voce nel Schema.ini è sempre il nome del file di origine del testo racchiuso tra parentesi quadre. Nell'esempio seguente viene illustrata la voce per il file Sample.txt:  
