---
description: Valori restituiti da SQLGetInfo per Access
title: Valori restituiti da SQLGetInfo per l'accesso | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
