 ...
 **descrittore di parametro**  
 Descrittore che descrive i parametri della fase di esecuzione utilizzati in un'istruzione SQL, prima di qualsiasi conversione specificata dall'applicazione (un descrittore di parametri dell'applicazione o APD) o dopo una conversione specificata dall'applicazione (un'implementazione di descrittore di parametro o dpi).  
