...
|--------------|--------------|---------------------------------------------------------------|--------------------------------------------------------------|  
|**SQLColumnPrivileges**|*CatalogName* *SchemaName* *TableName TableName* *ColumnName*|OA OA PV|ID ID ID|  
|**SQLColumns**|*CatalogName* *SchemaName* *TableName TableName* *ColumnName*|PV PV PV PV|ID ID ID|  
