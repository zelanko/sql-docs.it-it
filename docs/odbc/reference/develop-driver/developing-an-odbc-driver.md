...
-   [Aggiornamento da un driver 3.5 a un driver 3.8](../../../odbc/reference/develop-driver/upgrading-a-3-5-driver-to-a-3-8-driver.md)  
...
-   [Notifica del completamento di funzioni asincrone](../../../odbc/reference/develop-driver/notification-of-asynchronous-function-completion.md)
