...
|da 96 a 100|SQL_NO_DATA|No.|0|  
|da 99 a 100|SQL_NO_DATA|No.|0|  
...
|SQL_ROW_ADDED[4]|La riga è stata inserita da **SQLBulkOperations**. Se la riga viene recuperata di nuovo da questo set di risultati o viene aggiornata da **SQLSetPos**, il relativo stato è SQL_ROW_SUCCESS.|  
...
|----------------------|-----------|--------------|-----------------|  
|SQL_DESC_ARRAY_SIZE|ARD|Intestazione|Attributo dell'istruzione SQL_ATTR_ROW_ARRAY_SIZE|  
|SQL_DESC_ARRAY_STATUS_PTR|IRD|Intestazione|Attributo dell'istruzione SQL_ATTR_ROW_STATUS_PTR|  
|SQL_DESC_BIND_OFFSET_PTR|ARD|Intestazione|Attributo dell'istruzione SQL_ATTR_ROW_BIND_OFFSET_PTR|  
|SQL_DESC_BIND_TYPE|ARD|Intestazione|Attributo dell'istruzione SQL_ATTR_ROW_BIND_TYPE|  
...
|SQL_DESC_ROWS_PROCESSED_PTR|IRD|Intestazione|Attributo dell'istruzione SQL_ATTR_ROWS_FETCHED_PTR|  
