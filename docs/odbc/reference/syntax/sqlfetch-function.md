...
|---------------|-----------------------------|  
|Prima dell'avvio|1|  
|** \<CurrRowsetStart =  *LastResultRow-RowsetSize*[1]|** + *RowsetSize*CurrRowsetStart [2]|  
...
|SQL_DESC_DATA_PTR|ARD|records|Argomento *TargetValuePtr* di **SQLBindCol**|  
|SQL_DESC_INDICATOR_PTR|ARD|records|Argomento *StrLen_or_IndPtr* in **SQLBindCol**|  
|SQL_DESC_OCTET_LENGTH|ARD|records|Argomento *bufferLength* in **SQLBindCol**|  
|SQL_DESC_OCTET_LENGTH_PTR|ARD|records|Argomento *StrLen_or_IndPtr* in **SQLBindCol**|  
|SQL_DESC_ROWS_PROCESSED_PTR|IRD|intestazione|Attributo SQL_ATTR_ROWS_FETCHED_PTR Statement|  
|SQL_DESC_TYPE|ARD|records|Argomento *targetType* in **SQLBindCol**|  
