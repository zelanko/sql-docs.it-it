---
description: Funzione SQLNumParams
 ...
 **SQLNumParams** può essere chiamato solo dopo la chiamata di **SQLPrepare** .  
 ...
 Il numero di parametri restituiti da **SQLNumParams** è lo stesso valore del campo SQL_DESC_COUNT di dpi.  
