 ...
 **Riepilogo**  
 In ODBC 3 *. x*, la funzione ODBC 2.0 **SQLFreeConnect** è stata sostituita da **SQLFreeHandle**. Per altre informazioni, vedere [SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md).  
