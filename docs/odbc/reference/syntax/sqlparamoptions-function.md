---
title: Funzione SQLParamOptions | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **Riepilogo**  
 La funzione ODBC 2.0 **SQLParamOptions** è stata sostituita in ODBC 3. *x* dalle chiamate a [SQLSetStmtAttr](../../../odbc/reference/syntax/sqlsetstmtattr-function.md).  
