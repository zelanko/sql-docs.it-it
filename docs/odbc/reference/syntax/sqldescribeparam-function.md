 ...
 *NullablePtr*  
 Output Puntatore a un buffer in cui restituire un valore che indica se il parametro ammette valori NULL. Questo valore viene letto dal campo SQL_DESC_NULLABLE del dip. Uno dei seguenti:  
