...
|**DAYOFMONTH(** *date_exp* **)** (ODBC 1.0)|Restituisce il giorno del mese in base al campo mese nel *date_exp* come valore intero compreso tra 1 e 31.|  
|**DAYOFWEEK(** *date_exp* **)** (ODBC 1.0)|Restituisce il giorno della settimana in base al campo della settimana in *date_exp* come valore intero compreso nell'intervallo da 1 a 7, dove 1 corrisponde a domenica.|  
|**DAYOFYEAR(** *date_exp* **)** (ODBC 1.0)|Restituisce il giorno dell'anno di base il campo year *date_exp* come valore intero compreso tra 1 e 366.|  
