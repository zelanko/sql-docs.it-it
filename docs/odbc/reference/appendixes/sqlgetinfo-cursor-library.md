---
description: SQLGetInfo (libreria di cursori)
...
|SQL_GETDATA_EXTENSIONS|SQL_GD_BLOCK &#124; i valori restituiti dal driver **Nota:**  quando i dati vengono recuperati con **SQLFetchScroll**, **SQLGetData** supporta la funzionalità specificata con le maschere di SQL_GD_ANY_COLUMN e SQL_GD_BOUND.|  
