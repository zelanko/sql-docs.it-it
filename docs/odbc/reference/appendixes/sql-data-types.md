...
|SQL_LONGVARCHAR|LONG VARCHAR|Dati di tipo carattere a lunghezza variabile. La lunghezza massima dipende dall'origine dati. 9|  
...
|SQL_WLONGVARCHAR|LONGWVARCHAR|Dati di tipo carattere a lunghezza variabile Unicode. La lunghezza massima dipende dall'origine dati|  
