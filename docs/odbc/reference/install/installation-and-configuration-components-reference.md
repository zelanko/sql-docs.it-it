---
description: Informazioni di riferimento sui componenti di installazione e di configurazione
title: Informazioni di riferimento sui componenti di installazione e configurazione | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88499794"
---
# <a name="installation-and-configuration-components-reference"></a>Informazioni di riferimento sui componenti di installazione e di configurazione
> [!NOTE]  
>  A partire da Windows XP e Windows Server 2003, ODBC è incluso nel sistema operativo Windows. È consigliabile installare solo in modo esplicito ODBC nelle versioni precedenti di Windows.  
 ...
 Nelle sezioni seguenti vengono fornite informazioni sui componenti utilizzati per installare e configurare ODBC.  
