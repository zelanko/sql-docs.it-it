---
title: DLL di installazione di Microsoft Translator | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
>  A partire da Windows XP e Windows Server 2003, ODBC è incluso nel sistema operativo Windows. Solo nelle versioni precedenti di Windows è necessario installare ODBC in modo esplicito.  
 ...
 Il programma di installazione di Microsoft translator DLL è scritta dallo sviluppatore di Microsoft translator. Può essere parte del convertitore file DLL o una DLL separata.
