...
|CONFIGDSN *nome_driver* DSN =*name* &#124; *attributi*|Aggiunge o modifica un'origine dati di sistema.<br /><br /> Equivalente per la [funzione SQLConfigDataSource](../odbc/reference/syntax/sqlconfigdatasource-function.md).<br /><br /> Ad esempio:<br /><br /> /A {CONFIGDSN "SQL Server" "DSN = nome &#124; Server = srv"}|  
|CONFIGSYSDSN *nome_driver* DSN =*name* &#124; *attributi*|Aggiunge o modifica un'origine dati di sistema.<br /><br /> Equivalente per la [funzione SQLConfigDataSource](../odbc/reference/syntax/sqlconfigdatasource-function.md).<br /><br /> Ad esempio:<br /><br /> /A {CONFIGSYSDSN "SQL Server" "DSN = nome &#124; Server = srv"}|  
