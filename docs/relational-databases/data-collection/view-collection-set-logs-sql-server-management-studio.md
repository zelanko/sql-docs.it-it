---
title: Visualizzare i log dei set di raccolta (SSMS)
...
ms.locfileid: "74056428"
---
# <a name="view-collection-set-logs-sql-server-management-studio"></a>Visualizzare i log dei set di raccolta (SQL Server Management Studio)
