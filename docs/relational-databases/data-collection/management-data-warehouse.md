...
description: Il data warehouse di gestione in SQL Server è un database relazionale che contiene i dati raccolti da un server di destinazione.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
