...
## <a name="sql_copt_ss_oldpwd"></a>SQL_COPT_SS_OLDPWD  
 ...
 Per ulteriori informazioni, vedere [modifica delle password a livello di codice](../../relational-databases/native-client/features/changing-passwords-programmatically.md).  
