---
title: Gruppi di disponibilità Always On funzioni (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
---
# <a name="always-on-availability-groups-functions-transact-sql"></a>Gruppi di disponibilità Always On funzioni (Transact-SQL)
