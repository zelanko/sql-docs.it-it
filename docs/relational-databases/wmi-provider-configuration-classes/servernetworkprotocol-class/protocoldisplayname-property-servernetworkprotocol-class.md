---
description: Proprietà ProtocolDisplayName (classe ServerNetworkProtocol)
title: Proprietà ProtocolDisplayName (ServerNetworkProtocol)
...
ms.locfileid: "88446203"
---
# <a name="protocoldisplayname-property-servernetworkprotocol-class"></a>Proprietà ProtocolDisplayName (classe ServerNetworkProtocol)
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sqlserver.md)]
  Ottiene il nome visualizzato del protocollo di rete del server.  
...
## <a name="property-valuereturn-value"></a>Valore proprietà/Valore restituito  
 Valore string che specifica il nome visualizzato del protocollo di rete del server.  
