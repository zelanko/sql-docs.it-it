...
## <a name="property-valuereturn-value"></a>Valore proprietà/Valore restituito  
 Oggetto **uint32** valore che specifica la posizione della proprietà avanzata nella matrice di proprietà avanzate che appartiene al servizio di cui viene fatto riferimento.  
