---
description: Proprietà PropertyIndex (classe SqlServiceAdvancedProperty)
title: Proprietà PropertyIndex (SqlServiceAdvancedProperty)
...
## <a name="property-valuereturn-value"></a>Valore proprietà/Valore restituito  
 Valore **UInt32** che specifica la posizione della proprietà avanzata nella matrice di proprietà avanzata che appartiene al servizio a cui si fa riferimento.  
