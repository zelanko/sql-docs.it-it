...
description: Individuare e implementare le funzionalità fornite da Strumentazione gestione Windows. Per Configuration Manager, scegliere una di queste classi.
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
