...
description: Informazioni su come srv_setcollen specifica la lunghezza corrente dei dati in byte di una colonna a lunghezza variabile o di una colonna che consente valori NULL.
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
