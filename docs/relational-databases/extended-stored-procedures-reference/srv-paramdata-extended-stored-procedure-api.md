...
description: Informazioni sulle srv_paramdata. srv_paramdata restituisce il valore di un parametro di chiamata stored procedure remoto.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
