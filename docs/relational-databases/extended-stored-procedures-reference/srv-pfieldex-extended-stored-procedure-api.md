...
description: Informazioni su come srv_pfieldex nell'API della stored procedure estesa restituisce un puntatore ai dati che contengono il campo di SRV_PROC richiesto.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
