...
description: Informazioni sul modo in cui srv_paramlen nell'API della stored procedure estesa restituisce la lunghezza dei dati di un parametro di chiamata stored procedure remoto.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
