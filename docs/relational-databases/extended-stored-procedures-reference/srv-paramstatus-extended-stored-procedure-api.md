...
description: Informazioni su come srv_paramstatus restituisce lo stato di un determinato parametro di chiamata stored procedure remoto.
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
