...
description: SQL Server programmazione CLR non consente un tipo o un membro con determinati valori per l'enumerazione HostProtectionResource. Questo articolo elenca i valori non consentiti di System. dll.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
