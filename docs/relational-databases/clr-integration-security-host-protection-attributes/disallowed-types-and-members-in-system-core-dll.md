...
description: SQL Server programmazione CLR non consente un tipo o un membro con alcuni valori per l'enumerazione HostProtectionResource. Questo articolo elenca System.Core.dll valori non consentiti.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
