...
description: Il Common Language Runtime (CLR) fornisce un meccanismo per annotare le API (Application Programming Interface) gestite che fanno parte del .NET Framework con determinati attributi.
