---
description: Recupero delle informazioni sugli errori (provider OLE DB Native Client)
title: Recupero delle informazioni sugli errori (provider OLE DB Native Client)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88475770"
---
# <a name="retrieving-error-information-native-client-ole-db-provider"></a>Recupero delle informazioni sugli errori (provider OLE DB Native Client)
