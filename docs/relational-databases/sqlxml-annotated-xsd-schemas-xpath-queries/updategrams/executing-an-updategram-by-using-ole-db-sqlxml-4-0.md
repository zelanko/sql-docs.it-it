...
```  
 ...
 Il modello include una query SQL. La query richiede un valore per il parametro (@Title). Se per il parametro non viene passato alcun valore, verrà utilizzato il valore predefinito ("Mr.").  
