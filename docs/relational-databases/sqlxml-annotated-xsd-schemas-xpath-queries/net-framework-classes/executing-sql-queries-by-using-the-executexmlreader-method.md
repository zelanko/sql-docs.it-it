...
description: Informazioni su come eseguire query SQL utilizzando il metodo ExecuteXmlReader dell'oggetto SqlXmlCommand per eseguire comandi.
ms.date: 03/14/2017
ms.prod: sql
