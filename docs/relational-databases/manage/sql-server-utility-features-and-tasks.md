...
description: Acquisire familiarità con Utilità SQL Server. Informazioni sulle funzionalità e su come usare l'utilità per monitorare un ambiente SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
|Viene descritto come risolvere i problemi relativi a Utilità SQL Server.|[Attività e funzionalità di Utilità SQL Server](/previous-versions/sql/sql-server-2016/ee210592(v=sql.130))|  
