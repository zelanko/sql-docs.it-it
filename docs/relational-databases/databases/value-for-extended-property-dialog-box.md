...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  Usare la finestra di dialogo **Valore per** _\<<nome proprietà_ per immettere o visualizzare un valore. È possibile accedere a questa finestra di dialogo da diverse posizioni.  
