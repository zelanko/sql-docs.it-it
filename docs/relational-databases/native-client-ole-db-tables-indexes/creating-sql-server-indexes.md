...
ms.locfileid: "81301662"
---
# <a name="creating-sql-server-indexes"></a>Creazione di indici SQL Server
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  Il [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] provider OLE DB Native Client espone la funzione **IIndexDefinition::CreateIndex,** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] consentendo ai consumer di definire nuovi indici nelle tabelle.  
 ...
 Il *pIndexID* parametro può essere NULL [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] e, in caso affermativo, il provider OLE DB Native Client crea un nome univoco per l'indice. Il consumer può acquisire il nome dell'indice specificando un puntatore valido a un DBID nel parametro *ppIndexID*.  
 ...
 Il [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] provider OLE DB [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client e supportano l'ordine crescente sui valori nell'indice. Il [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] provider OLE DB Native Client restituisce E_INVALIDARG se il consumer specifica DBINDEX_COL_ORDER_DESC in qualsiasi struttura DBINDEXCOLUMNDESC.  
  
 **CreateIndex** interpreta le proprietà di indice come segue.  
  
|ID proprietà|Descrizione|  
|-----------------|-----------------|  
|DBPROP_INDEX_AUTOUPDATE|L/S: Lettura/Scrittura<br /><br /> Impostazione predefinita: nessuna<br /><br /> Descrizione: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] il provider OLE DB client nativo non supporta questa proprietà. I tentativi di impostare la proprietà in **CreateIndex** determinano un valore restituito DB_S_ERRORSOCCURRED. Il membro *dwStatus* della struttura di proprietà indica DBPROPSTATUS_BADVALUE.|  
|DBPROP_INDEX_CLUSTERED|L/S: Lettura/Scrittura<br /><br /> Impostazione predefinita: VARIANT_FALSE<br /><br /> Descrizione: controlla il clustering dell'indice.<br /><br /> VARIANT_TRUE: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] il provider OLE DB Native Client tenta [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] di creare un indice cluster nella tabella. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] supporta al massimo un indice con cluster su una tabella.<br /><br /> VARIANT_FALSE: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] il provider OLE DB Native Client tenta di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] creare un indice non cluster nella tabella.|  
...
|DBPROP_INDEX_UNIQUE|L/S: Lettura/Scrittura<br /><br /> Impostazione predefinita: VARIANT_FALSE<br /><br /> Descrizione: crea l'indice come vincolo UNIQUE nella colonna o nelle colonne utilizzate.<br /><br /> VARIANT_TRUE: l'indice viene utilizzato per vincolare in modo univoco i valori della tabella.<br /><br /> VARIANT_FALSE: l'indice non vincola in modo univoco i valori di riga.|  
 ...
 Nell'insieme di proprietà specifiche [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] del provider DBPROPSET_SQLSERVERINDEX, il provider OLE DB Native Client definisce la proprietà di informazioni sull'origine dati seguente.  
