---
description: Audit Server Object Take Ownership - classe di evento
...
ms.locfileid: "88456093"
---
# <a name="audit-server-object-take-ownership-event-class"></a>Audit Server Object Take Ownership - classe di evento
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
   La classe di evento **Audit Server Object Take Ownership** viene generata quando viene modificato il proprietario degli oggetti nell'ambito del server.  
