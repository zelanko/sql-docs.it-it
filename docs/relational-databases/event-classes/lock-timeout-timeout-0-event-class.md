---
description: Classe di evento Lock:Timeout (timeout &gt; 0)
...
|DatabaseID|**int**|ID del database in cui si è verificato il timeout. [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] visualizza il nome del database se la colonna di dati **ServerName** è acquisita nella traccia e il server è disponibile. Determinare il valore per un database utilizzando la funzione DB_ID.|3|Sì|  
