---
title: Finestra di dialogo Proprietà facet, pagina Generale
description: Descrive la pagina "Generale" della finestra di dialogo "Proprietà facet" per la gestione basata su criteri in SQL Server Management Studio (SSMS).
