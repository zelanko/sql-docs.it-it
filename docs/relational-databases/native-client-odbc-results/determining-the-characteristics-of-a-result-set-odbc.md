---
title: Caratteristiche di un insieme di risultati (ODBC)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 ODBC fornisce metadati alle applicazioni tramite le funzioni API di catalogo. Il [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] driver ODBC Native Client implementa molte delle funzioni [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] del catalogo API ODBC come chiamate a una procedura di catalogo corrispondente.  
