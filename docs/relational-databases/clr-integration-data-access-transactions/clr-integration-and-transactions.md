...
description: Per l'integrazione e le transazioni CLR, System. Transactions e ADO.NET collaborano per estendere e semplificare l'utilizzo di transazioni locali e distribuite nelle applicazioni gestite.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
