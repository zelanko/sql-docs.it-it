...
description: Informazioni su come usare le proprietà delle stored procedure (pagina Generale) per visualizzare informazioni di sola lettura su un stored procedure.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
