...
description: Informazioni su come usare un esempio di un batch di istruzioni Transact-SQL che usa le stored procedure di automazione OLE per creare e usare un oggetto SQL-DMO di SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
