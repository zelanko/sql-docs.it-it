...
description: Questo articolo descrive importanti decisioni di progettazione da effettuare quando si crea un tipo definito dall'utente da installare in SQL Server.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
