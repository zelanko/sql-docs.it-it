...
description: In questo articolo viene descritto il processo per la creazione di tipi definiti dall'utente (UDT) per archiviare oggetti CLR in un database di SQL Server.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
