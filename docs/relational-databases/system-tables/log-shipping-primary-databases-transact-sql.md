...
|**backup_job_id**|**uniqueidentifier**|ID del processo dell'agente di [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] associato al processo di backup nel server primario.|  
|**monitor_server**|**sysname**|Nome dell'istanza del [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] utilizzato come server di monitoraggio nella configurazione log shipping.|  
