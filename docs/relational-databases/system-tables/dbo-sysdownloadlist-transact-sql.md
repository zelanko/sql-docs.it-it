...
|**operation_code**|**tinyint**|Codice operativo per il processo:<br /><br /> **1** = INS (INSERT)<br /><br /> **2** = UPD (AGGIORNAMENTO)<br /><br /> **3** = CANC (ELIMINA)<br /><br /> **4** = START<br /><br /> **5** = STOP|  
