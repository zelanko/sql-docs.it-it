...
|**numero_versione**|**int**|Numero di versione corrente della pianificazione. Se, ad esempio, una pianificazione è stata modificata 10 volte, il **version_number** è 10.|  
