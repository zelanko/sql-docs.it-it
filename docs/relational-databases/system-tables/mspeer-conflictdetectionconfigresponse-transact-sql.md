...
|is_peer|**po'**|Indica se un nodo è un Sottoscrittore di sola lettura. Il valore **0** indica un Sottoscrittore di sola lettura.|  
|conflict_detection_enabled|**po'**|Indica se il rilevamento dei conflitti è abilitato per la topologia.|  
