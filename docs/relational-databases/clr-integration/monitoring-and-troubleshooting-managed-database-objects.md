...
|Evento|Description|  
|-----------|-----------------|  
|[Assembly Load-classe di evento](/sql/database-engine/assembly-load-event-class)|Utilizzato per monitorare le richieste di caricamento degli assembly (esito positivo ed errori).|  
...
|Oggetto|Description|  
|------------|-----------------|  
|[SQL Server, oggetto CLR](../../relational-databases/performance-monitor/sql-server-clr-object.md)|Tempo totale di esecuzione in CLR.|  
