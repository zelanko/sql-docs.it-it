---
title: Restrizioni sulle connessioni regolari e contestuali Documenti Microsoft
description: In questo articolo vengono descritte le restrizioni associate al codice in esecuzione nel processo di Microsoft SQL Server tramite il contesto e le connessioni regolari.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
  In questo argomento vengono illustrate le restrizioni [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] associate al codice in esecuzione nel processo tramite il contesto e le connessioni regolari.  
...
-   **Impossibile utilizzare SqlNotificationRequest** con i comandi eseguiti su una connessione di contesto.  
...
-   La proprietà **SqlConnection.DataSource** restituisce null se la stringa di connessione per la connessione **SqlConnection** è "context connection-true", anziché il nome dell'istanza di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
