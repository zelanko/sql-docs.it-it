---
description: Creazione di un processo di SQL Server Agent per l'archiviazione di messaggi e log eventi di Posta elettronica database
title: Creare un processo di SQL Server Agent per l'archiviazione di messaggi ed eventi di Posta elettronica database
ms.date: 08/09/2016
ms.prod: sql
