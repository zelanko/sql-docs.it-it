---
title: sys. dm _db_resource_stats (database SQL di Azure) | Microsoft Docs
ms.custom: ''
ms.date: 05/21/2019
...
|avg_data_io_percent|**Decimal (5, 2)**|Utilizzo medio di I/O dei dati in percentuale rispetto al limite del livello di servizio.|  
...
## <a name="remarks"></a>Note  
 I dati restituiti da **sys. dm _db_resource_stats** vengono espressi come percentuale dei limiti massimi consentiti per il livello di servizio o il livello di prestazioni che si sta eseguendo.
