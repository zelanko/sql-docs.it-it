---
description: Viste a gestione dinamica relative a Service Broker (Transact-SQL)
title: Viste a gestione dinamica relative a Service Broker (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
ms.reviewer: ''
