---
description: Viste a gestione dinamica relative alle repliche (Transact-SQL)
title: Viste a gestione dinamica relative alla replica (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "88455083"
---
# <a name="replication-related-dynamic-management-views-transact-sql"></a>Viste a gestione dinamica relative alle repliche (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  In questa sezione sono contenuti gli oggetti a gestione dinamica utilizzati dalla replica.  
