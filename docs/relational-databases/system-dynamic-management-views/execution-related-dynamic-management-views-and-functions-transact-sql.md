---
description: Funzioni e viste a gestione dinamica relative all'esecuzione (Transact-SQL)
title: Funzioni e viste a gestione dinamica relative all'esecuzione (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/27/2019
ms.prod: sql
ms.reviewer: ''
...
> [!NOTE]  
>  La vista a gestione dinamica **sys. dm_exec_query_transformation_stats** viene identificata solo a scopo informativo. Non supportata. Non è garantita la compatibilità con le versioni future.  
