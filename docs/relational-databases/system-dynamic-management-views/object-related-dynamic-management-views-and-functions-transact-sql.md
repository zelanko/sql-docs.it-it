---
description: Funzioni e viste a gestione dinamica relative agli oggetti (Transact-SQL)
title: Funzioni e viste a gestione dinamica relative agli oggetti (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 02/10/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
  ...
  In questa sezione sono contenuti gli oggetti a gestione dinamica seguenti in [!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)].  
