...
## <a name="remarks"></a>Osservazioni  
 ...
 sys. dm_db_persisted_sku_features possibile elencare le funzionalità di modifica del database seguenti come limitate a specifiche edizioni di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]:  
...
> [!NOTE]
> A partire da [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] Service Pack 1, queste funzionalità, ad eccezione di **TransparentDataEncryption.** sono disponibili in più edizioni di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] e non solo per le edizioni Enterprise o Developer.
