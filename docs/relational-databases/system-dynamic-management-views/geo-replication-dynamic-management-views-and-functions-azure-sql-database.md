---
description: Geo-Replication funzioni e viste a gestione dinamica (database SQL di Azure)
title: Geo-Replication funzioni e viste a gestione dinamica (database SQL di Azure) | Microsoft Docs
ms.custom: ''
ms.date: 11/24/2015
ms.prod: sql
...
ms.locfileid: "97411398"
---
# <a name="geo-replication-dynamic-management-views-and-functions-azure-sql-database"></a>Geo-Replication funzioni e viste a gestione dinamica (database SQL di Azure)
