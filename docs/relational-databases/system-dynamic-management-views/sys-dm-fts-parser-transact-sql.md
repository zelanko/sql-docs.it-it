 ...
 *query_string*  
 Query da analizzare. *stringa_query* può essere una catena di stringhe che [CONTAINS](../../t-sql/queries/contains-transact-sql.md) supporto della sintassi. È possibile ad esempio includere forme flessive, un thesaurus e operatori logici.  
