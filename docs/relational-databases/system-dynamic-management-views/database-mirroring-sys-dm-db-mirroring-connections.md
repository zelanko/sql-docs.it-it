...
|**transport_stream_id**|**uniqueidentifier**|Identificatore della connessione [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SNI (Network Interface) utilizzata dalla connessione per le comunicazioni TCP/IP.|  
