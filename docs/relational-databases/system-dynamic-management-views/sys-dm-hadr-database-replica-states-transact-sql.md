 ...
 **end_of_log_lsn**, **last_hardened_lsn**, e **recovery_lsn** sono LSN scaricati. Ad esempio, **last_hardened_lsn** indica l'inizio del blocco successivo oltre i blocchi già presenti su disco.  Pertanto, qualsiasi LSN < il valore di **last_hardened_lsn** è su disco.  Gli LSN maggiori o uguali a questo valore non vengono scaricati.  
