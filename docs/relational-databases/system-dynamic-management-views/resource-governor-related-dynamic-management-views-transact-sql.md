---
description: Viste a gestione dinamica relative a Resource Governor (Transact-SQL)
title: Viste a gestione dinamica relative a Resource Governor (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 10/28/2018
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "88419785"
---
# <a name="resource-governor-related-dynamic-management-views-transact-sql"></a>Viste a gestione dinamica relative a Resource Governor (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  In questa sezione sono contenute le viste a gestione dinamica seguenti per Resource Governor.  
