...
|EXTERNAL_SCRIPT_NETWORK_IO |TBD <br /> **Si applica a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] all'istanza corrente.| 
...
|FOREIGN_REDO |TBD <br /> **Si applica a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] all'istanza corrente.| 
...
|PREEMPTIVE_HADR_LEASE_MECHANISM |Gestore di lease di gruppi di disponibilità AlwaysOn di pianificazione per la diagnostica CSS., <br /> **Si applica a**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] tramite [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].| 
