...
|EXTERNAL_SCRIPT_NETWORK_IO |Solo per uso interno. <br /> **Si applica a: da a** [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] corrente.| 
...
|FOREIGN_REDO |Solo per uso interno. <br /> **Si applica a: da a** [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] corrente.| 
...
|QUERY_ERRHDL_SERVICE_DONE |Identificato solo a scopo informativo. Non supportata. <br /> **Si applica a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] solo. |  
|QUERY_WAIT_ERRHDL_SERVICE |Identificato solo a scopo informativo.  Non supportata. <br /> **Si applica a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] solo.  |  
...
|XE_PACKAGE_LOCK_BACKOFF |Identificato solo a scopo informativo. Non supportata. <br /> **Si applica a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] solo. |  
