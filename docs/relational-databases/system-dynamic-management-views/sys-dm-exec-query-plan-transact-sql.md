...
## <a name="permissions"></a>Permissions  
 Per eseguire **DM exec_query_plan**, un utente deve essere un membro delle **sysadmin** ruolo predefinito del server o disporre dell'autorizzazione VIEW SERVER STATE nel server.  
