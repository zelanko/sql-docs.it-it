---
description: Funzioni e viste a gestione dinamica relative a I/O (Transact-SQL)
title: Funzioni e viste a gestione dinamica relative a I/O (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
