...
> **Nota:** Per chiamare questo oggetto [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] da [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]o, usare il nome **sys. dm_pdw_nodes_os_sys_info**.  
...
|**sqlserver_start_time_ms_ticks**|**bigint**|Rappresenta il **ms_tick** numero di ms_tick [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] al momento dell'ultimo avvio di. Da confrontare con la colonna ms_ticks corrente. Non ammette i valori NULL.|  
