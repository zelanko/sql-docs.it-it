...
|**sqlserver_start_time_ms_ticks**|**bigint**|Rappresenta il **** numero di ms_tick [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] al momento dell'ultimo avvio di. Da confrontare con la colonna ms_ticks corrente. Non ammette i valori NULL.|  
