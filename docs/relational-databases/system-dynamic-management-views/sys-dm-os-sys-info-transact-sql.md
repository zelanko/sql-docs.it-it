...
> **Nota:** Per chiamare questo oggetto da [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] o [!INCLUDE[ssPDW](../../includes/sspdw-md.md)], usare il nome **sys. dm_pdw_nodes_os_sys_info**.  
...
|**sqlserver_start_time_ms_ticks**|**bigint**|Rappresenta il numero di **ms_tick** al momento dell'ultimo avvio di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Da confrontare con la colonna ms_ticks corrente. Non ammette i valori NULL.|  
