...
## <a name="remarks"></a>Note  
 Il **sys.dm_cryptographic_provider_sessions** visualizzazione è visibile al pubblico per la connessione corrente. Per visualizzare tutte le connessioni di crittografia, è necessario disporre di **controllo** autorizzazione server.  
