---
description: Viste a gestione dinamica relative a CLR (Common Language Runtime) (Transact-SQL)
title: Viste a gestione dinamica relative a Common Language Runtime (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
ms.reviewer: ''
