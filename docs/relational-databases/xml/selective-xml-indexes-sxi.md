...
description: Informazioni su come usare indici XML selettivi (SXI) per migliorare le prestazioni delle query, supportare l'indicizzazione più veloce e ridurre i costi di archiviazione degli indici XML.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
