...
description: Informazioni sul modo in cui i caratteri XML non validi vengono gestiti dalla clausola FOR XML e sulle regole di escape per i caratteri non validi nei nomi XML.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
