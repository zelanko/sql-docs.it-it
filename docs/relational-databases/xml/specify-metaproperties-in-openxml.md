...
description: Informazioni su come specificare gli attributi delle metaproprietà in un'istruzione OPENXML per estrarre informazioni dai nodi XML.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
