...
description: Informazioni su come la regola del vincolo di attribuzione di particelle univoche (UPA) rifiuti uno schema XSD se contiene un tipo con un modello di contenuto potenzialmente ambiguo.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
