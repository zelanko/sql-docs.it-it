...
description: Informazioni su come specificare i percorsi dei nodi e gli hint di ottimizzazione quando si creano o si modificano indici XML selettivi.
ms.date: 03/14/2017
ms.prod: sql
