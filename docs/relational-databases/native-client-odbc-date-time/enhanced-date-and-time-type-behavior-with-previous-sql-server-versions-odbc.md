---
title: Data Ora nelle versioni SQL (ODBC)
ms.custom: ''
ms.date: 12/18/2019
ms.prod: sql
...
## <a name="down-level-client-behavior"></a>Comportamento dei client legacy  
 ...
 I metadati dell'istruzione restituiti da SQLDescribeCol, SQLDescribeParam, SQGetDescField e SQLColAttribute restituiranno metadati coerenti con il tipo di livello inferiore sotto tutti i aspetti, incluso il nome del tipo. Un esempio di tale tipo di livello inferiore è **nvarchar**.  
...
||Time(7)|SQL_C_TIME|Fails - valore letterale temporale non valido.|OK (1)|  
|||SQL_C_TYPE_TIMESTAMP|Fails - valore letterale temporale non valido.|OK (1)|  
