---
title: Regole di confronto e tipi di dati di integrazione CLR . Documenti Microsoft
description: Nell'integrazione CLR di SQL Server, le API di stringa di .NET Framework utilizzano la proprietà CompareInfo di CultureInfo del thread corrente per eseguire confronti tra stringhe.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
