...
description: La libreria SqlTypes fa parte del Framework Microsoft .NET. Fornisce tipi di dati con la stessa semantica e la stessa precisione di quelli del database SQL Server.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 [Gestione di Large Object &#40;i parametri LOB&#41; in CLR](../../relational-databases/clr-integration-database-objects-types-net-framework/handling-large-object-lob-parameters-in-the-clr.md)  
