---
title: Confronto della logica a tre valori e di supporto Null Documenti Microsoft
description: In questo articolo viene illustrato come i tipi di dati di SQL Server differiscono dai tipi in System.Data.SqlTypes in .NET Framework, con semantica e precisione simili.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
  Se si ha [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] familiarità con i tipi di dati, si troveranno semantica [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)]e precisione simili nello spazio dei nomi **System.Data.SqlTypes** nell'oggetto . Esistono tuttavia alcune differenze, le più importanti delle quali sono illustrate nel presente argomento.  
...
## <a name="sqlboolean-data-type"></a>Tipo di dati SqlBoolean  
 Lo spazio dei nomi **System.Data.SqlTypes** introduce un tipo **SqlBoolean** per rappresentare questa logica a 3 valori. I confronti tra qualsiasi **SqlTypes** restituiscono un **SqlBoolean** tipo di valore. Il valore UNKNOWN è rappresentato dal valore null del tipo **SqlBoolean.** Le proprietà **IsTrue**, **IsFalse**e **IsNull** vengono fornite per controllare il valore di un **SqlBoolean** tipo.  
  
## <a name="operations-functions-and-null-values"></a>Operazioni, funzioni e valori NULL  
 Tutti gli operatori aritmetici \*(Sezione , - , /, %) , gli operatori bit per bit (Sezione , &, e ) e la maggior parte delle funzioni restituiscono NULL se uno degli operandi o degli argomenti di **SqlTypes** sono NULL. La proprietà **IsNull** restituisce sempre un valore true o false.  
  
## <a name="precision"></a>Precision  
 I valori massimi dei tipi di dati decimali CLR di [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] sono diversi da quelli dei tipi di dati numerici e decimali di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Per i tipi di dati CLR decimali di [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)], inoltre, si presuppone la massima precisione. In CLR [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]per , tuttavia, **SqlDecimal** fornisce la stessa precisione e la [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]stessa scala massime e la stessa semantica del tipo di dati decimal in .  
