...
> Per informazioni, vedere [Using Connection String Keywords con il Driver OLE DB per SQL Server](../../../connect/oledb/applications/using-connection-string-keywords-with-oledb-driver-for-sql-server.md).
