...
description: Informazioni sul supporto SQL Server Native Client per Gruppi di disponibilità Always On, che è stato aggiunto in SQL Server 2012.
ms.custom: ''
ms.date: 04/04/2018
ms.prod: sql
ms.reviewer: ''
