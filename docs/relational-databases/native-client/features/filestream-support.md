...
-   [OLE DB di &#40;supporto FILESTREAM&#41;](../../../relational-databases/native-client/ole-db/filestream-support-ole-db.md)  
...
## <a name="down-level-compatibility"></a>Compatibilità con le versioni precedenti  
 ...
 Per i client che utilizzano SQLOLEDB o altri provider rilasciati prima della versione [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] native client, **varbinary (max)** verrà mappato all'immagine.  
