---
description: Modifica del comportamento del driver ODBC quando si gestiscono le conversioni di caratteri
title: Conversione di caratteri di gestione delle modifiche ODBC
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
