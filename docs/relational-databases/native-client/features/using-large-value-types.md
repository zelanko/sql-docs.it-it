...
description: Informazioni su come SQL Server Native Client gestisce i tipi di dati con valori di grandi dimensioni che richiedono in precedenza una gestione speciale.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
```  
 ...
 Per ulteriori informazioni sul modo in cui il [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] provider di OLE DB di Native Client espone i tipi di dati con valori di grandi dimensioni, vedere [oggetti BLOB e oggetti OLE](../../../relational-databases/native-client-ole-db-blobs/blobs-and-ole-objects.md).  
