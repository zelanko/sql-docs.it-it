...
-   **SQLLinkedCatalogs**  
 ...
 Quando si dispone di un nome di server collegato e di un nome di catalogo, il driver ODBC di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client supporta il recupero di informazioni dal catalogo utilizzando un nome in due parti di _linked_server_name_ **.** _Catalog_ per *CatalogName* nelle funzioni del catalogo ODBC seguenti:  
