...
description: Informazioni su come eliminare le statistiche dalle tabelle e dalle viste in SQL Server usando SQL Server Management Studio o Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
