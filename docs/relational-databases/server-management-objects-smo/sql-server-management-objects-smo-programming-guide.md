---
description: Guida alla programmazione di SMO (SQL Server Management Objects)
...
|-----------|-----------------|
|[Introduzione a SMO](getting-started-in-smo.md)|Vengono fornite informazioni su come avviare lo sviluppo di un'applicazione SMO
