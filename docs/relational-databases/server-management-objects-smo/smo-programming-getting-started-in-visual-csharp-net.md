...
ms.locfileid: "62942858"
---
# <a name="smo-programming---getting-started-in-visual-c-net"></a>Programmazione SMO - Introduzione a Visual C# .NET
...
## <a name="references-and-imports"></a>Riferimenti e importazioni  
 ...
 In [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], gli assembly SMO si trovano nella cartella C:\Program Files\Microsoft SQL Server\130\SDK\Assemblies\.  
  
## <a name="see-also"></a>Vedere anche  
 [Creare un Visual C&#35; progetto SMO per Visual Studio .NET](../../relational-databases/server-management-objects-smo/how-to-create-a-visual-csharp-smo-project-in-visual-studio-net.md)  
