...
description: In un modello di recupero con registrazione minima o con registrazione minima delle operazioni bulk, la registrazione minima delle operazioni di importazione bulk riduce la possibilità che un'operazione riempia lo spazio del log.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
