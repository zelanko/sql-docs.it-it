...
description: SQL Server 2019 supporta file di formato non XML e file di formato XML per l'esportazione e l'importazione bulk. Informazioni sui file di formato non XML e sui relativi vantaggi.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
