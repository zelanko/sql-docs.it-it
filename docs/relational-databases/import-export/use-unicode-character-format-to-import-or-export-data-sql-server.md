...
description: Il formato di dati carattere Unicode consente di esportare i dati da un'istanza di SQL Server usando una tabella codici diversa da quella usata dal client.
ms.date: 09/30/2016
ms.prod: sql
