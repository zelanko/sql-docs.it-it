...
## <a name="before-you-begin"></a>Prima di iniziare<a name="begin"></a>
...
## <a name="using-a-format-file-to-bulk-import-data"></a>Utilizzo di un file di formato per l'importazione bulk dei dati<a name="import_data"></a>
