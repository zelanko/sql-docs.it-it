---
title: Effetti delle opzioni ISO Documenti Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "81297936"
---
# <a name="effects-of-iso-options"></a>Effetti delle opzioni ISO
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  Lo standard ODBC è molto simile allo standard ISO e le applicazioni ODBC presuppongono un comportamento standard da un driver ODBC. Per rendere il comportamento più conforme a quello definito [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] nello standard ODBC, il driver ODBC Native Client utilizza sempre tutte le opzioni ISO disponibili nella versione di SQL Server con cui si connette.  
  
 Quando [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] il driver ODBC Native Client [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]si connette a un'istanza di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] , il server rileva che il client utilizza il driver ODBC Native Client e imposta diverse opzioni.  
 ...
 Nelle applicazioni DB-Library in genere queste opzioni non vengono attivate. I siti che osservano un comportamento diverso tra i client ODBC o DB-Library [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] quando si esegue la stessa istruzione SQL non devono presupporre che questo punti a un problema con il driver ODBC Native Client. Devono prima rieseguire l'istruzione nell'ambiente DB-Library con le stesse [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] opzioni SET utilizzate dal driver ODBC Native Client.  
 ...
 Durante la connessione a un'istanza di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], viene attivata anche una quarta opzione SET, CONCAT_NULL_YIELDS_NULL. Il [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] driver ODBC Native Client non imposta queste opzioni su se AnsiNPW- NO è specificato nell'origine dati o su [SQLDriverConnect](../../../relational-databases/native-client-odbc-api/sqldriverconnect.md) o [SQLBrowseConnect](../../../relational-databases/native-client-odbc-api/sqlbrowseconnect.md).  
  
 Analogamente alle opzioni ISO indicate in precedenza, il [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] driver ODBC Native Client non attiva l'opzione QUOTED_IDENTIFIER se QuotedID-NO è specificato nell'origine dati o in **SQLDriverConnect** o **SQLBrowseConnect**.  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [SQLDriverConnect (connessione di SQLDriverConnect)](../../../relational-databases/native-client-odbc-api/sqldriverconnect.md)   
