...
>  [!INCLUDE[ssNoteDepFutureDontUse](../../includes/ssnotedepfuturedontuse-md.md)] Utilizzare invece la funzionalità di integrazione con CLR.  
 ...
 Per eliminare ogni funzione di stored procedure estesa in una DLL di stored procedure estesa definita dall'utente, un amministratore di sistema [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] deve eseguire il **sp_dropextendedproc** di sistema stored procedure, specificando il nome della funzione e il nome della dll in cui risiede la funzione. Ad esempio, questo comando rimuove la funzione **xp_hello**, che si trova in una dll denominata xp_hello. dll, da [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]:  
