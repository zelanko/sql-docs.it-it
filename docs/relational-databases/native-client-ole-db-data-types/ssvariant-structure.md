...
ms.locfileid: "81296999"
---
# <a name="ssvariant-structure"></a>Struttura SSVARIANT
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  La struttura **SSVARIANT,** definita in sqlncli.h, corrisponde a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] un valore DBTYPE_SQLVARIANT nel provider OLEDB Native Client.  
...
-   VT_SS_DATE  
 ...
 Per ulteriori informazioni su SSPROP_INIT_DATATYPECOMPATIBILITY, vedere Utilizzo di parole chiave della stringa di [connessione con SQL Server Native Client](../../relational-databases/native-client/applications/using-connection-string-keywords-with-sql-server-native-client.md).  
...
|fltRealVal|DBTYPE_R4|**Galleggiante**|**VT_SS_R4**|Supporta il tipo di dati **real.** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
|numNumericVal|DBTYPE_NUMERIC|**DB_NUMERIC**|**VT_SS_NUMERIC**|Supporta il tipo di dati **numerico.** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
