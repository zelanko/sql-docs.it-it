...
description: Informazioni su come sincronizzare una sottoscrizione push in SQL Server tramite SQL Server Management Studio, agenti di replica o Replication Management Objects.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
