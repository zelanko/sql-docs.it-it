...
description: Informazioni sui mapping predefiniti dei tipi di dati tra Oracle e SQL Server quando i dati vengono spostati dal server di pubblicazione Oracle al server di distribuzione di SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
