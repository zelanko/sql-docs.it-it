...
-   Lo spazio dei nomi in cui viene creato un oggetto: \<Database>.\<Schema>.\<Object>. Gli schemi vengono definiti usando l'istruzione `CREATE SCHEMA`.  
