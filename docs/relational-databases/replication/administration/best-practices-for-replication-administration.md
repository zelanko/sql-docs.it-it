...
description: Dopo aver configurato la replica, seguire queste procedure consigliate per amministrare la topologia di replica in SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
