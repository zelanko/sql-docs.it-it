...
description: Informazioni sui tipi di sottoscrizioni della replica di SQL Server replica, su come scegliere il tipo necessario e su come creare una sottoscrizione.
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
