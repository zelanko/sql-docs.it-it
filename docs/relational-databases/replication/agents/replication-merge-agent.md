...
description: Agente merge repliche applica lo snapshot iniziale contenuto nelle tabelle di database ai Sottoscrittori, esegue il merge delle modifiche dei dati incrementali e risolve i conflitti.
ms.custom: ''
ms.date: 10/29/2018
ms.prod: sql
