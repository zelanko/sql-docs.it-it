...
description: Informazioni sugli agenti usati dalla replica di SQL Server per eseguire le attività associate al rilevamento delle modifiche e alla distribuzione dei dati.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
