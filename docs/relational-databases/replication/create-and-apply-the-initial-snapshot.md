...
description: Informazioni su come creare e applicare lo snapshot iniziale in SQL Server tramite SQL Server Management Studio, Transact-SQL o Replication Management Objects.
ms.custom: ''
ms.date: 11/20/2018
ms.prod: sql
