---
title: Proprietà pubblicazione - Finestra di dialogo
description: Descrive le pagine disponibili nella finestra di dialogo "Proprietà server di pubblicazione" in SQL Server Management Studio (SSMS).
