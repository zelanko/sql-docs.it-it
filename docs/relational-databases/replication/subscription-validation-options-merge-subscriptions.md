---
title: Opzioni di convalida delle sottoscrizioni (sottoscrizioni merge)
description: Viene descritta la finestra di dialogo "Opzioni di convalida delle sottoscrizioni" in SQL Server Management Studio (SSMS).
