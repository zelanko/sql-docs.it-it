...
|**mirroring_end_of_log_lsn**|**numerico (25, 0)**|La fine del log locale è stata scaricata sul disco. Questo è paragonabile all'LSN finalizzato dal server mirror (vedere la colonna **mirroring_failover_lsn** ).|  
|**mirroring_replication_lsn**|**numerico (25, 0)**|Il valore LSN massimo che la replica può inviare.|  
