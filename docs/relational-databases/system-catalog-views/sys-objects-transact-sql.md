...
[!INCLUDE[tsql-appliesto-ss2008-all-md](../../includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  Contiene una riga per ogni oggetto definito dall'utente, con ambito schema che viene creato all'interno di un database, compresa la funzione definita dall'utente scalari compilate in modo nativo.  
...
Subset di oggetti possono essere visualizzati utilizzando viste di sistema per un tipo specifico di oggetto, ad esempio:  
