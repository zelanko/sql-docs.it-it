---
description: Spazi dei dati (Transact-SQL)
title: Spazi dati (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
ms.locfileid: "88470063"
---
# <a name="data-spaces-transact-sql"></a>Spazi dei dati (Transact-SQL)
