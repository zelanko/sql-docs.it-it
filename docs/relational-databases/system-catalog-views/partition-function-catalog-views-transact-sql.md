---
description: Viste del catalogo delle funzioni di partizione (Transact-SQL)
title: Viste del catalogo delle funzioni di partizione (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
