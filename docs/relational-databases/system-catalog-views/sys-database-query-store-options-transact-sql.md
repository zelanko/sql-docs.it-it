...
|**query_capture_mode_desc**|**nvarchar(60)**|Descrizione testuale della modalità di acquisizione effettiva di Query Store:<br /><br /> ALL (impostazione predefinita [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]per)<br /><br /> **Auto** (impostazione predefinita [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)]per)<br /><br /> NONE|  
