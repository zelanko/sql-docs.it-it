...
Visualizza le informazioni di distribuzione viste materializzate.  
  
|Nome colonna|Tipo di dati|Descrizione|  
|-----------------|---------------|-----------------| 
|object_id|**int**|ID della vista materializzata per le tre proprietà sono state specificate.| 
