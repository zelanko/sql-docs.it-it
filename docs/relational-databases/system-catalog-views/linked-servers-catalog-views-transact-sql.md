---
description: Viste del catalogo dei server collegati (Transact-SQL)
title: Viste del catalogo di server collegati (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
