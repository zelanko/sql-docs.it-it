...
### <a name="a-view-all-of-the-internal-rowsets-for-a-table"></a>R. Visualizzare tutti i set di righe interni per una tabella  
 In questo esempio vengono restituiti tutti i set di righe columnstore interni per una tabella. È anche possibile usare hobt_id per trovare altre informazioni sul set di righe specifico.  
