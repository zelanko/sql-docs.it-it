...
|**column_store_order_ordinal**</br> Si applica a: Azure SQL Data Warehouse (anteprima)|**tinyint**|Ordinale (in base 1) nel set di colonne ORDER in un indice columnstore cluster ordinato.|
