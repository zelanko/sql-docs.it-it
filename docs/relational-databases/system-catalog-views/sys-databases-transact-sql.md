...
|**log_reuse_wait**|**tinyint**|Il riutilizzo dello spazio del log delle transazioni è attualmente in attesa di uno dei seguenti elementi a partire dall'ultimo checkpoint. Per una spiegazione più dettagliata di questi valori, vedere [il log delle transazioni](../../relational-databases/logs/the-transaction-log-sql-server.md).<br /> **Valore &#124; si applica a**<br /> 0 = Nessuno<br />   1 = Checkpoint (quando un database utilizza un modello di recupero e ha un filegroup di dati ottimizzato per la memoria, è necessario che la `log_reuse_wait` colonna indichi checkpoint o xtp_checkpoint) &#124; [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] e versioni successive<br />  2 = &#124; backup del log [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] e versioni successive<br />  3 = backup attivo o ripristino &#124; [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] e versioni successive<br />  4 = &#124; transazioni attive [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] e versioni successive<br />  5 = &#124; mirroring del database [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] e versioni successive<br />  6 = &#124; [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] di replica e versioni successive<br />  7 = Creazione di snapshot del database &#124; [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] e versioni successive<br />  8 = Analisi del log <br />  9 = una Always On replica secondaria dei gruppi di disponibilità applica i record del log delle transazioni del database a un database secondario corrispondente. &#124; [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e versioni successive<br />  9 = altro (temporaneo) &#124; fino a e include[!INCLUDE[ssKilimanjaro](../../includes/ssKilimanjaro-md.md)]<br />  10 = solo per uso interno &#124; [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e versioni successive<br />  11 = solo per uso interno &#124; [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e versioni successive<br /> 12 = solo per uso interno &#124; [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e versioni successive<br />13 = &#124; di pagina meno recente [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e versioni successive<br /> 14 = altri &#124; [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e versioni successive<br />  16 = XTP_CHECKPOINT (quando un database utilizza un modello di recupero e ha un filegroup di dati ottimizzato per la memoria, è necessario che la colonna log_reuse_wait indichi checkpoint o xtp_checkpoint) &#124; [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] e versioni successive|  
...
|**physical_database_name**|**nvarchar(128)**|Per SQL Server, il nome fisico del database. Per il database SQL di Azure, un ID comune per i database in un server. <br />**Si applica a**: SQL Server 2019 (15. x) e versioni successive e al database SQL di Azure|
