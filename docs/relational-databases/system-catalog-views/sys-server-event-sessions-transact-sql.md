...
|event_retention_mode|**nchar (1)**|Determina la modalità di gestione della perdita di eventi. L'impostazione predefinita è S. Non sono ammessi valori Null. I valori validi sono i seguenti:<br /><br /> Numero Esegue il mapping a event_retention_mode_desc = ALLOW_SINGLE_EVENT_LOSS<br /><br /> M. Esegue il mapping a event_retention_mode_desc = ALLOW_MULTIPLE_EVENT_LOSS<br /><br /> N. Esegue il mapping a event_retention_mode_desc = NO_EVENT_LOSS|  
