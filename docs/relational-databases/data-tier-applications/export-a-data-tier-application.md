---
description: Esportazione di un'applicazione livello dati
...
##  <a name="using-a-net-framework-application"></a><a name="NetApp"></a> Utilizzo di un'applicazione .NET Framework  
