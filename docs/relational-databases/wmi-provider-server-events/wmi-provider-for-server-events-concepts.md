...
## <a name="in-this-section"></a>In questa sezione  
 ...
 [Esempio: Creazione di un avviso SQL Server Agent tramite il Provider WMI per eventi del Server](../../relational-databases/wmi-provider-server-events/sample-creating-a-sql-server-agent-alert-with-the-wmi-provider.md)  
 ...
 [Esempio: Usare il Provider di eventi WMI con .NET Framework](../../relational-databases/wmi-provider-server-events/sample-using-the-wmi-event-provider-with-the-net-framework.md)  
