...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
 ...
 Nota: per i driver ODBC di Mac e Linux con unixODBC 2.3.1 a 2.3.4, quando si imposta il nome TVP tramite SQLSetDescField tramite il campo SQL_CA_SS_TYPE_NAME, unixODBC non automaticamente la conversione tra ANSI e Unicode le stringhe in base l'esatto funzione chiamata (SQLSetDescFieldA / SQLSetDescFieldW). È necessario sempre utilizzare SQLBindParameter o SQLSetDescFieldW con una stringa Unicode (UTF-16) per impostare il nome TVP.
