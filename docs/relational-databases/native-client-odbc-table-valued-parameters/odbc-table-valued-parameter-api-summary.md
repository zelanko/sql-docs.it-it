---
description: Riepilogo delle API dei parametri con valori di tabella ODBC
title: Riepilogo API parametro Table-Valued ODBC | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
