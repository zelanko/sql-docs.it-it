---
description: Metadati aggiuntivi dei parametri con valori di tabella
title: Metadati aggiuntivi del parametro Table-Valued | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
