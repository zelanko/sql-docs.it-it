...
description: Informazioni su come creare un'attività che cerchi di ridurre le dimensioni dei database di SQL Server selezionati utilizzando l'attività Compatta database.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
