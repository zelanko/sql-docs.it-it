...
|Nome simbolico|P3_HEKATON_TABLE_IMP|  
|Testo del messaggio|*construct* '*feature*' non ancora implementato con le tabelle con ottimizzazione per la memoria.|  
