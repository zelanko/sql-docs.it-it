...
description: Usare Monitor di sistema per misurare le prestazioni degli oggetti di SQL Server, i contatori delle prestazioni e il comportamento di altri oggetti, ad esempio processori e memoria.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
