...
description: Informazioni sui contatori di Metodi di accesso, che possono essere usati anche per monitorare la quantità di dati, indici e spazio libero all'interno di un database in SQL Server.
ms.custom: ''
ms.date: 03/20/2017
ms.prod: sql
