...
description: Informazioni su come creare grafici, avvisi, log e report per monitorare un'istanza di SQL Server usando Monitor di sistema.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
