...
```  
 ...
 B. Esempio esteso dell'esempio precedente che include alcuni controlli di base.  Eseguire il comando [!INCLUDE[tsql](../../includes/tsql-md.md)] seguente in[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]\:
...
## <a name="see-also"></a>Vedere anche  
 [Associare un database con tabelle ottimizzate per la memoria a un pool di risorse](../../relational-databases/in-memory-oltp/bind-a-database-with-memory-optimized-tables-to-a-resource-pool.md)   
