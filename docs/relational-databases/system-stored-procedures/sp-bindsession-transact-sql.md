 ...
 **'** *bind_token* **'**  
 È il token che identifica la transazione ottenuto in origine tramite **sp_getbindtoken** o il servizio ODS **srv_getbindtoken** (funzione). *bind_token*is **varchar(255)** .  
