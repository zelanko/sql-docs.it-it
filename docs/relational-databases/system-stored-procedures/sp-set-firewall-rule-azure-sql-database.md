...
## <a name="arguments"></a>Argomenti  
 Nella tabella seguente vengono illustrati gli argomenti e le [!INCLUDE[msCoName](../../includes/msconame-md.md)] opzioni supportati in [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)].  
...
## <a name="remarks"></a>Note  
 ...
 Quando si aggiunge un'impostazione del firewall a livello di server in cui gli indirizzi IP iniziale e finale `0.0.0.0`sono uguali a, si abilita [!INCLUDE[ssSDS](../../includes/sssds-md.md)] l'accesso al server da Azure. Fornire un valore al parametro *Name* che consenta di ricordare l'impostazione del firewall a livello di server.  
