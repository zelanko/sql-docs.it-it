---
description: Stored procedure di catalogo (Transact-SQL)
title: Stored procedure del catalogo (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88419345"
---
# <a name="catalog-stored-procedures-transact-sql"></a>Stored procedure di catalogo (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] supporta le stored procedure di sistema seguenti che implementano le funzioni del dizionario dei dati ODBC e isolano le applicazioni ODBC dalle modifiche apportate alle tabelle di sistema sottostanti.  
