...
||**false**|Le istruzioni DELETE non vengono replicate.<br /><br /> ** \* Importante \* \* ** L'impostazione di **delete_tracking** su **false** comporta una mancata convergenza ed è necessario rimuovere manualmente le righe eliminate.|  
