---
description: Stored procedure di SQL Server Profiler (Transact-SQL)
title: Stored procedure di SQL Server Profiler (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
