...
> [!IMPORTANT]  
>  **sp_replrestart** è un stored procedure di replica interna e deve essere utilizzato solo per il ripristino di un database pubblicato in una topologia di replica transazionale, come indicato nell'argomento [strategie per il backup e il ripristino di snapshot e Replica](../../relational-databases/replication/administration/strategies-for-backing-up-and-restoring-snapshot-and-transactional-replication.md)transazionale.  
