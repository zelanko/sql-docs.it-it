---
description: Stored procedure di Query Store (Transact-SQL)
title: Stored procedure di Query Store (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/29/2016
ms.prod: sql
...
ms.locfileid: "89539172"
---
# <a name="query-store-stored-procedures-transact-sql"></a>Stored procedure di Query Store (Transact-SQL)

[!INCLUDE [sqlserver2016-asdb-asdbmi](../../includes/applies-to-version/sqlserver2016-asdb-asdbmi.md)]

  Questa sezione contiene le stored procedure seguenti usate per configurare archivio query.  
