...
### <a name="a-calling-a-method"></a>R. Chiamata di un metodo  
 Nell'esempio seguente viene chiamato `Connect` il metodo dell'oggetto **SqlServer** creato in precedenza.  
