...
Il **sp_execute_external_script** stored procedure esegue uno script fornito come argomento di input per la stored procedure e viene utilizzato con [Machine Learning Services](../../machine-learning/index.yml) e le [estensioni del linguaggio](../../language-extensions/language-extensions-overview.md). 
...
Il **sp_execute_external_script** stored procedure esegue uno script fornito come argomento di input della stored procedure e viene utilizzato con [Machine Learning Services](../../machine-learning/index.yml) su SQL Server 2017. 
...
+ [Librerie e tipi di dati Python](../../machine-learning/python/python-libraries-and-data-types.md)  
+ [Librerie r e tipi di dati R](../../machine-learning/r/r-libraries-and-data-types.md)  
+ [R Services per SQL Server](../../machine-learning/r/sql-server-r-services.md)   
+ [Problemi noti per SQL Server Machine Learning Services](../../machine-learning/known-issues-for-sql-server-machine-learning-services.md)   
