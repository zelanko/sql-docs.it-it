...
`[ @policy_category = ] 'policy_category'` È il nome della sottoscrizione di categoria di criteri che si desidera eliminare. *policy_category* viene **sysname**ed è obbligatorio.  
