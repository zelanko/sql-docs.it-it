---
description: Stored procedure di backup gestito (Transact-SQL)
title: Stored procedure di backup gestito (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "89549956"
---
# <a name="managed-backup-stored-procedures-transact-sql"></a>Stored procedure di backup gestito (Transact-SQL)
[!INCLUDE [sqlserver2016](../../includes/applies-to-version/sqlserver2016.md)]

  Per configurare, è possibile utilizzare le stored procedure seguenti [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] .  
