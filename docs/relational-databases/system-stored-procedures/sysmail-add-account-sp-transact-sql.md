...
## <a name="remarks"></a>Remarks  
 ...
 Quando **\@use_default_credentials** viene inviato un messaggio di posta elettronica al server SMTP utilizzando le credenziali del [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]. Quando **\@use_default_credentials** è 0 e vengono specificati un **\@username** e **\@password** per un account, l'account utilizza l'autenticazione SMTP. Il **\@username** e **\@password** sono le credenziali utilizzate dall'account per il server SMTP, non le credenziali per [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] o la rete in cui si trova il computer.  
