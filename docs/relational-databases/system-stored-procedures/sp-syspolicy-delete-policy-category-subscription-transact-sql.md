...
`[ @policy_category_subscription_id = ] policy_category_subscription_id` È l'identificatore per la sottoscrizione di categoria di criteri. *policy_category_subscription_id* viene **int**.  
