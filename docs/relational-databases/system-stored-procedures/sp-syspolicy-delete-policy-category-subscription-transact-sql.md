...
`[ @policy_category_subscription_id = ] policy_category_subscription_id`Identificatore della sottoscrizione di categoria di criteri. *policy_category_subscription_id* è di **tipo int**.  
...
## <a name="permissions"></a>Autorizzazioni  
 ...
 Per ottenere i valori per *policy_category_subscription_id*, è possibile utilizzare la query seguente:  
