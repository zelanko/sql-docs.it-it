...
`[ @publication = ] 'publication'` È la pubblicazione per cui si desidera aggiornare le sottoscrizioni. *pubblicazione* viene **sysname**, non prevede alcun valore predefinito.  
