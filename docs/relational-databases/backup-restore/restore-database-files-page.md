...
description: Durante il ripristino di un database in SQL Server, usare la pagina File della finestra di dialogo Ripristina database per gestire i file specifici da ripristinare all'interno del database.
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
