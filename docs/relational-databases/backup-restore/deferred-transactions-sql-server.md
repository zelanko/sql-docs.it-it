...
description: Una transazione posticipata in SQL Server Enterprise si verifica se i dati necessari per il rollback sono offline. Informazioni su come spostarli fuori dallo stato posticipato.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
