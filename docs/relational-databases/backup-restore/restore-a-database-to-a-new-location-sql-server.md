...
description: Questo articolo illustra come ripristinare un database di SQL Server in un nuovo percorso e rinominare il database usando SQL Server Management Studio o Transact-SQL.
ms.custom: ''
ms.date: 08/05/2016
ms.prod: sql
