...
> [!NOTE]  
>  Quando si specifica un'attività di ripristino usando [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], è possibile generare lo script [!INCLUDE[tsql](../../includes/tsql-md.md)]RESTORE[ corrispondente di ](../../t-sql/statements/restore-statements-transact-sql.md) facendo clic su **Script** e quindi selezionando una destinazione per lo script.  
