...
description: In SQL Server Enterprise Edition, in alcuni casi è possibile ripristinare i dati per file, pagina o a fasi mentre un database rimane online.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
