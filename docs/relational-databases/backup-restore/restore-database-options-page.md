...
description: Durante il ripristino di un database in SQL Server, usare la pagina Opzioni della finestra di dialogo Ripristina database per modificare il comportamento e il risultato dell'operazione di ripristino.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
