...
description: Questo articolo descrive come ripristinare un backup del log delle transazioni in SQL Server usando SQL Server Management Studio o Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
