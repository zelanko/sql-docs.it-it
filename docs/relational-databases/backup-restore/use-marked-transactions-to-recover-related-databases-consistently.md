...
description: Quando si eseguono aggiornamenti correlati in due o più database correlati, usare i contrassegni delle transazioni in SQL Server per recuperarli fino a un punto consistente logico.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
