---
title: 'Ripristinare un database: modello di recupero con registrazione minima'
description: Informazioni su un ripristino di database completo in SQL Server che ripristina tutti i dati fino al punto nel tempo in cui è stato eseguito il backup.
