...
|BCP_OUT_NATIVE_MODE|Specifica tipi di database nativi.<br /><br /> Corrisponde all'opzione - n in BCP. File EXE e con bcp_setcolfmt **BCP_FMT_TYPE** proprietà impostata sul valore predefinito.|  
