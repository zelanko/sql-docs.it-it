...
-   [Configurazione delle procedure del driver ODBC di SQL Server](./configuring-the-sql-server-odbc-driver-add-a-data-source.md)  
...
-   [Procedure per l'elaborazione dei risultati &#40;ODBC&#41;](./processing-results-process-results.md)  
...
-   [Procedure per l'esecuzione di stored procedure &#40;ODBC&#41;](./running-stored-procedures-call-stored-procedures.md)  
  
-   [Procedure per la gestione di colonne di testo e di immagini &#40;ODBC&#41;]()  
