---
title: Copia di massa tramite un file di formato (ODBC) Documenti Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
5.  Chiamare [bcp_readfmt](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-readfmt.md) per leggere il file di formato che descrive il file di dati che deve essere utilizzato dall'operazione di copia di massa.  
  
6.  Chiamare [bcp_exec](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-exec.md) per eseguire l'operazione di copia di massa.  
...
## <a name="example"></a>Esempio  
 ...
 Eseguire il [!INCLUDE[tsql](../../../includes/tsql-md.md)]primo listato di codice ( ) per creare la tabella che verrà utilizzata nell'esempio.  
 ...
 Eseguire il [!INCLUDE[tsql](../../../includes/tsql-md.md)]quinto elenco di codice ( ) per eliminare la tabella utilizzata dall'esempio.  
