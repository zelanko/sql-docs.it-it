...
description: Informazioni su come usare un server di test per ottimizzare un database in un server di produzione. Questo è un importante vantaggio di Ottimizzazione guidata motore di database.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
