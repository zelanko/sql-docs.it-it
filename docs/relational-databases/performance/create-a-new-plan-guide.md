...
description: Informazioni su come creare una guida di piano usando SQL Server Management Studio o Transact-SQL. Una guida di piano applica a una query un piano di query fisso e hint per la query.
ms.custom: ''
ms.date: 08/02/2016
ms.prod: sql
ms.reviewer: ''
