...
description: Informazioni sulle guide di piano, che consentono di ottimizzare le prestazioni delle query senza modificare direttamente il testo della query in SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
