...
description: Informazioni sul monitoraggio dei database per valutare le prestazioni del server, sull'uso di snapshot periodici e sulla raccolta continua di dati per tenere traccia delle tendenze delle prestazioni.
ms.custom: ''
ms.date: 07/18/2016
ms.prod: sql
