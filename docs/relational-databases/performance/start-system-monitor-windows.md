...
description: Usare Monitor di sistema per la raccolta dei contatori dei dati sulle prestazioni, ad esempio l'uso del processore e della memoria, e per le risorse di SQL Server, ad esempio i blocchi e le transazioni.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
