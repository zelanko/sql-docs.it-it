...
description: Informazioni su come usare SQL Server Management Studio per salvare i piani di esecuzione in formato XML e per aprirli per la visualizzazione. Sono necessarie le autorizzazioni appropriate.
ms.custom: ''
ms.date: 08/21/2017
ms.prod: sql
