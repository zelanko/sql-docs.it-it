...
description: Informazioni sugli strumenti di monitoraggio e ottimizzazione di SQL Server e su come scegliere quello più adatto in base al tipo di monitoraggio e agli eventi da monitorare.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
