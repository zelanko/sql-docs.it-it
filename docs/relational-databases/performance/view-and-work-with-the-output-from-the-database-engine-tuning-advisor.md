---
title: Output di DTA
description: Informazioni su come usare i riepiloghi, le raccomandazioni, i report e i log di ottimizzazione creati da Ottimizzazione guidata motore di database durante l'installazione di SQL Server.
