...
|**All'utente autorizzato**|**smallint**|ID dell'utente, del gruppo o del ruolo a cui è stata concessa o negata l'autorizzazione.|  
|**Utente che concede**|**smallint**|ID dell'utente, del gruppo o del ruolo che ha concesso o negato l'autorizzazione.|  
