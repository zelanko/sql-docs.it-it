...
description: Informazioni su come creare o configurare entità di Resource Governor usando la pagina delle proprietà di Resource Governor in SQL Server Management Studio.
ms.custom: ''
ms.date: 07/18/2016
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE [SQL Server SQL MI](../../includes/applies-to-version/sql-asdbmi.md)]
 ...
 ##  <a name="related-topics"></a><a name="BeforeYouBegin"></a> Argomenti correlati 
...
##  <a name="resource-governor-properties-page"></a><a name="ViewRGProp"></a> Pagina Proprietà di Resource Governor  
