...
description: Il processo di classificazione di SQL Server Resource Governor consente di assegnare sessioni in ingresso a un gruppo di carico di lavoro in base alle caratteristiche della sessione.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
