...
## <a name="static-scenario"></a>Scenario statico  
 ...
 Le proprietà dell'oggetto set di righe di parametri con valori di tabella sono di sola lettura, pertanto non è previsto che il consumer imposti alcuna proprietà in *rgPropertySets*.  
