---
description: Set di righe dello schema modificati per i parametri con valori di tabella OLE DB in SQL Server Native Client
title: Set di righe dello schema, OLE DB parametri con valori di tabella
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "88482601"
---
# <a name="schema-rowsets-changed-for-ole-db-table-valued-parameters-in-sql-server-native-client"></a>Set di righe dello schema modificati per i parametri con valori di tabella OLE DB in SQL Server Native Client
