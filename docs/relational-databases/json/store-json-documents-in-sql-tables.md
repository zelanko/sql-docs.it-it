...
description: Questo articolo descrive perché e come archiviare e indicizzare i documenti JSON in SQL Server o nel database SQL e come ottimizzare le query sui documenti JSON.
ms.date: 06/03/2020
ms.prod: sql
ms.technology: ''
ms.topic: conceptual
