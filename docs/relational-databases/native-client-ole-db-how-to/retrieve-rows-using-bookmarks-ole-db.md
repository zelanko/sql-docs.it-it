---
description: Recuperare righe utilizzando i segnalibri (provider OLE DB Native Client)
title: Recuperare righe utilizzando i segnalibri (provider OLE DB Native Client)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97483212"
---
# <a name="retrieve-rows-using-bookmarks-native-client-ole-db-provider"></a>Recuperare righe utilizzando i segnalibri (provider OLE DB Native Client)
...
5.  Usare **IRowsetLocate::GetRowsAt** per recuperare le righe, a partire da quella specificata da un offset del segnalibro.  
