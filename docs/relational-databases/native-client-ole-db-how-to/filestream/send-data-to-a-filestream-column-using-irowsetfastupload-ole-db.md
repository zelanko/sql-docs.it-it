---
description: Inviare dati a una colonna FILESTREAM utilizzando IRowsetFastUpload SQL Server Native Client (OLE DB)
...
ms.locfileid: "88455735"
---
# <a name="send-data-to-a-filestream-column-using-irowsetfastupload-sql-server-native-client-ole-db"></a>Inviare dati a una colonna FILESTREAM utilizzando IRowsetFastUpload SQL Server Native Client (OLE DB)
