---
description: FileStream e OLE DB (provider OLE DB di Native Client)
title: FileStream e OLE DB (provider OLE DB di Native Client) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88407317"
---
# <a name="filestream-and-ole-db-native-client-ole-db-provider"></a>FileStream e OLE DB (provider OLE DB di Native Client)
