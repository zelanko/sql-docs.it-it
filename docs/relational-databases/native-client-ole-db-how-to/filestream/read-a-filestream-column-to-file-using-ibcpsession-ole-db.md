---
description: Leggere una colonna FILESTREAM in un file utilizzando IBCPSession in SQL Server Native Client (OLE DB)
...
ms.locfileid: "97464902"
---
# <a name="read-a-filestream-column-to-file-using-ibcpsession-in-sql-server-native-client-ole-db"></a>Leggere una colonna FILESTREAM in un file utilizzando IBCPSession in SQL Server Native Client (OLE DB)
