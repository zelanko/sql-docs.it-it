---
description: Recuperare dati da una colonna FILESTREAM utilizzando ISequentialStream in SQL Server Native Client (OLE DB)
title: FILESTREAM con ISequentialStream (OLE DB)
ms.custom: ''
ms.date: 03/07/2017
ms.prod: sql
