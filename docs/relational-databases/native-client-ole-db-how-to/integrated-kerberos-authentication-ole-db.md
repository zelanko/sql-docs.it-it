---
description: Autenticazione Kerberos integrata (provider OLE DB Native Client)
title: Autenticazione Kerberos integrata (provider OLE DB Native Client) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97481102"
---
# <a name="integrated-kerberos-authentication-native-client-ole-db-provider"></a>Autenticazione Kerberos integrata (provider OLE DB Native Client)
