---
description: Enumerare SQL Server Native Client OLE DB origini dati (OLE DB)
title: Enumerare OLE DB origini dati (provider OLE DB Native Client) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
