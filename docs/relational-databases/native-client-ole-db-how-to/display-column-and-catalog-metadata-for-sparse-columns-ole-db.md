---
description: SQL Server Native Client visualizzare i metadati della colonna e del catalogo per le colonne di tipo sparse (OLE DB)
...
ms.locfileid: "97469472"
---
# <a name="sql-server-native-client-display-column-and-catalog-metadata-for-sparse-columns-ole-db"></a>SQL Server Native Client visualizzare i metadati della colonna e del catalogo per le colonne di tipo sparse (OLE DB)
