...
ms.locfileid: "78937678"
---
# <a name="reorganize-and-rebuild-indexes"></a>Riorganizzare e ricompilare gli indici

[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

Questo articolo descrive come riorganizzare o ricompilare un indice frammentato in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] usando [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] o [!INCLUDE[tsql](../../includes/tsql-md.md)].
...
## <a name="how-to-remedy-index-fragmentation"></a>Come correggere la frammentazione dell'indice
...
Il primo passaggio per decidere il metodo di deframmentazione dell'indice da usare consiste nell'eseguire un'analisi dell'indice per determinare il grado di frammentazione.
...
Non è in genere consigliabile usare questi comandi per livelli di frammentazione molto ridotti (inferiori al 5%), poiché i vantaggi offerti dalla rimozione di una frammentazione così limitata sono quasi sempre annullati dal costo a livello di CPU della riorganizzazione o della ricompilazione dell'indice.
...
Una volta noto il grado di frammentazione dell'indice, usare la tabella seguente per determinare il metodo migliore per la correzione della frammentazione.
...
## <a name="check-index-fragmentation"></a>Controllare la frammentazione dell'indice
...
## <a name="remove-fragmentation"></a>Rimuovere la frammentazione
