...
```  
 ...
 Ogni volta che questi attributi sono impostati sui valori predefiniti, il driver ODBC di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] native client utilizza un set di risultati predefinito [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]. I set di risultati predefiniti possono essere utilizzati per qualsiasi istruzione SQL supportata da [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] e rappresentano il metodo più efficiente per trasferire un intero set di risultati al client.  
