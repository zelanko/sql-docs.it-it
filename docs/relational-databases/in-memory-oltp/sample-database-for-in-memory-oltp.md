...
1.  Scaricare ed eseguire il pacchetto di installazione x64 per le utilità RML dalla pagina seguente: [RML Utilities for SQL Server](https://www.microsoft.com/en-us/download/details.aspx?id=4511)
