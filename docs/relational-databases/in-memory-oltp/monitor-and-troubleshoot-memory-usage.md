...
description: Informazioni sul monitoraggio e la risoluzione dei problemi di utilizzo della memoria OLTP in memoria, che dispone di modelli diversi rispetto alle tabelle basate su disco in SQL Server.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
-   [Creare un database di esempio con tabelle ottimizzate per la memoria](../../relational-databases/in-memory-oltp/monitor-and-troubleshoot-memory-usage.md#bkmk_CreateDB)  
...
-   [Gestione della memoria utilizzata dagli oggetti ottimizzati per la memoria](../../relational-databases/in-memory-oltp/monitor-and-troubleshoot-memory-usage.md#bkmk_MemOptObjects)  
...
##  <a name="monitoring-memory-usage"></a><a name="bkmk_Monitoring"></a> Monitoraggio dell'utilizzo della memoria  
  
###  <a name="using-ssmanstudiofull"></a><a name="bkmk_UsingSSMS"></a> Uso [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]  
...
##  <a name="managing-memory-consumed-by-memory-optimized-objects"></a><a name="bkmk_MemOptObjects"></a> Gestione della memoria utilizzata dagli oggetti ottimizzati per la memoria  
...
##  <a name="troubleshooting-memory-issues"></a><a name="bkmk_Troubleshooting"></a> Risoluzione dei problemi relativi alla memoria  
