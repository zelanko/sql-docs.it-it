...
description: Informazioni sugli elementi di SQL Server Management Objects (SMO) che supportano OLTP in memoria. Esaminare i tipi e i membri nello spazio dei nomi Microsoft.SqlServer.Management.Smo.
