...
ms.locfileid: "52507215"
---
# <a name="migrating-to-in-memory-oltp"></a>Migrazione a OLTP in memoria
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]

  Gli articoli di questa sezione del Sommario descrivono come usare OLTP in memoria in un'applicazione esistente eseguendo la migrazione degli oggetti di database.  
...
-   [Assistente compilazione nativa](../../relational-databases/in-memory-oltp/native-compilation-advisor.md)  
  
-   [Cmdlet di PowerShell per la valutazione della migrazione](../../relational-databases/in-memory-oltp/powershell-cmdlet-for-migration-evaluation.md)  
...
-   [Migrazione di colonne calcolate](../../relational-databases/in-memory-oltp/migrating-computed-columns.md)  
  
-   [Migrazione di trigger](../../relational-databases/in-memory-oltp/migrating-triggers.md)  
  
-   [Query tra database](../../relational-databases/in-memory-oltp/cross-database-queries.md)  
  
-   [Implementazione di IDENTITY in una tabella con ottimizzazione per la memoria](../../relational-databases/in-memory-oltp/implementing-identity-in-a-memory-optimized-table.md)  
