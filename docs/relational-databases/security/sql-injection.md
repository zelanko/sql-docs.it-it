...
description: Informazioni sul funzionamento degli attacchi SQL injection. Attenuare questo tipo di attacchi convalidando l'input ed esaminando il codice per SQL injection in SQL Server.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
