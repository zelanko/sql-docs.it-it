...
NOTRUNCATE  
Sposta le pagine assegnate dalla fine del file alle pagine non assegnate all'inizio del file. Questa azione compatta i dati all'interno del file. _target\_percent_ è facoltativo. [!INCLUDE[ssSDW](../../includes/sssdwfull-md.md)] non supporta questa opzione. 
