 ...
 *integer_expression*  
 ...
 \<order_by_clause>  
 Determina l'ordine di assegnazione dei valori NTILE alle righe in una partizione. Una colonna non può essere rappresentata da un valore intero quando \<order_by_clause> viene usato in una funzione di rango.  
