---
description: Funzioni di sistema (Transact-SQL)
...
ms.locfileid: "88459573"
---
# <a name="system-functions-transact-sql"></a>Funzioni di sistema (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  Le funzioni di sistema riportate di seguito eseguono operazioni e restituiscono informazioni su valori, oggetti e impostazioni in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
