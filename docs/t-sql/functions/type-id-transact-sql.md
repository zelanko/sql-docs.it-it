...
### <a name="a-looking-up-the-type-id-values-for-single--and-two-part-type-names"></a>R. Ricerca dei valori di TYPE_ID per i nomi dei tipi composti da una o due parti  
