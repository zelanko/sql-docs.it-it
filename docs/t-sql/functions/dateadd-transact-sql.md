...
description: Informazioni di riferimento Transact-SQL per la funzione DATEADD. Questa funzione restituisce una data modificata dalla parte della data specificata.
ms.date: 07/29/2017
ms.prod: sql
