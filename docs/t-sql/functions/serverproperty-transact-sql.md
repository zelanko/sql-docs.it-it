...
|IsBigDataCluster| Introdotta in [!INCLUDE[ssSQL2019](../../includes/sssqlv15-md.md)] a partire da CU4.<br /><br />Restituisce 1 se l'istanza è un cluster Big Data di SQL Server; 0 in caso contrario.|  
...
|IsLocalDB|**Si applica a**: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] e versioni successive.<br /><br /> Il server è un'istanza del database locale di [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)].<br /><br /> NULL = input non valido, errore o non applicabile.|  
