...
|Recupero|Modello di recupero del database|FULL: Modello di recupero con registrazione completa<br /><br /> BULK_LOGGED: modello con registrazione minima delle operazioni bulk<br /><br /> SIMPLE: Modello di recupero con registrazione minima<br /><br /> Tipo di dati di base: **nvarchar(128)**|  
...
### <a name="a-retrieving-the-status-of-the-auto_shrink-database-option"></a>A. Recupero dello stato dell'opzione AUTO_SHRINK del database  
