...
ms.locfileid: "66826870"
---
# <a name="set-result-set-caching-transact-sql-applies-to-azure-sql-data-warehouse-gen2-only-preview"></a>SET RESULT SET CACHING (Transact-SQL) si applica solo ad Azure SQL Data Warehouse Gen2 (anteprima)
