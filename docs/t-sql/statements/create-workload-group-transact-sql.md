...
||||
|---|---|---|
|[SQL Server](create-workload-group-transact-sql.md?view=sql-server-2017)|**_\* Istanza gestita<br />database SQL \*_** &nbsp;|[Azure Synapse<br />Analytics](create-workload-group-transact-sql.md?view=azure-sqldw-latest)|
||||
