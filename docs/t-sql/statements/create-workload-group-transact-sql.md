...
-   Impostando *value* su 0 si impedisce l'esecuzione delle query con operazioni SORT e HASH MATCH nei gruppi di carico di lavoro definiti dall'utente.  
...
### <a name="1-shows-how-to-create-a-workload-group-named-newreports"></a>1. Illustra come creare un gruppo di carico di lavoro denominato newReports    
