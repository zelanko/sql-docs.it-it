...
-   Livello di isolamento SNAPSHOT. Per altre informazioni sull'isolamento dello snapshot, vedere [Isolamento dello Snapshot in SQL Server](/dotnet/framework/data/adonet/sql/snapshot-isolation-in-sql-server). 
