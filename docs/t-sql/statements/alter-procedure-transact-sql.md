 ...
 *default*  
 ...
 ENCRYPTION  
 **Si applica a**: SQL Server ([!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] e versioni successive) e [!INCLUDE[ssSDSFull](../../includes/sssdsfull-md.md)].  
