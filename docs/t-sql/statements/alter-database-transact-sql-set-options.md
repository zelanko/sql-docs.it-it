...
OFF        
Specifica che i set di risultati delle query restituiti da questo database non verranno memorizzati nella cache della risorsa di archiviazione di Azure SQL Data Warehouse. 
