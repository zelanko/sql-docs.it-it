...
ms.locfileid: "65560185"
---
# <a name="alter-database-set-options-transact-sql"></a>Opzioni ALTER DATABASE SET (Transact-SQL)

Imposta le opzioni di database in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], in un database SQL di Azure e in Azure SQL Data Warehouse. Per altre opzioni di ALTER DATABASE, vedere [ALTER DATABASE](../../t-sql/statements/alter-database-transact-sql.md).
...
DEFAULT_FULLTEXT_LANGUAGE **Si applica a**: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] fino a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].
...
DEFAULT_LANGUAGE **Si applica a**: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] fino a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].
...
TWO_DIGIT_YEAR_CUTOFF **Si applica a**: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] fino a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].
...
OFF: il database crea sempre le pagine iniziali usando extent uniformi. OFF è il valore predefinito.
...
ON | OFF | CLEAR [ ALL ] controlla se l'archivio di query è abilitato in questo database e controlla anche la rimozione di contenuto dall'archivio query. Per altre informazioni, vedere [Scenari di utilizzo di Query Store](../../relational-databases/performance/query-store-usage-scenarios.md).
...
> [!NOTE]
> Per Azure SQL Data Warehouse, è necessario eseguire `ALTER DATABASE SET QUERY_STORE` dal database utente. L'esecuzione dell'istruzione da un'altra istanza del data warehouse non è supportata.
...
Se si specifica ON, non è possibile specificare anche l'argomento CREDENTIAL. Se si specifica OFF, è necessario fornire l'argomento CREDENTIAL.
