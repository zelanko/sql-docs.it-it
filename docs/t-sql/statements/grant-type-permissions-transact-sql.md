---
description: GRANT - autorizzazioni per tipi (Transact-SQL)
 ...
 *permission*  
 ...
 TO \<database_principal> Specifica l'entità a cui viene concessa l'autorizzazione.  
