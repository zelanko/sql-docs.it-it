---
description: Autorizzazioni per entità server DENY (Transact-SQL)
...
### <a name="a-denying-impersonate-permission-on-a-login"></a>R. Negazione dell'autorizzazione IMPERSONATE per un account di accesso  
