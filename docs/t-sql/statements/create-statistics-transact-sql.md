...
### <a name="e-using-create-statistics-with-fullscan-and-persist_sample_percent"></a>E. Uso di CREATE STATISTICS con le opzioni FULLSCAN e PERSIST_SAMPLE_PERCENT  
