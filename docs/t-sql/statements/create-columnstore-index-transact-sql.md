...
### <a name="f-create-an-ordered-clustered-columnstore-index"></a>F. Creare un indice columnstore cluster ordinato

Creare un indice columnstore cluster ordinato in base a SHIPDATE.
