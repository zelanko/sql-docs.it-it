...
Poiché [!INCLUDE[ssSDW](../../includes/sssdwfull-md.md)] non supporta i join ANSI nella clausola `FROM` di un'istruzione `UPDATE`, non è possibile usare questo codice di SQL Server senza modificarlo leggermente.
