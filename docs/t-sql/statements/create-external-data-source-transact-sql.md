...
### <a name="b-create-external-data-source-to-reference-azure-data-lake-store-gen-1"></a>B. Creare un'origine dati esterna per fare riferimento ad Azure Data Lake Store Gen1
