---
description: '&gt; (maggiore di) (Transact-SQL)'
title: '&gt; (maggiore di) (Transact-SQL) | Microsoft Docs'
ms.custom: ''
ms.date: 03/13/2017
ms.prod: sql
...
### <a name="b-using--to-compare-two-variables"></a>B. Uso di < per confrontare due variabili  
