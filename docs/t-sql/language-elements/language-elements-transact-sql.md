---
description: Elementi del linguaggio (Transact-SQL)
...
[Transazioni (Azure Synapse Analytics)](../../t-sql/language-elements/transactions-sql-data-warehouse.md)
