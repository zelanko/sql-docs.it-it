...
description: In questo articolo viene fornita una breve spiegazione dei diversi download e pacchetti autonomi forniti da Microsoft per aggiungere valore per SQL Server.
ms.prod: sql
...
In questo articolo viene fornita una breve spiegazione dei diversi download e pacchetti autonomi forniti da Microsoft per aggiungere valore per SQL Server.
...
## <a name="command-line-programming-and-t-sql"></a>Riga di comando, programmazione e T-SQL
...
| [SQL Server Data-Tier Application Framework](https://www.microsoft.com/en-us/download/details.aspx?id=56508) | SQL Server Data-Tier Application Framework è un componente basato su .NET Framework che fornisce servizi relativi al ciclo di vita delle applicazioni per lo sviluppo e la gestione di database. |
...
| [Integration Services Feature Pack per le SQL Server più recenti](https://www.microsoft.com/download/details.aspx?id=100303) | Questi pacchetti autonomi forniscono valore aggiuntivo per le Integration Services di Microsoft SQL Server più recenti. |
