---
title: Proprietà - SQL Server Agent (scheda Avanzate)
description: Informazioni sulle opzioni disponibili nella scheda Avanzate della finestra di dialogo Proprietà SQL Server Agent, ad esempio la directory dump e l'ID istanza.
