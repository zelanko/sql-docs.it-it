---
title: Proprietà - SQL Server Browser (scheda Avanzate)
description: Informazioni sulle opzioni disponibili nella scheda Avanzate della finestra di dialogo Proprietà - SQL Server Browser, ad esempio la directory dump e l'ID istanza.
