...
description: Informazioni sul funzionamento di SQL Server Profiler, su come usarlo per tracciare gli eventi e su dove trovare altre informazioni sulle relative funzionalità.
ms.prod: sql
