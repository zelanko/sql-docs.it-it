---
title: Arrestare una traccia
titleSuffix: SQL Server Profiler
description: Informazioni su come arrestare una traccia che viene eseguita in SQL Server Profiler, modificare le proprietà che si vogliono regolare e salvare i dati acquisiti.
ms.prod: sql
