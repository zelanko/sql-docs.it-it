...
description: Di seguito viene descritto come usare SQL Server Profiler per esportare un modello di traccia come file modello per usarlo con un'altra istanza di SQL Server Profiler.
ms.prod: sql
