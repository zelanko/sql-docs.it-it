---
title: Importare un modello di traccia
titleSuffix: SQL Server Profiler
description: Informazioni su come importare un modello definito dall'utente in SQL Server Profiler e renderlo disponibile per le tracce insieme ai modelli di sistema predefiniti.
ms.prod: sql
