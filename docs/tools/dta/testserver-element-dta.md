...
description: Nell'utilità dta l'elemento TestServer indica il server di prova da usare durante l'ottimizzazione di un server di produzione.
ms.prod: sql
