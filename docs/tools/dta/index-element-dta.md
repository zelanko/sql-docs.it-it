...
description: Nell'utilità dta l'elemento Index contiene informazioni su un indice che si vuole creare o eliminare per una configurazione specificata dall'utente.
ms.prod: sql
