...
## <a name="remarks"></a>Note  
 ...
 La [funzione &#40;DMX&#41; lag](../dmx/lag-dmx.md) può essere utilizzata con i modelli Time Series per restituire o filtrare in un intervallo di tempo compreso tra ogni case e l'ora iniziale.  
  
 L'utilizzo [della &#40;funzione&#41; DMX IsInNode](../dmx/isinnode-dmx.md) nella clausola **where** restituisce solo i case associati al nodo specificato dalla colonna NODE_UNIQUE_NAME del set di righe dello schema.  
  
## <a name="examples"></a>Esempi  
 Gli esempi seguenti si basano sulla struttura di data mining Targeted mailing, basata [!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)]sul database e sui modelli di data mining associati. Per ulteriori informazioni, vedere [esercitazione di base sul data mining](https://msdn.microsoft.com/library/6602edb6-d160-43fb-83c8-9df5dddfeb9c).  
  
### <a name="example-1-drillthrough-to-model-cases-and-structure-columns"></a>Esempio 1: Drill-through ai case del modello e alle colonne della struttura  
