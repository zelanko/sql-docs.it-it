---
description: Operatori logici (DMX)
title: Operatori logici (DMX) | Microsoft Docs
ms.date: 06/07/2018
ms.prod: sql
...
ms.locfileid: "88395717"
---
# <a name="operators---logical"></a>Operatori logici
[!INCLUDE[ssas](../includes/applies-to-version/ssas.md)]

  È possibile utilizzare gli operatori logici nelle espressioni DMX (Data Mining Extensions) per valutare i valori e restituire un valore booleano in [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] .  
