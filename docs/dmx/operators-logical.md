---
title: Gli operatori logici (DMX) | Microsoft Docs
ms.date: 06/07/2018
ms.prod: sql
...
[!INCLUDE[ssas-appliesto-sqlas](../includes/ssas-appliesto-sqlas.md)]
  ...
  È possibile usare gli operatori logici nelle espressioni di Data Mining Extensions (DMX) per valutare i valori e restituire un valore booleano [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)].  
...
|[OR &#40;DMX&#41;](../dmx/or-dmx.md)|Esegue la disgiunzione logica di due espressioni numeriche.|  
