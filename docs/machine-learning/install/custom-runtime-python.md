...
Scaricare il file ZIP che contiene l'estensione del linguaggio Python, [python-lang-extension.zip](https://go.microsoft.com/fwlink/?linkid=2143952).
...
Scaricare il file ZIP che contiene l'estensione del linguaggio Python, [python-lang-extension.zip](https://go.microsoft.com/fwlink/?linkid=2143793).
