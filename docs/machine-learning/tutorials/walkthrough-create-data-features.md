...
7. Facoltativamente, è possibile chiamare [rxGetVarInfo](/r-server/r-reference/revoscaler/rxgetvarinfo) per esaminare lo schema dell'origine dati trasformata.
