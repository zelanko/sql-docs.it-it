...
In questa serie di esercitazioni in cinque parti per i programmatori SQL verranno fornite informazioni sull'integrazione di Python in [Machine Learning Services in Istanza gestita di SQL di Azure (anteprima)](/azure/azure-sql/managed-instance/machine-learning-services-overview).
::: moniker-end
