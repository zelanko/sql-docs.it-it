...
> [!Note]
> La funzionalità R Services, rinominata in [Machine Learning Services](../what-is-sql-server-machine-learning.md) in SQL Server 2017 e versioni successive, supporta sia Python che R.
