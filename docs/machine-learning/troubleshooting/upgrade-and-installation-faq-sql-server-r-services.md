---
title: Domande frequenti sull'installazione e sull'aggiornamento
description: Risposte ad alcune domande comuni sull'installazione o sull'aggiornamento delle funzionalità di Machine Learning in SQL Server.
ms.prod: sql
...
ms.locfileid: "87253711"
---
# <a name="installation-and-upgrade-faq-for-sql-server-machine-learning-or-r-server"></a>Domande frequenti sull'installazione e sull'aggiornamento delle funzionalità di Machine Learning di SQL Server o di R Server
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

Questo articolo fornisce le risposte ad alcune domande comuni sull'installazione delle funzionalità di Machine Learning in SQL Server. Sono anche riportate domande frequenti sugli aggiornamenti.
