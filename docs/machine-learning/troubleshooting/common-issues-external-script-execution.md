...
Se si riscontrano problemi non trattati in questo argomento, è possibile pubblicare domande nel [forum di Machine Learning Server](https://social.msdn.microsoft.com/Forums/home?category=MicrosoftR).
