...
## <a name="discontinued-features-in-includesssql15includessssql15-mdmd"></a>Funzionalità non più disponibili in [!INCLUDE[ssSQL15](../includes/sssql15-md.md)]  
