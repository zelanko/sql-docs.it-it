...
description: Informazioni su un endpoint di mirroring del database dedicato, necessario affinché ogni server partecipi a gruppi di disponibilità Always On o al mirroring dei database.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
