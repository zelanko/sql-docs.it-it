...
description: Informazioni sulle considerazioni per combinare log shipping e il mirroring del database in SQL Server, incluso il numero di server di destinazione necessari.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
