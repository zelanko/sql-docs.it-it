...
description: Informazioni su SQL Server Browser. Questo servizio è in ascolto delle richieste di risorse di SQL Server e fornisce informazioni sulle istanze di SQL Server installate.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Nascondere un'istanza del motore di database di SQL Server](../../database-engine/configure-windows/hide-an-instance-of-sql-server-database-engine.md)  
