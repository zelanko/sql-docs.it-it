...
description: Informazioni su come aprire Amministrazione origine dati ODBC in diversi sistemi operativi. È possibile usare questo componente di Windows per creare e gestire origini dati ODBC.
ms.custom: ''
ms.date: 11/07/2016
ms.prod: sql
...
> [!NOTE]  
> Per le connessioni all'autenticazione di Azure Active Directory per il database SQL, installare il driver più recente, ad esempio il [driver ODBC 17 per SQL Server](../../connect/odbc/download-odbc-driver-for-sql-server.md).  
