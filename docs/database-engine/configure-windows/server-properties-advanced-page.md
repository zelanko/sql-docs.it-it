...
description: Acquisire familiarità con le impostazioni avanzate del server di SQL Server. Informazioni sulle opzioni FILESTREAM, varie soglie, alternative di aggiornamento full-text e altre impostazioni.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
