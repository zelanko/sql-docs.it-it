...
description: Acquisire familiarità con le opzioni di avvio del motore di database di SQL Server. Suggerimenti su come usarle e informazioni sullo scopo di ogni opzione.
ms.custom: ''
ms.date: 08/01/2019
ms.prod: sql
