...
## <a name="see-also"></a>Vedere anche  
 [Opzioni &#40;Esecuzione query: SQL Server: Pagina Avanzate&#41;](https://docs.microsoft.com/sql/ssms/f1-help/database-engine-query-editor-sql-server-management-studio)   
