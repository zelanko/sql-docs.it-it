...
|Algoritmi hash|Algoritmi MD2, MD4, MD5, SHA e SHA1. Questi algoritmi non devono essere usati.|Usare SHA2_256 o SHA2_512.|Algoritmo hash deprecato||  
...
|Trace Management Objects|Spazio dei nomi Microsoft.SqlServer.Management.Trace (contiene le API per gli oggetti Trace and Replay di SQL Server)|Configurazione della traccia: <xref:Microsoft.SqlServer.Management.XEvent><br /><br /> Lettura della traccia: <xref:Microsoft.SqlServer.XEvent.Linq><br /><br /> Riproduzione della traccia: None|||  
