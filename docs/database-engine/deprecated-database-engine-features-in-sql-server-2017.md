...
|Algoritmi hash|L'uso di MD2, MD4, MD5, SHA e SHA1 è deprecato.|Usare invece SHA2_256 o SHA2_512. Gli algoritmi precedenti continueranno a funzionare, ma genereranno un evento Deprecation.|Algoritmo hash deprecato|None|  
