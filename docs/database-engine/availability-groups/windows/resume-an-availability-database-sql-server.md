...
description: Procedura per riprendere un database messo in pausa all'interno di un gruppo di disponibilità Always On usando SQL Server Management Studio (SSMS), Transact-SQL (T-SQL) o SQL PowerShell.
