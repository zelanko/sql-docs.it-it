...
description: Usare istruzioni Transact-SQL SELECT per monitorare i gruppi di disponibilità Always On e i relativi database e repliche.
ms.custom: seodec18
ms.date: 05/17/2016
ms.prod: sql
ms.reviewer: ''
