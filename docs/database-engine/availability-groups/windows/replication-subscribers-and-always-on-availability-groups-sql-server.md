...
description: Informazioni su cosa accade se un gruppo di disponibilità Always On contenente un database che rappresenta un sottoscrittore di replica esegue il failover in SQL Server.
