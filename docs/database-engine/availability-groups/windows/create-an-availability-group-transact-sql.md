...
description: Usare Transact-SQL per creare e configurare un gruppo di disponibilità nelle istanze di SQL Server 2019 (15.x) in cui è abilitata la funzionalità dei gruppi di disponibilità Always On.
