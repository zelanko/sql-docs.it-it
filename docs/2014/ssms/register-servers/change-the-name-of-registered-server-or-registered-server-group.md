...
## <a name="see-also"></a>Vedere anche  
 [Modificare la &#40;di registrazione di un server SQL Server Management Studio&#41;](change-a-server-s-registration-sql-server-management-studio.md)
