...
# <a name="options-environment-help-general-page"></a>Opzioni (ambiente-Guida-pagina generale)
  Utilizzare la finestra di dialogo **Opzioni** per scegliere i set di documentazione e decidere se visualizzare gli [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] argomenti internamente o esternamente in una finestra separata. Per accedere a questa finestra di dialogo, scegliere **Opzioni** dal menu **Strumenti** , espandere **Guida** nel nodo **Ambiente** e fare clic su **Generale**.  
