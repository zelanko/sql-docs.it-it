...
# <a name="sql-server-agent-fixed-database-roles"></a>Ruoli di database predefiniti di SQL Server Agent
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]dispone dei ruoli predefiniti del database msdb del database **msdb** , che offrono agli amministratori un controllo [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] più preciso sull'accesso a Agent. Sono previsti i seguenti ruoli, elencati a partire da quello che ha meno privilegi:  
 ...
 **SQLAgentUserRole** è il privilegio minimo dei ruoli [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] predefiniti del database di Agent. Dispone di autorizzazioni solo su operatori, processi locali e pianificazioni di processi. I membri del ruolo **SQLAgentUserRole** hanno autorizzazioni solo sui processi locali e le pianificazioni di processo di cui sono proprietari. Essi non possono utilizzare processi multiserver (processi per server master e di destinazione) e non possono modificare la proprietà dei processi per ottenere l'accesso a processi di cui non sono già proprietari. I membri di **SQLAgentUserRole** possono visualizzare un elenco di proxy disponibili solo nella finestra di dialogo **Proprietà passaggio processo** di [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]. Ai membri del ruolo **SQLAgentUserRole** è visibile solo il nodo [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]Processi** in Esplora oggetti di **.  
...
|Azione|Operatori|Processi locali<br /><br /> (solo processi di proprietà)|Pianificazioni dei processi<br /><br /> (solo pianificazioni di proprietà)|Proxy|  
|------------|---------------|----------------------------------------|------------------------------------------------|-------------|  
...
|Visualizzare la cronologia processo|Non applicabile|Sì|Non applicabile|Non applicabile|  
...
|Visualizzare la cronologia processo|Non applicabile|Sì|Sì|Non applicabile|Non applicabile|  
...
|Visualizzare la cronologia processo|Non applicabile|Non applicabile|Sì|Sì|Non applicabile|Non applicabile|  
