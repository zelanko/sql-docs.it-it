 ...
 **Indice o chiave primaria/univoca selezionata**  
...
-   **Sì** [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] genera un avviso, ignora la riga in ingresso danneggiata e tenta di inserire le righe rimanenti.  
 ...
 **Disabilitato**  
 Indica se l'indice è disabilitato. La proprietà è di sola lettura. Viene impostata su **Sì** solo se l'indice è stato disabilitato all'esterno di Visual Database Tools.  
