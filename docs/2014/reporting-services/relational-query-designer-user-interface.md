...
>  
 ...
 ![Progettazione query con interfaccia grafica](https://docs.microsoft.com/analysis-services/analysis-services/media/rsqd-relational-graphical.gif "Progettazione query con interfaccia grafica")  
