...
-   [Recapito della raccolta di SharePoint in Reporting Services](sharepoint-library-delivery-in-reporting-services.md) Descrive il recapito della sottoscrizione a una raccolta di SharePoint.  
  
-   [Sottoscrizioni guidate dai dati](data-driven-subscriptions.md) Vengono fornite informazioni sull'utilizzo di sottoscrizioni guidate dai dati per personalizzare l'output del report in fase di esecuzione.  
