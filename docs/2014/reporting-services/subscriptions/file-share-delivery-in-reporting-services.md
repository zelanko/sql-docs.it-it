...
-   [Opzioni file](#bkmk_file_options)  
  
##  <a name="bkmk_Characteristics"></a>Caratteristiche di un report recapitato a una cartella condivisa  
...
##  <a name="bkmk_file_options"></a>Opzioni file  
