...
ms.locfileid: "66097567"
---
# <a name="pathname-property-wmi-msreportserver_configurationsetting"></a>Proprietà PathName (MSReportServer_ConfigurationSetting WMI)
...
## <a name="property-values"></a>Valori della proprietà  
 Oggetto `String` che rappresenta il percorso di installazione.  
