...
-   TargetServerVersion è una proprietà di distribuzione che identifica la versione prevista [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] di installata nel server di report di destinazione specificato nella proprietà TargetServerURL.  
...
|Progetto server di report<br /><br /> o<br /><br /> Progetto Creazione guidata report|[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]|Schema RDL 2005|[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]o [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] server di report||  
...
|Controlli dei visualizzatori di [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]|[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]2005<br /><br /> [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]2008|RDL 2008 non supportato in modalità locale|N/D|Consente di visualizzare i report RDL [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 2008 sul server di report in modalità server.|  
