...
|**Gestione configurazione**|Sì|** \* Importante \* \* ** Non è possibile utilizzare Configuration Manager per gestire un server di report in modalità SharePoint. Usare invece Amministrazione centrale SharePoint.|  
