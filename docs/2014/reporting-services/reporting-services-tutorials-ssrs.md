...
# <a name="reporting-services-tutorials-ssrs"></a>Esercitazioni su Reporting Services (SSRS)
 ...
 Eseguire la procedura descritta in questa esercitazione per informazioni su come accedere [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)] ai servizi Web da un'applicazione creata [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] con [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[csprcs](../includes/csprcs-md.md)]o.  
 ...
 Eseguire la procedura descritta in questa esercitazione per apprendere come utilizzare lo strumento XML Schema Definition (XSD. exe) per generare classi che consentono di serializzare e deserializzare i file di definizione dei [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]report (con estensione rdl e rdlc) con.  
