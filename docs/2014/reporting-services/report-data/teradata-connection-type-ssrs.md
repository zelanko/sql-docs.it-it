...
##  <a name="Models"></a>Modelli di report  
 Per creare un set di dati da un modello di report basato su un'origine dati Teradata, il modello deve essere progettato in Progettazione modelli [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] in e pubblicato in un server di report.  
...
##  <a name="Related"></a>Sezioni correlate  
 ...
 [Uso di SQL Server 2008 Reporting Services con la provider di dati .NET Framework per Teradata](https://go.microsoft.com/fwlink/?LinkID=130848)  
