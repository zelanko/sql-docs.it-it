...
-   **Estensioni per il rendering di interruzioni di pagina** manuali Le estensioni renderer di interruzioni di pagina manuali mantengono il layout e la formattazione del report. Il file risultante è ottimizzato per garantire una stampa coerente o per la visualizzazione del report online in formato libro.  
...
##  <a name="OtherWaysExportingReports"></a>Altre modalità di esportazione dei report  
