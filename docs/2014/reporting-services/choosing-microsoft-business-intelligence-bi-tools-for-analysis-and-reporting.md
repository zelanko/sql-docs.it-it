...
|Eseguire analisi predittive self-service||||||[Componenti aggiuntivi Data mining per Excel](https://docs.microsoft.com/analysis-services/data-mining-client-for-excel-sql-server-data-mining-add-ins)|  
