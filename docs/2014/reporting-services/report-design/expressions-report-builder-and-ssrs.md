...
### <a name="report-model-formulas"></a>Formule di modelli di report  
 ...
 Per altre informazioni, vedere [Formule nelle query del modello di report &#40;Generatore report e SSRS&#41;](formulas-in-report-model-queries-report-builder-and-ssrs.md).  
