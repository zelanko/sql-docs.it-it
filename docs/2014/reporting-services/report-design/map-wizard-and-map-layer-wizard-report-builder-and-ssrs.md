...
-   **Dati spaziali.** Dall'origine dati spaziali, un campo che contiene set di coordinate che specificano le posizioni.  
...
1.  [Scegliere un'origine dati spaziali](#SpatialDataSource). I dati spaziali possono provenire dalla raccolta mappe, ovvero un file di forma Environmental Systems Research Institute, Inc. (ESRI) o da dati spaziali di un database relazionale [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] .  
    ...
    -   [Che cos'è una query spaziale SQL Server?](#SqlServerSpatial)  
...
2.  [Scegliere Opzioni dati spaziali e vista mappa](#MapView). Impostare la vista e la risoluzione mappa, specificare se incorporare i dati spaziali nel report e se includere uno sfondo a tessere con le tessere mappa di [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Bing.  
    ...
    -   [Che cosa fa l'incorporamento dei dati spaziali?](#Embed)  
  
    -   [Che cos'è uno sfondo a tessere mappa di Bing?](#Tiles)  
  
3.  [Scegliere la visualizzazione mappa](#Visualization). Scegliere il tipo di mappa da creare.  
  
    -   [Qual è la differenza tra una mappa di base, una mappa a bolle e una mappa analitica?](#MapType)  
...
7.  [Specificare i campi delle corrispondenze per i dati spaziali e analitici](#SpecifyMatchFields). Compilare una relazione tra i dati spaziali e i dati analitici in modo che l'aspetto degli elementi della mappa possa variare in base ai dati.  
  
    -   [Che cos'è un campo delle corrispondenze?](#MatchFields)  
...
###  <a name="GetShapefiles"></a>Dove è possibile ottenere I forma ESRI?  
...
###  <a name="SqlServerSpatial"></a>Che cos'è una query spaziale SQL Server?  
...
###  <a name="Embed"></a>Che cosa fa l'incorporamento dei dati spaziali?  
...
###  <a name="Tiles"></a>Che cos'è uno sfondo a tessere mappa di Bing?  
...
-   **Aerea.** Visualizza solo una vista aerea. Con questa modalità non viene visualizzato alcun testo.  
...
##  <a name="Visualization"></a>Scegliere la visualizzazione mappa  
...
###  <a name="MapType"></a>Qual è la differenza tra una mappa di base, una mappa a bolle e una mappa analitica?  
...
##  <a name="AnalyticalData"></a>Scegliere il set di dati analitici  
...
###  <a name="Diff"></a>Qual è la differenza tra dati spaziali e dati analitici?  
...
##  <a name="SpecifyMatchFields"></a>Specificare i campi delle corrispondenze  
 In questa pagina compilare una relazione tra i dati spaziali e i dati analitici.  
  
###  <a name="MatchFields"></a>Che cosa sono i campi delle corrispondenze?  
...
##  <a name="ThemeandVisualization"></a>Scegliere tema colori e visualizzazione dati  
...
###  <a name="Theme"></a>Che cosa fa il tema?  
...
###  <a name="Legends"></a>Quali sono le legende e le scale nell'anteprima della mappa per?  
...
###  <a name="Rules"></a>Che cosa sono le regole?  
