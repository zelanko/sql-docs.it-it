...
# <a name="formatting-scales-on-a-gauge-report-builder-and-ssrs"></a>Formattazione di scale su un misuratore (Generatore report e SSRS)
 ...
 ![Panoramica degli elementi della scala di un misuratore](../media/scaleoverviewdiagram.gif "Panoramica degli elementi della scala di un misuratore")  
