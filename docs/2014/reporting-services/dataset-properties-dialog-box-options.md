 ...
 **Regole di confronto**  
 Consente di selezionare le impostazioni locali che determinano la sequenza di regole di confronto da utilizzare per l'ordinamento dei dati. **Default** indica che il server di report deve tentare di derivare il valore dal provider di dati durante l'esecuzione del report. Se non è possibile recuperare il valore, il valore predefinito viene ottenuto in base alle impostazioni locali del computer.  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Nome delle regole di confronto di Windows &#40;Transact-SQL&#41;](/sql/t-sql/statements/windows-collation-name-transact-sql)   
 [SQL Server nome delle regole di confronto &#40;&#41;Transact-SQL](/sql/t-sql/statements/sql-server-collation-name-transact-sql)   
