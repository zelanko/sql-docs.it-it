...
4.  Aggiungere una voce per l'estensione per l'elaborazione dati che include un' **estensione** elemento con i valori per il `Name`, `Type`, e `Visible` attributi. La voce può essere simile alla seguente:  
