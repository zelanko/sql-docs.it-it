...
- [Supporto del browser per controlli del server Web ReportViewer in Visual Studio](#bkmk_controls)  
...
|**Mozilla Firefox (ultima versione rilasciata pubblicamente)**|32 bit|32 bit|32 bit|32 bit|32 bit|Non supportato|  
...
|**Apple Safari (ultima versione rilasciata pubblicamente)**|Non supportate|Non supportate|Non supportate|Non supportate|Non supportate|32 bit, 64 bit|  
|**Google Chrome (ultima versione pubblicamente rilasciata)**|32 bit **(\*)** per un periodo di tempo limitato|32 bit **(\*)** per un periodo di tempo limitato|32 bit **(\*)** per un periodo di tempo limitato|32 bit **(\*)** per un periodo di tempo limitato|32 bit **(\*)** per un periodo di tempo limitato|Non supportato|  
...
|**Internet Explorer 9**|Non supportato|32 bit, 64 bit|Non supportato|32 bit, 64 bit|32 bit, 64 bit|Non supportate|Non supportate|  
|**Internet Explorer 8**|Non supportato|32 bit, 64 bit|Non supportato|32 bit, 64 bit|32 bit, 64 bit|Non supportate|Non supportate|  
...
|**Firefox (ultima versione rilasciata pubblicamente)**|Sì|Sì|Sì|Sì|Sì|Non supportato|La stampa e lo zoom non sono supportati.|  
