...
## <a name="next-steps"></a>Passaggi successivi
 ...
 [Strumenti di Reporting Services](tools/reporting-services-tools.md) [ReportServer &#40;modalità nativa SSRS&#41; ](../../2014/reporting-services/report-manager-ssrs-native-mode.md) [visualizzatore HTML e barra degli strumenti Report](html-viewer-and-the-report-toolbar.md) [riferimento ai parametri di accesso URL](url-access-parameter-reference.md)  
