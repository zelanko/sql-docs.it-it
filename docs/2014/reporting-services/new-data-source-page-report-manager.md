 ...
 **Tipo di origine dati**  
 Consente di specificare l'estensione per l'elaborazione dati utilizzata per elaborare i dati dall'origine dati. Il server di report include estensioni per [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]l' [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]elaborazione dati per [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)],, Oracle,, SAP, XML, ODBC e OLE DB. È possibile che siano disponibili ulteriori estensioni per l'elaborazione dati di terze parti.  
 ...
 **Stringa di connessione**  
 ...
 Nell'esempio seguente viene illustrata una stringa di connessione utilizzata per la [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssSampleDBnormal](../includes/sssampledbnormal-md.md)] connessione al database:  
