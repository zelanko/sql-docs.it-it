 ...
 **Nome gruppo o utente**  
 Digitare il nome di un account utente o di gruppo per il quale si desidera creare l'assegnazione di ruolo. Il nome utente o il nome di gruppo deve corrispondere a un account di dominio di Windows valido. Immettere l'account nel formato: \<dominio>\\<account.\>  
