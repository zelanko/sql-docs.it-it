...
-   [Confronto tra le attività in modalità nativa e le autorizzazioni di SharePoint](#bkmk_compare_tasks_permissions)  
  
##  <a name="bkmk_compare_tools_terms"></a>Confrontare strumenti di autorizzazione e terminologia  
 **Modalità nativa:** Gli [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] oggetti di autorizzazione (ruoli e attività) in modalità nativa vengono [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] creati in e configurati per i singoli utenti in Gestione report.  
  
 **Modalità SharePoint:** [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] in modalità SharePoint vengono utilizzate le funzionalità di autorizzazione di SharePoint. I gruppi e le autorizzazioni di SharePoint vengono gestiti dalla seguente pagina **Impostazioni sito** .  
...
|---------------------------------------------|----------------|  
|**Ruolo:** Ad esempio "Gestione contenuto".|**Gruppo:** Ad esempio, il gruppo "visualizzatori" predefinito.|  
|---|**Gruppo livello di autorizzazione:** Ad esempio "solo visualizzazione" per il gruppo "visualizzatori".|  
|**Attività:** ad esempio "gestione di report".|**Autorizzazioni:** Ad esempio, all'interno del gruppo "solo visualizzazione" sono presenti autorizzazioni correlate all'elenco degli elementi della visualizzazione, delle versioni di visualizzazione e della visualizzazione delle pagine dell'applicazione.|  
...
|**Report personali**|Nessun gruppo equivalente. **Report personali** non è supportato per un server di report eseguito in modalità SharePoint. Se si desidera utilizzare funzionalità equivalenti, è possibile utilizzare quelle di Sito personale in [!INCLUDE[winSPServ](../includes/winspserv-md.md)] .|  
...
##  <a name="bkmk_compare_tasks_permissions"></a>Confronto tra le attività in modalità nativa e le autorizzazioni di SharePoint  
