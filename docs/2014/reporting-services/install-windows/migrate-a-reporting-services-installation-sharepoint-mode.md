 ...
 **Migrazione solo del contenuto di servizi di report:** Se si desidera copiare le [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] contenuto in una nuova farm, quindi è necessario usare strumenti come **rs.exe** per copiare il contenuto nella nuova installazione di SharePoint. Per altre informazioni sulle migrazioni solo del contenuto, vedere quanto riportato di seguito:  
