...
[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Il [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] componente aggiuntivo (SSRS) per prodotti e tecnologie SharePoint (sprsSharePoint. msi) è un download Web che offre funzionalità per l'integrazione di un server di report con una distribuzione di SharePoint.  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Non è possibile esplorare le pagine di SharePoint nell'area non predefinita dopo avere disinstallato Reporting Services componente aggiuntivo](https://support.microsoft.com/kb/2009212)  
