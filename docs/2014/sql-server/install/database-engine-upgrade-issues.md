---
title: Problemi di aggiornamento del motore di database | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Problemi di aggiornamento replica](../../../2014/sql-server/install/replication-upgrade-issues.md)   
