...
##  <a name="Geneva"></a> Passaggio 2: Avviare i servizi nel server  
 Per una distribuzione PowerPivot per SharePoint è necessario che nella farm siano inclusi i servizi seguenti: Servizi di calcolo Excel, servizio di archiviazione sicura e attestazioni per il servizio token Windows.  
...
##### <a name="part-1-enable-secure-store-service"></a>Parte 1: Abilita servizio di archiviazione sicura  
