...
##  <a name="bkmk_example_deployments_2013"></a>Topologie di distribuzione di esempio di SharePoint 2013  
 ...
 per la **modalità SharePoint di [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]** è richiesto sharepoint Server 2013 e viene utilizzata l'architettura dell'applicazione di servizio SharePoint.  
...
###  <a name="bkmk_bi_Sharepoint2013_3tier"></a>PowerPivot per SharePoint 2013 e Reporting Services la distribuzione di tre server  
 ...
 Distribuzione ![server SSAS e SSRS SharePoint Mode 3 distribuzione server](../../../2014/sql-server/install/media/as-and-rs-3server-deployment.gif "SSAS e SSRS SharePoint Mode 3 server")  
  
|||  
|-|-|  
|**(1)**|Applicazione Excel Services. L'applicazione di servizio viene creata durante l'installazione di SharePoint.|  
|**(2)**|Applicazione di servizio [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]. Il nome predefinito è **Applicazione di servizio PowerPivot predefinita**.|  
...
|**(7)**|Database dell'applicazione di servizio, di configurazione e del contenuto di SharePoint.|  
 ...
 Impostazioni ![SharePoint impostazioni]di(https://docs.microsoft.com/analysis-services/analysis-services/media/as-sharepoint2013-settings-gear.gif "SharePoint") [inviare commenti e suggerimenti e informazioni di contatto tramite Microsoft SQL Server Connect](https://connect.microsoft.com/SQLServer/Feedback) (https://connect.microsoft.com/SQLServer/Feedback).  
...
###  <a name="bkmk_powerpivot_sharepoint2013_1server"></a>Distribuzione a server singolo PowerPivot per SharePoint 2013  
 ...
 Distribuzione ![PowerPivot per SharePoint Server singolo](../../../2014/sql-server/install/media/as-powerpivot-mode-1server-deployment.gif "PowerPivot per SharePoint distribuzione a server singolo")  
...
###  <a name="bkmk_powerpivot_sharepoint2013_2server"></a>Distribuzione server PowerPivot per SharePoint 2013 2  
 ...
 Il pacchetto di installazione è disponibile come parte del Feature Pack di [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] . È possibile scaricare il Feature Pack dall'area download [!INCLUDE[msCoName](../../includes/msconame-md.md)] in [microsoft® SQL Server® 2014 PowerPivot® per microsoft® SharePoint®](https://go.microsoft.com/fwlink/?LinkID=296473) (HYPERLINK "<https://go.microsoft.com/fwlink/?LinkID=296473>" \t "_ blank" <https://go.microsoft.com/fwlink/?LinkID=296473>).  
...
###  <a name="bkmk_powerpivot_sharepoint2013_3server"></a>Distribuzione server PowerPivot per SharePoint 2013 3  
 ...
 ![Come distribuzione server Mode3 PowerPivot](../../../2014/sql-server/install/media/as-powerpivot-mode-3server-deployment.gif "come distribuzione server Mode3 PowerPivot")  
...
###  <a name="bkmk_powerpivot_ssrs_sharepoint2013_1server"></a>PowerPivot per SharePoint 2013 e distribuzione a server singolo Reporting Services  
 ...
 Distribuzione ![server SSAS e SSRS SharePoint in modalità 1 server](../../../2014/sql-server/install/media/as-and-rs-1server-deployment.gif "SSAS e distribuzione in modalità SharePoint di SSRS 1 server")  
...
###  <a name="bkmk_powerpivot_ssrs_sharepoint2013_2server"></a>PowerPivot per SharePoint 2013 e Reporting Services due distribuzioni server  
 ...
 Distribuzione ![server SSAS e SSRS modalità SharePoint 2 distribuzione server](../../../2014/sql-server/install/media/as-and-rs-2server-deployment.gif "SSAS e distribuzione in modalità SharePoint di SSRS 2 server")  
...
##  <a name="bkmk_example_deployments_2010"></a>Topologie di distribuzione di esempio di SharePoint 2010  
 ...
 (../../../2014/sql-server/install/media/sql11bisetup.gif "Diagramma dell'architettura logica") del ![diagramma dell'architettura logica]  
...
##  <a name="bkmk_sharepoint2010_1server"></a>Distribuzioni a server singolo  
 ...
 Per installare tutte le caratteristiche in un server unico, installare [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] e [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] in sequenza nello stesso server fisico. Per istruzioni sulla configurazione di un server autonomo, vedere elenco di controllo [Deployment: Reporting Services, Power View e PowerPivot per SharePoint @ no__t-0.  
...
##  <a name="bkmk_sharepoint2010_3server"></a>Distribuzione a tre livelli  
 ...
 ![3-topologia server](../../../2014/sql-server/install/media/sql11bisetup-3server.gif "3-topologia server")  
...
##  <a name="bkmk_sharepoint2010_scaleserver"></a>Distribuzione con scalabilità orizzontale a tre livelli  
 ...
 ![5-]topologia del server(../../../2014/sql-server/install/media/sql11bisetup-5server.gif "5-trilogia server")  
...
## <a name="see-also"></a>Vedere anche  
 ...
 @No__t [installazione di PowerPivot per SharePoint 2013](https://docs.microsoft.com/analysis-services/instances/install-windows/install-analysis-services-in-power-pivot-mode)-1  
