...
# <a name="reporting-services-configuration-options-ssrs"></a>Opzioni di configurazione di Reporting Services (SSRS)
 ...
 Per le informazioni più recenti relative [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] e l'installazione e la configurazione di questa versione, vedere [informazioni sull'installazione aggiuntive](https://go.microsoft.com/fwlink/?LinkId=207425) (https://go.microsoft.com/fwlink/?LinkId=207425).  
