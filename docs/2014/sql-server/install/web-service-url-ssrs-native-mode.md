...
# <a name="web-service-url-ssrs-native-mode"></a>URL servizio Web (modalità nativa SSRS)
 ...
 Per aprire questa pagina, avviare Gestione configurazione [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] e fare clic su **URL servizio Web** nel riquadro di navigazione. Per altre informazioni, vedere [Reporting Services Configuration Manager &#40;Native Mode&#41;](../../../2014/sql-server/install/reporting-services-configuration-manager-native-mode.md).  
 ...
 **Certificato SSL**  
 Consente di associare un certificato all'indirizzo IP specificato. Il certificato deve essere installato e configurato nel computer. Reporting Services non fornisce caratteristiche per la gestione di certificati. Il certificato deve essere rilasciato a un nome host o a un nome computer risolto nell'indirizzo IP. Ad esempio, per utilizzare un certificato emesso per http://salesreports, l'indirizzo IP specificato deve essere risolto in un server denominato "SalesReports".  
