...
-   Le eccezioni per il firewall vengono configurate dall'amministratore. In questo modo è possibile accedere a programmi specificati in esecuzione o a porte di connessione specificate nel computer. In questo caso, il computer accetta il traffico in ingresso non richiesto quando svolge le funzioni di server, listener o peer. Questo è il tipo di configurazione che è necessario completare per connettersi a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
 ...
 [Guida a Windows Firewall con sicurezza avanzata Introduzione](https://go.microsoft.com/fwlink/?LinkId=116080)  
  
 [Guida alla progettazione di Windows Firewall con sicurezza avanzata](https://go.microsoft.com/fwlink/?LinkId=116904)  
...
-   **Windows Firewall elemento nel pannello di controllo**  
...
-   **netsh**  
    ...
    -   [Come utilizzare lo strumento Netsh. exe e le opzioni della riga di comando](https://support.microsoft.com/kb/242468)  
    ...
    -   [Il comando "netsh firewall" insieme al parametro "profile = all" non configura il profilo pubblico in un computer basato su Windows Vista](https://support.microsoft.com/kb/947213)  
...
###  <a name="BKMK_ssde"></a>Porte usate dal motore di database  
 Nella tabella seguente sono indicate le porte più utilizzate dal [!INCLUDE[ssDE](../../includes/ssde-md.md)].  
  
|Scenario|Porta|Commenti|  
|--------------|----------|--------------|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]istanza predefinita in esecuzione su TCP|Porta TCP 1433|Si tratta della porta più comune consentita dal firewall. Viene utilizzata nelle connessioni di routine all'installazione predefinita del [!INCLUDE[ssDE](../../includes/ssde-md.md)]o a un'istanza denominata che rappresenta l'unica istanza in esecuzione nel computer. Le istanze denominate presuppongo alcune considerazioni speciali. Vedere [Porte dinamiche](#BKMK_dynamic_ports) più avanti in questo argomento.|  
|
...
|Scenario|Porta|Commenti|  
|--------------|----------|--------------|  
|Strumentazione gestione Windows (WMI)<br /><br /> Per ulteriori informazioni su Strumentazione gestione Windows (WMI), vedere [WMI Provider for Configuration Management Concepts](../../relational-databases/wmi-provider-configuration/wmi-provider-for-configuration-management.md).|WMI viene eseguito come parte di un host del servizio condiviso con porte assegnate tramite DCOM e potrebbe utilizzare la porta TCP 135.<br /><br /> Vedere [Considerazioni speciali per la porta 135](#BKMK_port_135)|
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] utilizza WMI per elencare e gestire servizi. È consigliabile usare il gruppo di regole preconfigurate **Strumentazione gestione Windows (WMI)**. Per ulteriori informazioni, vedere la sezione [Interazione con altre regole del firewall](#BKMK_other_rules) più avanti.|  
|
...
-   [Panoramica dei servizi e requisiti per le porte di rete per Windows Server System](https://support.microsoft.com/kb/832017)  
  
-   [Risoluzione degli errori di mapping degli endpoint RPC mediante gli strumenti di supporto di Windows Server 2003 dal CD del prodotto](https://support.microsoft.com/kb/839880)  
  
-   [RPC (Remote Procedure Call)](https://go.microsoft.com/fwlink/?LinkId=118375)  
  
-   [Come configurare l'allocazione delle porte dinamiche RPC per l'uso con i firewall](https://support.microsoft.com/kb/154596/)  
...
##  <a name="BKMK_profiles"></a>Panoramica dei profili firewall  
...
##  <a name="BKMK_additional_settings"></a>Impostazioni aggiuntive del firewall mediante l'elemento Windows Firewall nel pannello di controllo  
...
3.  Scegliere una delle opzioni seguenti:  
    ...
    -   **Qualsiasi computer (compresi quelli in Internet)**  
