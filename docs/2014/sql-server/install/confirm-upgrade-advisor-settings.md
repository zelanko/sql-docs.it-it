 ...
 **Inviare report a [!INCLUDE[msCoName](../../includes/msconame-md.md)]. Questi report possono contenere informazioni personali.**  
 Se si seleziona questa opzione, l' [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] analisi verrà inviata al team. Queste informazioni vengono utilizzate per migliorare le versioni successive.  
