...
# <a name="sql-server-2014-upgrade-advisor"></a>SQL Server 2014 Upgrade Advisor
 ...
 Il file di installazione di Preparazione aggiornamento (sqlua.msi) è disponibile nella cartella redist del supporto di installazione o come parte del [download di SQL 2014 Feature Pack](https://www.microsoft.com/download/details.aspx?id=42295).  
...
|[Utilizzo di Preparazione aggiornamento](../../../2014/sql-server/install/working-with-upgrade-advisor.md)|Vengono forniti cenni preliminari sulle funzionalità di Preparazione aggiornamento, informazioni sull'installazione e sull'uso e indicazioni su come usare i report.|  
