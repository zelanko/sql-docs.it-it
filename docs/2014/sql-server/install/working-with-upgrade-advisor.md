...
|[Riferimento all'interfaccia utente di preparazione aggiornamento](../../../2014/sql-server/install/upgrade-advisor-user-interface-reference.md)|Contiene argomenti che vengono visualizzati se si preme il tasto F1 o fare clic su **aiutare** nelle pagine di analisi guidata Preparazione aggiornamento.|  
