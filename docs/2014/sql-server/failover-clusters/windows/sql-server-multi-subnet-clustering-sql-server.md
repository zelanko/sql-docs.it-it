...
##  <a name="VisualElement"></a>SQL Server cluster di failover su più subnet (due nodi, due subnet)
 ...
 ![Architettura Multi-Subnet con MultiSubnetFailover](../../../database-engine/media/multi-subnet-architecture-withmultisubnetfailoverparam.gif "Architettura con più subnet con MultiSubnetFailover")
