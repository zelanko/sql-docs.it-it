...
-   **Pulizia rilevamento modifiche:** Nuova stored procedure `sp_flush_CT_internal_table_on_demand` è stato introdotto alla modifica di pulizia delle tabelle interne di rilevamento su richiesta.
