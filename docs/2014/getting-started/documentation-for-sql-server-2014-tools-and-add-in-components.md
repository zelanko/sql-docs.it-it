...
|[Installazione di SQL Server 2014](https://go.microsoft.com/fwlink/?LinkId=299175)|Documentazione per l'installazione di SQL Server 2014 per assistenza durante l'installazione.|  
|[SQL Server 2014 preparazione aggiornamento &#91;nuova&#93;](../sql-server/install/sql-server-2014-upgrade-advisor.md)|Preparazione aggiornamento a [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] analizza la configurazione dei componenti di [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] installati, quindi genera un report dei problemi che è necessario risolvere per garantire la corretta esecuzione dell'aggiornamento.|  
|[Installazione dei servizi di SQL Server](https://go.microsoft.com/fwlink/?LinkId=299176)|Documentazione per assistenza nell'applicazione degli aggiornamenti ai componenti di SQL Server.|  
