...
## <a name="includessnoversionincludesssnoversion-mdmd-accessibility-features"></a>Funzionalità di accessibilità di [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
