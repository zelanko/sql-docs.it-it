...
# <a name="data-type-mapping-in-itabledefinition"></a>Mapping dei tipi di dati in ITableDefinition
 ...
 Quando si specificano nuovi tipi di dati di colonna con OLE DB tipi di *wType* dati utilizzando il membro [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] della struttura DBCOLUMNDESC wType, il provider OLE DB di Native Client esegue il mapping OLE DB tipi di dati come indicato di seguito.  
  
|Tipo di dati OLE DB|SQL Server<br /><br /> Tipo di dati|Altre informazioni|  
|----------------------|------------------------------|----------------------------|  
|DBTYPE_BOOL|**bit**||  
