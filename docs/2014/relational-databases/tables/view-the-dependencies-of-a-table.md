...
3.  Nella finestra di dialogo_\<>nome oggetto_ **dipendenze oggetto**selezionare **oggetti che dipendono** da _ \<nome oggetto>_ o **oggetti da cui** **depends**_\<dipende il nome dell'oggetto>_.  
