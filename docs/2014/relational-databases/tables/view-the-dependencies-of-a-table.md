...
3.  Nella finestra di dialogo **dipendenze oggetto** _\<object name>_ selezionare **oggetti che dipendono** da _\<object name>_ o **oggetti da cui** _\<object name>_ **dipende**.  
