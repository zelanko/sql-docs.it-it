...
|ObjectID|`int`|ID assegnato dal sistema alla stored procedure trovata nella cache.|22|Yes|  
...
|TextData|`ntext`|Testo del codice SQL trovato nella cache. Se la colonna TextData viene popolata, la colonna ObjectName non viene popolata.|1|Yes|  
