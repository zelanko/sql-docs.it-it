...
|ObjectName|`nvarchar`|Nome della stored procedure. Se ObjectName è popolato, TextData non verrà popolato.|34|Yes|  
...
|TextData|`ntext`|Testo del codice SQL inserito nella cache. Se TextData è popolato, ObjectName non verrà popolato.|1|Yes|  
