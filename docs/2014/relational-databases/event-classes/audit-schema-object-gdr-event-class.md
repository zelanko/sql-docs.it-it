...
|**ColumnPermissions**|**int**|Indicatore dell'impostazione o meno di un'autorizzazione per la colonna. Analizzare il testo dell'istruzione per determinare con esattezza quali autorizzazioni sono state impostate per quali colonne. 1 = Sì, 0 = No.|44|Yes|  
...
|**ObjectName**|**nvarchar**|Nome dell'oggetto di destinazione dell'istruzione GRANT/REVOKE/DENY.|34|Yes|  
...
|**OwnerName**|**nvarchar**|Nome utente del database relativo al proprietario dell'oggetto di destinazione dell'istruzione GRANT/REVOKE/DENY.|37|Yes|  
|**ParentName**|**nvarchar**|Nome dello schema in cui è incluso l'oggetto.|59|Yes|  
|**Autorizzazioni**|**bigint**|Valore intero che rappresenta il tipo di autorizzazioni controllato.<br /><br /> 1=SELECT ALL<br /><br /> 2=UPDATE ALL<br /><br /> 4=REFERENCES ALL<br /><br /> 8=INSERT<br /><br /> 16=DELETE<br /><br /> 32=EXECUTE (solo procedure)<br /><br /> 4096=SELECT ANY (almeno una colonna)<br /><br /> 8192=UPDATE ANY<br /><br /> 16384=REFERENCES ANY|19|Yes|  
