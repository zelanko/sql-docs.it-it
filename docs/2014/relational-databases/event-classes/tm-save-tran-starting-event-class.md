...
ms.locfileid: "63061347"
---
# <a name="tm-save-tran-starting-event-class"></a>TM: Save Tran Starting - classe di evento
  TM: Salvare Tran Starting-classe di evento indica che una richiesta SAVE TRANSACTION è stata avviata. La richiesta è stata inviata dal client tramite l'interfaccia di gestione delle transazioni.  
  
## <a name="tm-save-tran-starting-event-class-data-columns"></a>TM: Save Tran Starting colonne di dati di classe di evento  
