...
ms.locfileid: "63012350"
---
# <a name="audit-statement-permission-event-class"></a>Audit Statement Permission - classe di evento
  La classe di evento **Audit Statement Permission** si verifica ogni volta che viene utilizzata un'autorizzazione per le istruzioni, ad esempio Create Table.  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Audit Schema Object Management - classe di evento](audit-schema-object-management-event-class.md)  
