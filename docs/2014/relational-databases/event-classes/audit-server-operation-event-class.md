...
# <a name="audit-server-operation-event-class"></a>Audit Server Operation - classe di evento
  La classe di evento **Audit Server Operation** viene generata quando si utilizzano operazioni di controllo della sicurezza, ad esempio la modifica delle impostazioni, delle risorse, dell'accesso esterno o dell'autorizzazione.  
