...
|**ColumnPermissions**|**int**|Indica se è stata impostata un'autorizzazione a livello di colonna. Analizzare il testo dell'istruzione per determinare quali autorizzazioni sono state applicate. 1 = Sì, 0 = No.|44|Yes|  
...
|**ObjectName**|**nvarchar**|Nome dell'oggetto di cui vengono controllate le autorizzazioni.|34|Yes|  
...
|**OwnerName**|**nvarchar**|Nome dell'utente del database proprietario dell'oggetto di destinazione.|37|Yes|  
|**ParentName**|**nvarchar**|Nome dello schema in cui è incluso l'oggetto.|59|Yes|  
|**Autorizzazioni**|**bigint**|Valore intero che rappresenta il tipo di autorizzazioni controllato.<br /><br /> 1=SELECT ALL<br /><br /> 2=UPDATE ALL<br /><br /> 4=REFERENCES ALL<br /><br /> 8=INSERT<br /><br /> 16=DELETE<br /><br /> 32=EXECUTE (solo procedure)|19|Yes|  
