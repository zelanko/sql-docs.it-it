...
# <a name="audit-schema-object-access-event-class"></a>Audit Schema Object Access - classe di evento
  La classe di evento **Audit Schema Object Access** viene generata quando viene utilizzata un'autorizzazione per gli oggetti, ad esempio SELECT.  
...
|**Autorizzazioni**|**int**|Indica se è stata impostata un'autorizzazione a livello di colonna. Analizzare il testo dell'istruzione per determinare quali autorizzazioni sono state applicate. 1 = Sì, 0 = No.|44|Sì|  
