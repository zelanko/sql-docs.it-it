...
# <a name="audit-database-object-gdr-event-class"></a>Audit Database Object GDR - classe di evento
  La classe di evento **Audit Database Object GDR** viene generata quando è stata eseguita un'istruzione Grant, REVOKE o Deny per oggetti di database, ad esempio assembly e schemi.  
