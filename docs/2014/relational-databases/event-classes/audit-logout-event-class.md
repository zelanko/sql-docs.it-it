...
|**CPU**|**int**|Quantità di tempo di CPU in millisecondi utilizzata dagli utenti durante le rispettive connessioni.|18|Yes|  
...
|**Durata**|**bigint**|Quantità di tempo trascorsa approssimativamente dopo l'accesso dell'utente.|13|Yes|  
|**EndTime**|**datetime**|Ora di fine della disconnessione.|15|Yes|  
...
|**Reads**|**bigint**|Numero di operazioni di I/O di lettura logica eseguite dall'utente durante la connessione.|16|Yes|  
...
|**Writes**|**bigint**|Numero di operazioni di I/O di scrittura logica eseguite dall'utente durante la connessione.|17|Yes|  
