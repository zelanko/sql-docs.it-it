...
|NestLevel|`int`|Livello di nidificazione della stored procedure se l'istruzione SQL è stata eseguita all'interno di una stored procedure.|29|Yes|  
...
|State|`int`|Indica se l'esecuzione dell'istruzione avviene dopo una ricompilazione.<br /><br /> 1=Ricompilata|30|Yes|  
|TextData|`ntext`|Testo dell'istruzione da eseguire|1|Yes|  
