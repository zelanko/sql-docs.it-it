...
|IndexID|`int`|Indice di cui viene eseguita l'analisi.|24|Yes|  
...
|ObjectID|`int`|ID dell'oggetto sottoposto ad analisi, assegnato dal sistema.|22|Yes|  
|Reads|`bigint`|Numero di pagine lette (a livello logico).|16|Yes|  
