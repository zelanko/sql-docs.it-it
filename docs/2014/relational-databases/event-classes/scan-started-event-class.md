...
|IndexID|`int`|L'indice sottoposto ad analisi (nel caso si tratti di un indice).|24|Yes|  
...
|ObjectID|`int`|ID assegnato dal sistema relativo all'oggetto sottoposto ad analisi.|22|Yes|  
