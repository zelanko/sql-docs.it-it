...
|**DatabaseName**|`nvarchar`|Nome del database in cui è stata tentata l'acquisizione del blocco.|35|Yes|  
|**Durata**|`bigint`|Quantità di tempo (in microsecondi) dalla richiesta all'annullamento del blocco.|13|Yes|  
...
|**ObjectID**|`int`|ID dell'oggetto sul quale è stato annullato il blocco, se disponibile e applicabile.|22|Yes|  
