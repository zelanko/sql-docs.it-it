...
# <a name="audit-login-change-password-event-class"></a>Audit Login Change Password _- classe di evento
  La classe di evento **Audit Login Change password** viene generata ogni volta che [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] un utente modifica la password di accesso.  
