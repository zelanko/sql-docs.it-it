...
|**DBUserName**|**nvarchar**|Nome dell'utente del database che ha aggiunto o rimosso l'account di accesso.|40|Yes|  
...
|**RoleName**|**nvarchar**|Nome del ruolo predefinito del server di cui viene modificata l'appartenenza.|38|Yes|  
