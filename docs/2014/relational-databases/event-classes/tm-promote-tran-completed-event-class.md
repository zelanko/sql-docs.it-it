...
ms.locfileid: "52823205"
---
# <a name="tm-promote-tran-completed-event-class"></a>TM: Promote Tran Completed-classe di evento
  TM: Alzare di livello Tran Completed-classe di evento indica che una richiesta PROMOTE TRANSACTION è stata completata. inviata dal client tramite l'interfaccia di gestione delle transazioni.  
  
## <a name="tm-promote-tran-completed-event-class-data-columns"></a>TM: Promote Tran completato colonne di dati di classe di evento  
...
|BinaryData|`image`|Token Xact di DTC.|2|Yes|  
