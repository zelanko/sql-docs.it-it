...
|**StarvationElevation**|**int**|Il messaggio è stato inviato con una priorità più alta rispetto alla priorità configurata per la conversazione: 0 = false, 1 = true.|33|Yes|  
