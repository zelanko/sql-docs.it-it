...
|**HonorBrokerPriority**|**Int**|Valore corrente dell'opzione di database HONOR_BROKER_PRIORITY: 0 = OFF, 1 = ON.|32|Yes|  
...
|**Priorità**|**int**|Livello di priorità della conversazione.|5|Yes|  
...
|**StarvationElevation**|**int**|Il messaggio è stato inviato con una priorità più elevata rispetto alla priorità configurata per la conversazione: 0 = false, 1 = true.|33|Yes|  
