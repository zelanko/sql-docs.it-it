...
|**EventSubClass**|**nvarchar**|Tipo di sottoclasse di evento in cui sono disponibili informazioni aggiuntive su ogni classe di evento. Questa colonna può contenere i valori seguenti:<br /><br /> **Locale**: La route scelta dispone dell'indirizzo LOCAL.<br /><br /> **Remoto**: La route scelta dispone di un indirizzo diverso da LOCAL.<br /><br /> **Ritardo**: Il messaggio viene posticipato poiché l'inoltro è disabilitato o non è disponibile alcuna route corrispondente.|21|Yes|  
