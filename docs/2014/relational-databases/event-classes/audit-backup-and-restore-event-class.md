...
|**EventSubClass**|**int**|Tipo di sottoclasse di evento.<br /><br /> 1 = Backup<br /><br /> 2 = Ripristino<br /><br /> 3 = Log di backup|21|Yes|  
...
|**TextData**|**ntext**|Testo SQL dell'istruzione di backup o ripristino.|1|Yes|  
