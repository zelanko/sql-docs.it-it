...
# <a name="audit-login-change-property-event-class"></a>Audit Login Change Property - classe di evento
  La classe di evento **Audit Login Change Property** viene generata quando si utilizza il **sp_defaultdb** stored procedure, il **SP_DEFAULTLANGUAGE** stored procedure o l'istruzione ALTER login per modificare una proprietà di un account di accesso.  
