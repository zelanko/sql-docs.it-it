...
|Riuscito|`int`|1 = esito positivo. 0 = esito negativo (ad esempio, 1 indica che un controllo delle autorizzazioni ha avuto esito positivo, 0 che l'esito è stato negativo).|23|Yes|  
