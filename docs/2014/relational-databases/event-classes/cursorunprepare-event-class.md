...
|**Handle**|**Int**|Identifica l'handle preparato che sta per essere convertito in non preparato.|33|Yes|  
...
|**RequestID**|**int**|Identificazione della richiesta che ha convertito il cursore in non preparato.|49|Yes|  
