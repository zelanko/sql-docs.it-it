...
|**SPID**|**int**|ID della sessione in cui si è stato generato l'evento.|12|Yes|  
|**StartTime**|**datetime**|Ora di inizio dell'evento, se disponibile.|14|Yes|  
|**Esito positivo**|**int**|1 = esito positivo. 0 = esito negativo. Il valore 1 indica, ad esempio, che il controllo delle autorizzazioni ha avuto esito positivo e il valore 0 che il controllo ha avuto esito negativo.|23|Yes|  
|**TargetLoginName**|**nvarchar**|Per le azioni relative a un account di accesso, il nome dell'account di accesso specifico.|42|Yes|  
|**TargetLoginSid**|**image**|Per le azioni relative a un account di accesso, il numero di identificazione di sicurezza (SID) dell'account di accesso specifico.|43|Yes|  
