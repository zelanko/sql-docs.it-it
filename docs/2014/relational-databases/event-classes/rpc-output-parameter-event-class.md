...
|ObjectName|`nvarchar`|Nome del parametro a cui si fa riferimento.|34|Yes|  
...
|TextData|`ntext`|Valori dei parametri di output della chiamata di procedura remota (RPC).|1|Yes|  
