...
|**Errore**|`int`|Numero di ID del messaggio in **sys. messages** per il testo nell'evento. Se l'evento indica un errore, questo è il numero di errore di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .|31|No|  
