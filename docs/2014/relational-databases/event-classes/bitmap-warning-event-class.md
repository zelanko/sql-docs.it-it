...
|**EventSubClass**|`int`|Tipo di sottoclasse di evento. 0 = il filtro bitmap è disabilitato.|21|Yes|  
...
|**LoginName**|`nvarchar`|Nome dell'account di accesso dell'utente, ovvero l'account di sicurezza di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] o credenziali di accesso di Windows nel formato *DOMINIO\nomeutente*.|11|Yes|  
