...
# <a name="cursorrecompile-event-class"></a>CursorRecompile - classe di evento
  La classe di evento **CursorRecompile** descrive gli eventi di ricompilazione del cursore che si verificano nei cursori API (Application Programming Interface). Gli eventi di ricompilazione del [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)] cursore si verificano quando ricompila un cursore Transact-SQL a causa di una modifica dello schema.  
