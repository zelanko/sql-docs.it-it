...
ms.locfileid: "62662195"
---
# <a name="showplan-all-event-class"></a>Showplan All - classe di evento
  La classe di evento Showplan All viene [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] generata quando esegue un'istruzione SQL. Le informazioni incluse sono tuttavia un subset delle informazioni disponibili nelle classi di evento Showplan XML Statistics o Showplan XML.  
