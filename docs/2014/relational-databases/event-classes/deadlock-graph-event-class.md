...
|**LoginSid**|**immagine**|ID di sicurezza (SID) dell'utente connesso. Queste informazioni sono disponibili nella vista del catalogo sys.server_principals. Il SID è univoco per ogni account di accesso nel server. Il valore è sempre il SID dell'utente di sistema per questo evento.|41|Sì|  
...
|**ID transazione**|**bigint**|Non usato.|4|Sì|  
