...
-   Creazione di elementi contenitore, ad esempio un elemento ** \< orders>** che esegue il wrapping di tutti gli ordini.  
 ...
 `sql:is-constant`È possibile aggiungere l'annotazione a un elemento ** \<>complexType** .  
