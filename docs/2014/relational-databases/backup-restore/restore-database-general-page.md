...
> [!NOTE]  
>  Quando si specifica un'attività di ripristino usando [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], è possibile generare lo script [RESTORE](/sql/t-sql/statements/restore-statements-transact-sql) corrispondente di [!INCLUDE[tsql](../../includes/tsql-md.md)] facendo clic su **Script** e quindi selezionando una destinazione per lo script.  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Argomenti di ripristino &#40;Transact-SQL&#41;](/sql/t-sql/statements/restore-statements-arguments-transact-sql)   
