...
> [!NOTE]  
>  Quando si specifica un'attività di ripristino utilizzando [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], è possibile generare lo script di [ripristino](/sql/t-sql/statements/restore-statements-transact-sql) [!INCLUDE[tsql](../../includes/tsql-md.md)]corrispondente facendo clic su **script** , quindi selezionando una destinazione per lo script.  
