...
-   [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]Agent supporta solo backup di database: Backup completi e del log.  L'automazione di backup di file non è supportata.  
...
-   Modelli di recupero: Sono supportati solo i database impostati sul modello con registrazione completa o con registrazione minima delle operazioni bulk.  I database impostati sul modello di recupero con registrazione minima non sono supportati.  
