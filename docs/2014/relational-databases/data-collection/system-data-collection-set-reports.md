...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Attività|È possibile accedere ai diversi aspetti dell'attività di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] dal grafico Attività di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] . Di seguito vengono indicati i report che è possibile ottenere facendo clic su un punto della linea del grafico Compilazioni SQL/sec:<br /><br /> Connessioni e sessioni<br /><br /> Richieste<br /><br /> Percentuale riscontri cache piano<br /><br /> Caratteristiche TempDb|  
