...
## <a name="see-also"></a>Vedere anche  
 [Spostare che database in un altro Server SQL protetto con TDE](move-a-tde-protected-database-to-another-sql-server.md)   
