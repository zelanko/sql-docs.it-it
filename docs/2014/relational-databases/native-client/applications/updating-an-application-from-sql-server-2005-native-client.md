...
|Il `sp_columns` stored procedure restituisce ora **"No"** invece di **"no"** per la colonna IS_NULLABLE.|[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] A partire da Native Client 10,0[!INCLUDE[ssKatmai](../../../includes/sskatmai-md.md)]() `sp_columns` , stored procedure restituisce ora **"No"** invece di **"No"** per una colonna IS_NULLABLE.|  
