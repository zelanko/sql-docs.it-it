...
-   Le stringhe di connessione MDAC consentono un valore booleano (`true`) per il **Trusted_Connection** (parola chiave). Oggetto [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] stringa di connessione di Native Client deve usare `yes` oppure **alcun**.  
