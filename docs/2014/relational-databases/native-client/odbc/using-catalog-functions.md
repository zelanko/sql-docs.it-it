...
-   **SQLTables**  
 ...
 Le due parti _linked_server_name_**.** _catalog_ è supportato anche per *FKCatalogName* e *PKCatalogName* sul [SQLForeignKeys](../../native-client-odbc-api/sqlforeignkeys.md).  
