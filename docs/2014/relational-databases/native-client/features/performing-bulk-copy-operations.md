...
# <a name="performing-bulk-copy-operations"></a>Esecuzione di operazioni di copia bulk
 ...
 Per un'applicazione di esempio in cui viene illustrata questa funzionalità, vedere [copia dati bulk con IRowsetFastLoad &#40;OLE DB&#41;](../../native-client-ole-db-interfaces/irowsetfastload-ole-db.md).  
