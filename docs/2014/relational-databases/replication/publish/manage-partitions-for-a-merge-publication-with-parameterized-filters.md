...
-   **Per gestire le partizioni per una pubblicazione di tipo merge con filtri con parametri, utilizzando:**  
...
##  <a name="RMOProcedure"></a>Utilizzo di Replication Management Objects (RMO)  
