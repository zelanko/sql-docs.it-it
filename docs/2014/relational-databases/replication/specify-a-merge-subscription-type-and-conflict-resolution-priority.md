...
1.  In **Proprietà sottoscrizione- \<Publisher> : \<PublicationDatabase> ** nel server di pubblicazione immettere un valore (da 0,00 a 99,99) per l'opzione **priorità** .  
