...
|Opzione CREATE FULLTEXT CATALOG:<br /><br /> IN PATH '*rootpath*'<br /><br /> ON FILEGROUP *filegroup*|No.|CREATE FULLTEXT CATLOG IN PATH<br /><br /> Nessuno.*|237<br /><br /> nessuna.<sup>*</sup>|  
