...
|------------------------|-----------------|------------------|----------------|  
|Proprietà FULLTEXTCATALOGPROPERTY: LogSize|Nessuno.|FULLTEXTCATALOGPROPERTY **('LogSize')**|211|  
|Proprietà di FULLTEXTSERVICEPROPERTY:<br /><br /> ConnectTimeout<br /><br /> DataTimeout|Nessuno.|FULLTEXTSERVICEPROPERTY **('ConnectTimeout')**<br /><br /> FULLTEXTSERVICEPROPERTY **('DataTimeout'**)|210<br /><br /> 209|  
...
|Opzione CREATE FULLTEXT CATALOG:<br /><br /> IN PATH '*rootpath*'<br /><br /> ON FILEGROUP *filegroup*|Nessuno.|CREATE FULLTEXT CATLOG IN PATH<br /><br /> Nessuno.*|237<br /><br /> Nessuno.<sup>*</sup>|  
|Proprietà di DATABASEPROPERTYEX: IsFullTextEnabled|Nessuno.|DATABASEPROPERTYEX **('IsFullTextEnabled')**|202|  
|Opzione di sp_detach_db:<br /><br /> [ @keepfulltextindexfile = ] '*KeepFulltextIndexFile*'|Nessuno.|sp_detach_db @keepfulltextindexfile|226|  
