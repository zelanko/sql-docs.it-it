...
##  <a name="whatcanido"></a>Cosa è possibile fare con la ricerca semantica?  
...
###  <a name="find3"></a>Trovare le frasi chiave che rendono simili o correlati i documenti  
