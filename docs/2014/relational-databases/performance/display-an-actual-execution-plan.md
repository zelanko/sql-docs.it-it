...
5.  È possibile modificare la visualizzazione del piano di esecuzione facendo clic con il pulsante destro del mouse sul piano di esecuzione e scegliendo **Zoom avanti**, **Zoom indietro**, **Personalizza zoom**oppure **Adatta alla finestra**. **Zoom** avanti e **Zoom indietro** consentono di ingrandire o ridurre il piano di esecuzione, mentre lo **Zoom personalizzato** consente di definire uno zoom personalizzato, ad esempio il 80 percento. **Adatta alla finestra consente** di ingrandire il piano di esecuzione per adattarlo al riquadro risultati.  
