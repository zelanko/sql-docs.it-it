...
|----------------------|-----------|  
|Descrive come specificare che un editor deve essere aperto facendo doppio clic su un file con un'estensione specificata in Esplora risorse.|[Associazione di estensioni di file a un editor di codice](associate-file-extensions-to-a-code-editor.md)|  
|Descrive come personalizzare i tipi di carattere per rendere più leggibili codice e testo.|[Modifica dello stile, delle dimensioni e del colore del carattere](change-font-color-size-and-style.md)|  
|Descrive come visualizzare le proprietà.|[Utilizzo della finestra Proprietà in Management Studio](use-the-properties-window-in-management-studio.md)|  
