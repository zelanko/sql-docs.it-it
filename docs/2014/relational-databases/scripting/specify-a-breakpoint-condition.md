...
## <a name="specifying-conditions"></a>Definizione delle condizioni  
 L'espressione specificata deve essere un'espressione Transact-SQL valida che restituisce un valore booleano. Per ulteriori informazioni, vedere [espressioni &#40;&#41;Transact-SQL ](/sql/t-sql/language-elements/expressions-transact-sql).  
