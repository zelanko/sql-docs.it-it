...
## <a name="updgguid-attribute"></a>Attributo updg:guid  
 L'attributo `updg:guid` è un attributo facoltativo che genera un identificatore univoco globale. Questo valore rimane nell'ambito per l'intero blocco di **> di sincronizzazione\<** in cui è specificato. È possibile utilizzare questo valore in qualsiasi punto del blocco **>\<Sync** . L'attributo chiama la funzione di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] `NEWGUID()`per generare l'identificatore univoco.  
...
## <a name="see-also"></a>Vedere anche  
 [Considerazioni &#40;sulla sicurezza dell'Updategram SQLXML 4,0&#41;](../security/updategram-security-considerations-sqlxml-4-0.md)  
