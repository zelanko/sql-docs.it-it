...
|**Tempo di attesa blocco (MS)**|Tempo di attesa totale dei blocchi (in millisecondi) nell'ultimo secondo.|  
...
|**Heap/albero b**|Heap o albero B (HOBT). Un blocco su un heap di pagine di dati, oppure sull'albero B di un indice.|  
