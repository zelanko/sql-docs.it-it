...
|----------------------------------------|-----------------|  
|**Memoria connessione (KB)**|Specifica la quantità totale di memoria dinamica utilizzata dal server per gestire le connessioni.|  
...
|**Memoria libera (KB)**|Specifica la quantità di memoria allocata attualmente non utilizzata dal server.|  
...
|**Memoria blocco (KB)**|Specifica la quantità totale di memoria dinamica utilizzata dal server per i blocchi.|  
...
|**Memoria server di destinazione (KB)**|Indica la quantità totale di memoria dinamica disponibile per il server.|  
