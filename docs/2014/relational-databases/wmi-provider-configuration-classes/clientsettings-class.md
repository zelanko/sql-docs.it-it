...
ms.locfileid: "63242881"
---
# <a name="clientsettings-class"></a>Classe ClientSettings
  Il [classe ClientSettings](clientsettings-class.md) rappresenta il [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] impostazioni del client.  
