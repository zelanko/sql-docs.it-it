...
|Testo del messaggio|Errore di tabella: L'extent id_p nell'oggetto con ID O_ID, indice con ID I_ID, partizione con ID PN_ID, unità allocazione con ID A_ID (tipo TYPE) è oltre l'intervallo di questo database.|  
