...
-   **Percorso predefinito del file di configurazione** -%LocalAppData%\SQL SERVER\DEPLOY to to SQL in WA VM\DeploymentSettings.XML  
...
-   **Avanti** : consente di passare alla pagina **impostazioni di origine** .  
