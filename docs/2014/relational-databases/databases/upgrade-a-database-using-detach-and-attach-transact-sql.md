...
##  <a name="SSMSProcedure"></a>Per aggiornare un database utilizzando la connessione e il collegamento  
  
1.  Scollegare il database. Per ulteriori informazioni, vedere [scollegamento di un database](detach-a-database.md).  
...
3.  Collegare i file copiati all'istanza di [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]. Per altre informazioni, vedere [Collegare un database](attach-a-database.md).  
