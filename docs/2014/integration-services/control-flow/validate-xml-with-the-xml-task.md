...
```  
 ...
 ![Query per raggruppare gli errori XML in Management Studio](../media/queryforxmlerrors.jpg "Query per raggruppare gli errori XML in Management Studio")  
