...
-   File di dump del debug con estensione tmp. Si tratta di un file in formato testo.  
 ...
 Per impostazione predefinita, [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] archivia questi file nella cartella, * \<drive> :* \Programmi\Microsoft SQL Server\110\Shared\ErrorDumps.  
