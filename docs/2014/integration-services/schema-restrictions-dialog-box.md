 ...
 **Variabile**  
 Consente di utilizzare una variabile per definire le restrizioni. Selezionare una variabile nell'elenco oppure fare clic su **nuova variabile** per creare una nuova variabile.  
