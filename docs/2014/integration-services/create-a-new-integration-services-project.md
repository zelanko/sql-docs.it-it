---
title: Creare un nuovo progetto di Integration Services | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
8.  Fare clic su **OK** da aggiungere alla soluzione **Esplora soluzioni**r e aggiungere il progetto alla soluzione.  
