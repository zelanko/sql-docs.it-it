...
-   Video [Procedura: Automatizzare l'esecuzione del pacchetto SSIS utilizzando SQL Server Agent (Video di SQL Server)](https://technet.microsoft.com/sqlserver/ff686764.aspx), su technet.microsoft.com  
