...
## <a name="documentation"></a>Documentazione  
 Questo file della Guida per [!INCLUDE[msCoName](../includes/msconame-md.md)] il connettore 1,1 per SAP BW contiene gli argomenti e le sezioni seguenti:  
  
 [Installazione di Microsoft Connector 1.1 for SAP BW](installing-the-microsoft-connector-for-sap-bw.md)  
 Descrive i requisiti di installazione per [!INCLUDE[msCoName](../includes/msconame-md.md)] il connettore 1,1 per SAP BW.  
