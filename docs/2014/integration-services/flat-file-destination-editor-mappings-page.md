 ...
 **Colonna di input**  
 Consente di visualizzare le colonne di input selezionate più indietro in questo argomento. È possibile modificare i mapping utilizzando l'elenco **Colonne di input disponibili**. Selezionare questa **\<ignore>** finestra per escludere la colonna dall'output.  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Editor destinazione file flat &#40;pagina Gestione connessione&#41;](../../2014/integration-services/flat-file-destination-editor-connection-manager-page.md)  
