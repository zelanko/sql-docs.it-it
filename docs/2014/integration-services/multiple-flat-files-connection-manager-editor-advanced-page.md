 ...
 **Configurare le proprietà di ogni colonna**  
...
|**ColumnDelimiter**|Consente di selezionare i delimitatori di colonna disponibili nell'apposito elenco. Scegliere come delimitatori caratteri che non siano già presenti nel testo. Questo valore viene ignorato per le colonne a larghezza fissa.<br /><br /> **{CR} {LF}** : le colonne sono delimitate da una combinazione di ritorno a capo/avanzamento riga<br /><br /> **{CR}** : le colonne sono delimitate da un ritorno a capo<br /><br /> **{LF}** : le colonne sono delimitate da un avanzamento riga<br /><br /> **Punto e virgola {;}** -le colonne sono delimitate da un punto e virgola<br /><br /> **Due punti {:}** : le colonne sono delimitate da due punti<br /><br /> **Virgole {,} ** : le colonne sono delimitate da una virgola<br /><br /> **Tab {t}** : le colonne sono delimitate da una tabulazione<br /><br /> **Barra verticale {&#124;}** : le colonne sono delimitate da una barra verticale|  
...
|valore|Descrizione|  
|-----------|-----------------|  
|**Aggiungere una colonna**|Consente di aggiungere una nuova colonna alla fine dell'elenco.|  
