...
2.  [Configurare le opzioni nel riquadro Contenitori](#container)  
  
3.  [Configurazione delle opzioni nella scheda Provider e log](#provider)  
  
4.  [Configurare le opzioni nella scheda Dettagli](#detail)  
  
##  <a name="open_dialog"></a>Aprire la finestra di dialogo Configura log SSIS  
...
##  <a name="container"></a>Configurare le opzioni nel riquadro Contenitori  
...
##  <a name="provider"></a>Configurare le opzioni nella scheda provider e log  
...
##  <a name="detail"></a>Configurare le opzioni nella scheda Dettagli  
