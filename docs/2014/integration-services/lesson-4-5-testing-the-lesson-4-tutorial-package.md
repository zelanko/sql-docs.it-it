---
title: "Passaggio 5: Verifica il pacchetto della lezione 4 dell'esercitazione | Microsoft Docs"
ms.custom: ''
ms.date: 06/13/2017
...
---
# <a name="step-5-testing-the-lesson-4-tutorial-package"></a>Passaggio 5: Il pacchetto della lezione 4 dell'esercitazione di test
...
-   Aprire il file ErrorOutput.txt in Blocco note o qualsiasi altro editor di testo. L'ordine delle colonne predefinita è: AverageRate, CurrencyID, CurrencyDate, EndOfDateRate, ErrorCode, ErrorColumn, ErrorDescription.  
