...
ms.locfileid: "85469296"
---
# <a name="coding-a-custom-task"></a>Scrittura del codice di un'attività personalizzata
  Dopo aver creato una classe che eredita dalla classe di base [Microsoft. SqlServer. Dts. Runtime. Task](/dotnet/api/microsoft.sqlserver.dts.runtime.task) e aver applicato l' <xref:Microsoft.SqlServer.Dts.Runtime.DtsTaskAttribute> attributo alla classe, è necessario eseguire l'override dell'implementazione delle proprietà e dei metodi della classe di base per fornire la funzionalità personalizzata.
