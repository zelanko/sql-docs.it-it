...
|DefaultCodePage|Integer|Tabella codici da utilizzare per le colonne di tipo string.<br /><br /> **Nota**: Questa proprietà non è disponibile nel **ODBC Destination Editor**, ma può essere impostata tramite il **Editor avanzato**.|  
