...
|DefaultCodePage|Integer|Tabella codici da utilizzare per le colonne di output di tipo string.<br /><br /> **Nota**: Questa proprietà non è disponibile nel **Editor origine ODBC**, ma può essere impostata tramite il **Editor avanzato**.|  
