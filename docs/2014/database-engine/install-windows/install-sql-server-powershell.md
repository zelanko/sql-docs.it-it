...
-   Gli [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] snap-in di PowerShell. Gli snap-in sono file dll che implementano due tipi di supporto di Windows PowerShell per [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] :  
