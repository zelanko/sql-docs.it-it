...
-   [Windows Server 2008 R2: Procedure consigliate per le distribuzioni di Server Core](https://go.microsoft.com/fwlink/?LinkID=245957) (https://go.microsoft.com/fwlink/?LinkID=245957)  
...
-   [Installazione di un ruolo del server in un server che esegue un'installazione Server Core di Windows Server 2008 R2: Panoramica](https://go.microsoft.com/fwlink/?LinkId=245960) (https://go.microsoft.com/fwlink/?LinkId=245960)  
...
-   [Installazione degli aggiornamenti per SQL Server 2014 dopo che è stato installato](#installing-updates-after-installation) 
...
##  <a name="startstop-sql-server-service"></a>Servizio di avvio/arresto di SQL Server  
...
### <a name="using-sql-server-configuration-manager-remotely"></a>Usando Gestione configurazione SQL Server in modalità remota  
...
### <a name="enable-and-start-the-sql-server-browser-service"></a>Abilitare e avviare il servizio SQL Server Browser  
...
##  <a name="sql-servevr-command-prompt-utilities"></a>Utilità della riga di comando Servevr SQL  
...
##  <a name="use-troubleshooting-tools"></a>Utilizzare gli strumenti di risoluzione dei problemi  
 ...
 È possibile avviare l'utilità nel prompt dei comandi di amministratore in Server Core, usando la sintassi specificata nell'argomento: [Utilità di SQLdiag](../../tools/sqldiag-utility.md).  
