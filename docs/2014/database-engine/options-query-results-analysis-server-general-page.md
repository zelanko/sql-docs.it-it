---
title: Opzioni (Query risultati-Analysis Server pagina generale) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "66089322"
---
# <a name="options-query-results-analysis-server-general-page"></a>Opzioni (Query risultati-Analysis Server pagina generale)
 ...
 **Mostra le griglie in schede separate**  
