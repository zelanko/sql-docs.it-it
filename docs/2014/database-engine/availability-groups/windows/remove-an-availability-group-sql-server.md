...
-   [Come funziona: ELIMINARE i comportamenti di gruppo di disponibilità](https://blogs.msdn.com/b/psssql/archive/2012/06/13/how-it-works-drop-availability-group-behaviors.aspx) (blog di ingegneri di SQL Server)  
