...
##  <a name="requirements-for-a-service-in-an-availability-group-to-receive-remote-messages"></a><a name="ReceiveRemoteMessages"></a>Requisiti per un servizio in un gruppo di disponibilità per la ricezione di messaggi remoti  
...
##  <a name="requirements-for-sending-messages-to-a-remote-service-in-an-availability-group"></a><a name="SendRemoteMessages"></a>Requisiti per l'invio di messaggi a un servizio remoto in un gruppo di disponibilità  
