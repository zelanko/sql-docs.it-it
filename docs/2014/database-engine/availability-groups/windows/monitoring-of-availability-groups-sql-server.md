...
-   **Blog:**  
     ...
     [Monitoraggio dell'integrità AlwaysOn con PowerShell - parte 1: Panoramica su Cmdlet di base](https://blogs.msdn.com/b/sqlalwayson/archive/2012/02/13/monitoring-alwayson-health-with-powershell-part-1.aspx)  
  
     [Monitoraggio dell'integrità AlwaysOn con PowerShell - parte 2: Utilizzo avanzato di Cmdlet](https://blogs.msdn.com/b/sqlalwayson/archive/2012/02/13/monitoring-alwayson-health-with-powershell-part-2.aspx)  
  
     [Monitoraggio dell'integrità AlwaysOn con PowerShell - parte 3: Un'applicazione di monitoraggio semplice](https://blogs.msdn.com/b/sqlalwayson/archive/2012/02/15/monitoring-alwayson-health-with-powershell-part-3.aspx)  
