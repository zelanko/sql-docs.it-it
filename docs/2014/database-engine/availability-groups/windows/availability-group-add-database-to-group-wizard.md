...
-   **Per aggiungere un database, utilizzando:**  [Aggiungere Database a Creazione guidata gruppo di disponibilità (SQL Server Management Studio)](#SSMSProcedure)  
