...
-   [Uso di un server di controllo del mirroring in più sessioni](#InMultipleSessions)  
  
-   [Raccomandazioni software e hardware](#SwHwRecommendations)  
...
##  <a name="InMultipleSessions"></a>Uso di un server di controllo del mirroring in più sessioni  
...
##  <a name="SwHwRecommendations"></a>Raccomandazioni software e hardware  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Quorum: impatto di un server di controllo del mirroring sul mirroring del database &#40;&#41;](quorum-how-a-witness-affects-database-availability-database-mirroring.md)   
