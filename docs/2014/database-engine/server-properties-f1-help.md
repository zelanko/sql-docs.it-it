...
# <a name="server-properties-f1-help"></a>Guida sensibile al contesto delle pagine Proprietà server
 ...
 [Le proprietà del server &#40;pagina avanzate&#41;](configure-windows/server-properties-advanced-page.md)  
 ...
 [Le proprietà del server &#40;pagina Impostazioni varie&#41;](configure-windows/server-properties-misc-server-settings-page.md)  
  
 [Le proprietà del server &#40;pagina processori&#41;](configure-windows/server-properties-processors-page.md)  
