...
2.  Impostare il database come sistema di posta elettronica per SQL Server sistema di avvisi: fare clic con il pulsante destro del mouse su **SQL Server Agent**, selezionare **sistema avvisi**, selezionare la casella di controllo **Abilita profilo di posta** , selezionare **posta elettronica database** come **sistema di posta**e selezionare una precedente Profilo di posta creato.  
