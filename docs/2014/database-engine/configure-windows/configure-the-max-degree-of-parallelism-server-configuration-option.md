...
-   **Completamento:**  [Dopo aver configurato l'opzione max degree of parallelism](#FollowUp)  
...
##  <a name="FollowUp"></a> Completamento: Dopo aver configurato l'opzione max degree of parallelism  
