...
1.  In Gestione configurazione SQL Server, nel riquadro della console espandere **SQL Server configurazione di rete**, espandere **protocolli per \<instance name> **e quindi fare doppio clic su **TCP/IP**.  
...
6.  Nel riquadro dei dettagli fare clic con il pulsante destro del mouse su **SQL Server (** \<instance name> **)** , quindi scegliere **Riavvia**per arrestare e riavviare [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
