...
```  
 ...
 Il codice [!INCLUDE[tsql](../../includes/tsql-md.md)] seguente`test.sql`() consente di testare l'esempio esercitando le stored procedure e la funzione definite nell'esempio.  
