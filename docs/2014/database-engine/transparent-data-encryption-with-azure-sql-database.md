...
4.  Nel pannello database fare clic su **tutte le impostazioni**.  
...
8.  Nel pannello **Crittografia dati ANTEPRIMA** spostare lo stato attivo del pulsante **Crittografia dati** su **Attivato**e quindi fare clic su **Salva** (in alto nella pagina) per applicare l'impostazione. Lo **stato della crittografia** apparirà approssimativamente lo stato della crittografia dei dati trasparente.  
...
##  <a name="Encrypt"></a>Abilitazione di [!INCLUDE[ssSDS](../includes/sssds-md.md)] Transparent Data Encryption tramite Transact-SQL  
...
##  <a name="Decrypt"></a>Decrittografia di un database protetto con Transparent Data Encryption[!INCLUDE[ssSDS](../includes/sssds-md.md)]  
...
## <a name="see-also"></a>Vedere anche  
 [&#41;Transparent Data Encryption &#40;Transparent Data Encryption](../relational-databases/security/encryption/transparent-data-encryption.md)   
