...
# <a name="model-object-permissions-master-data-services"></a>Autorizzazioni per oggetti modello (Master Data Services)
 ...
 Per concedere a un utente l'accesso a un'area funzionale diversa da **Esplora**, l'utente deve essere un amministratore del modello, che implica anche l'assegnazione delle autorizzazioni per gli oggetti modello. Per altre informazioni, vedere [Amministratori &#40;Master Data Services&#41;](administrators-master-data-services.md).  
