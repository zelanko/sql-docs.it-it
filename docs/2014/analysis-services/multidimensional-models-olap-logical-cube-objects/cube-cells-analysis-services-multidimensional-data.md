...
# <a name="cube-cells-analysis-services---multidimensional-data"></a>Celle del cubo (Analysis Services - Dati multidimensionali)
 ...
 ![Diagramma cubo che identifica una singola cella](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro5.gif "Diagramma cubo che identifica una singola cella")  
...
-   Il membro Packages.  
 ...
 ![celle del terzo e quarto trimestre per la seconda metà del membro](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro6.gif "celle del terzo e quarto trimestre per la seconda metà del membro")  
...
## <a name="empty-cells"></a>Celle vuote  
 ...
 ![Diagramma cubo che identifica le celle vuote](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro7.gif "Diagramma cubo che identifica le celle vuote")  
  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] In[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]una cella vuota è una cella con qualità particolari. Dato che le celle vuote possono distorcere i risultati di cross join, conteggi e così via, molte funzioni MDX consentono di ignorare le celle vuote a scopo di calcolo. Per ulteriori informazioni, vedere Guida di [riferimento a &#40;MDX&#41; ](/sql/mdx/multidimensional-expressions-mdx-reference)(Multidimensional Expressions) e [concetti chiave &#40;in MDX Analysis Services&#41;](../multidimensional-models/key-concepts-in-mdx-analysis-services.md).  
