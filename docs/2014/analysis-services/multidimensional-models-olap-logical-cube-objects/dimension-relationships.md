...
## <a name="fact-dimension-relationships"></a>Relazioni di tipo Fatti  
 ...
 Le ![colonne nella tabella dei fatti possono supportare dimensioni] Le (https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-factdim.gif "colonne nella tabella dei fatti possono supportare dimensioni")  
