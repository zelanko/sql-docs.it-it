...
##  <a name="bkmk_connect"></a>Connetti da Excel  
...
5.  Nell'ultima pagina è possibile fornire un nome descrittivo e una descrizione. Fare clic su **Fine**e quindi fare clic su **OK** nella finestra di dialogo Importa dati per importare i dati.  
 ...
 Per verificare che MSOLAP.5.dll sia la versione corrente, verificare `HKEY_CLASSES_ROOT\MSOLAP` nel Registro di sistema. 
  `CurVer` deve essere impostato su MSOLAP.5.  
...
##  <a name="bkmk_use"></a>Connettersi da Reporting Services in SharePoint  
