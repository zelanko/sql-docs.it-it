...
### <a name="description"></a>Descrizione  
 Nell'esempio seguente viene creata un'origine dati relazionale che fa [!INCLUDE[ssAWDWsp](../../includes/ssawdwsp-md.md)] riferimento [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] al database di esempio.  
