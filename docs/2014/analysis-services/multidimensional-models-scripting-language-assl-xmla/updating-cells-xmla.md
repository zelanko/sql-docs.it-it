...
## <a name="specifying-cells"></a>Specifica di celle  
 ...
 ![Formula per calcolare la posizione ordinale della cella](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/cellordinalformula.gif "Formula per calcolare la posizione ordinale della cella")  
