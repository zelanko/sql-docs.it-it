...
-   [Supporto del linguaggio di query e di scripting](#bkmk_lang)  
...
-   [Modalità di distribuzione server per soluzioni multidimensionali e tabulari](#bkmk_deploymentmode)  
...
##  <a name="bkmk_overview"></a>Panoramica della modellazione in Analysis Services  
...
##  <a name="bkmk_ds"></a>Supporto dell'origine dati in base al tipo di soluzione  
...
##  <a name="bkmk_ext"></a>Programmabilità e esperienza dello sviluppatore  
...
##  <a name="bkmk_lang"></a>Supporto del linguaggio di query e di scripting  
...
##  <a name="bkmk_client"></a>Applicazioni client e di Reporting  
...
|
  [!INCLUDE[ssCrescent](../includes/sscrescent-md.md)] in SharePoint locale|
  [!INCLUDE[ssCrescent](../includes/sscrescent-md.md)], come applicazione ClickOnce da SharePoint, possono usare un cubo di Analysis Services o un modello tabulare.|  
  
##  <a name="bkmk_deploymentmode"></a>Modalità di distribuzione server per soluzioni multidimensionali e tabulari  
