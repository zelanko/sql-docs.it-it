...
## <a name="next-task-in-lesson"></a>Attività successiva della lezione  
 [Definizione di una relazione molti-a-molti](https://docs.microsoft.com/analysis-services/lesson-5-3-defining-a-many-to-many-relationship)  
