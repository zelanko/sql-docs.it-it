...
> [!NOTE]  
>  Per altre informazioni sulla configurazione del log di query, vedere [registrare le operazioni in Analysis Services](../instances/log-operations-in-analysis-services.md).  
