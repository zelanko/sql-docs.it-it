...
|**Ottimizzazione basata sulle statistiche di utilizzo**|Fare clic per visualizzare la procedura guidata **Ottimizzazione basata sulle statistiche di utilizzo**.<br /><br /> Nota: questa opzione è visualizzata solo nella vista standard di progettazione delle aggregazioni.|  
