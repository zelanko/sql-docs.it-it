---
title: Credenziali (SSAS) per l'origine dei dati | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Password**  
 Immettere la password per la connessione all'origine dati.  
  
 **Salva password**  
 Specificare se archiviare la password.  
