...
1.  Fare clic su **Start**, scegliere **Tutti i programmi**, **Microsoft SQL Server 2012**, quindi fare clic su **SQL Server Data Tools**.  
     ...
     Verrà visualizzato l'ambiente di sviluppo di [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] .  
...
4.  Modifica il nome del progetto per `Analysis Services Tutorial`, che viene modificato anche il **Nome soluzione** casella e quindi fare clic su **OK**.  
  
 È stato creato il `Analysis Services Tutorial` progetto, in base il **multidimensionale di Analysis Services e progetto di Data Mining** modello, all'interno di una nuova soluzione denominata anch ' essa `Analysis Services Tutorial`.  
