...
|**Mostra misure**|Fare clic su questo pulsante per selezionare in successione le opzioni seguenti oppure per selezionare una delle opzioni seguenti che consentono di cambiare il tipo di visualizzazione del riquadro **Misure** :<br /><br /> **Albero**: Consente di visualizzare gruppi di misure e misure in una visualizzazione albero.<br /><br /> **Griglia**: Consente di visualizzare gruppi di misure e misure in una griglia.|  
...
|**Nascondi tabella**|Fare clic su questo pulsante per nascondere la tabella selezionata nel riquadro **Vista origine dati** .<br /><br /> Nota: Questa opzione è disabilitata se non viene selezionata una tabella nel **vista origine dati** riquadro.|  
...
|**Mostra**|Fare clic su questo pulsante per selezionare in successione le opzioni seguenti oppure per selezionare una delle opzioni seguenti che consentono di cambiare il tipo di visualizzazione del riquadro **Vista origine dati** :<br /><br /> **Visualizzazione albero**: Consente di visualizzare tabelle, query denominate, colonne, calcoli denominati e relazioni in una visualizzazione albero.<br /><br /> **Vista diagramma**: Consente di visualizzare tabelle, query denominate, colonne, calcoli denominati e relazioni in una visualizzazione diagramma.|  
