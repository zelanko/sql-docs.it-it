...
# <a name="analysis-services-backward-compatibility"></a>Analysis Services Backward Compatibility
  Negli argomenti di questa sezione vengono descritte le modifiche del comportamento tra le [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]versioni di.  
