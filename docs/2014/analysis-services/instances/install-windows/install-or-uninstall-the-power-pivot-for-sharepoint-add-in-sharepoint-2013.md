...
-   [Distribuire i file della soluzione di SharePoint con lo strumento di configurazione PowerPivot per SharePoint 2013](#bkmk_deploy_solution)  
...
### <a name="command-line-installation"></a>Installazione dalla riga di comando  
 ...
 `Msiexec.exe /i SpPowerPivot.msi`(Indici per tabelle con ottimizzazione per la memoria).  
