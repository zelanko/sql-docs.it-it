...
4.  Nella scheda **Parametri** :  
    ...
    2.  **Server di database**: è possibile utilizzare SQL Server motore di database supportato per la farm di SharePoint.  
...
##  <a name="bkmk_troubleshoot_issues"></a>Risolvere i problemi  
