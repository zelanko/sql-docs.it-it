 ...
 **Nome descrittivo per questa connessione**  
 ...
 **Test connessione**  
 Provare a stabilire una connessione all'origine dati utilizzando la stringa di connessione specificata. Viene visualizzato un messaggio che indica se la connessione è stata stabilita.  
