---
title: Aggiungi finestra di dialogo tabella (Analysis Services - dati multidimensionali) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
|**Viste**|Usare la scheda **Viste** per visualizzare e selezionare una vista da aggiungere.|  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Crea o modifica Query denominata finestra di dialogo &#40;Analysis Services - dati multidimensionali&#41;](create-or-edit-named-query-dialog-box-analysis-services-multidimensional-data.md)   
 [Crea finestra di dialogo di Query di Polling &#40;Analysis Services - dati multidimensionali&#41;](create-polling-query-dialog-box-analysis-services-multidimensional-data.md)   
 [Creare la finestra di dialogo di elaborazione &#40;Analysis Services - dati multidimensionali&#41;](create-processing-query-dialog-box-analysis-services-multidimensional-data.md)  
