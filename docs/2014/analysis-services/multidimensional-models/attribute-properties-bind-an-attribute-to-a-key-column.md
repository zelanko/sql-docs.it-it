...
4.  Digitare il nuovo nome.  
    ...
    > [!NOTE]  
    >  È anche possibile impostare il `Name` proprietà di un attributo selezionato nel **delle proprietà** finestra di [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)].  
