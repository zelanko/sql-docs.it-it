...
|`InstanceSelection`|Fornisce un hint alle applicazioni client sul modo in cui deve venire visualizzato un elenco di elementi, in base al numero previsto di elementi presenti nell'elenco. Sono disponibili le seguenti opzioni:<br /><br /> **Nessuna** Nessun hint viene fornito all'applicazione client. Si tratta del valore predefinito.<br /><br /> **Elenco a discesa** Il numero di elementi è sufficientemente piccolo da essere visualizzato in un elenco a discesa.<br /><br /> **Elenco** di Il numero di elementi è troppo grande per un **elenco**a discesa, ma non richiede l'applicazione di filtri.<br /><br /> **Filtrato** Il numero di elementi è sufficientemente grande da richiedere agli utenti di filtrare gli elementi da visualizzare.<br /><br /> **MandatoryFilter** Il numero di elementi è talmente grande che la visualizzazione deve sempre essere filtrata.|  
...
|`OrderBy`|Descrive in che modo ordinare i membri contenuti nella gerarchia dell'attributo. Il valore predefinito è Name, che specifica che l'ordine dei membri dell'attributo si basa sul valore della proprietà `NameColumn`, se disponibile. In caso contrario, i membri vengono ordinati in base al valore della colonna chiave. Sono disponibili le seguenti opzioni:<br /><br /> `NameColumn`Ordinamento in base al valore della `NameColumn` proprietà.<br /><br /> **Chiave** di Ordinamento in base al valore della colonna chiave del membro dell'attributo.<br /><br /> **AttributeKey** Ordina per valore della chiave del membro di un attributo specificato, che deve presentare una relazione tra attributi e l'attributo.<br /><br /> **AttributeName** Ordina in base al valore del nome del membro di un attributo specificato, che deve presentare una relazione tra attributi e l'attributo.|  
...
|`Usage`|Descrive la modalità di utilizzo di un attributo.<br /><br /> Sono disponibili le seguenti opzioni:<br /><br /> `Regular`L'attributo è un attributo regolare. Si tratta del valore predefinito.<br /><br /> **Chiave** di L'attributo è un attributo chiave.<br /><br /> **Elemento padre** L'attributo è un attributo padre.|  
