...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 Viene descritto come progettare estensioni della personalizzazione [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]per.  
