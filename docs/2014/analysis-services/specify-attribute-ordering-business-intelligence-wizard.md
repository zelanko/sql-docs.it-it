 ...
 **Attributo di ordinamento**  
 ...
 Per creare un nuovo attributo di ordinamento, selezionare ** \<nuovo attributo>** e nella finestra di dialogo **Seleziona colonna** selezionare la colonna su cui deve essere basato il nuovo attributo.  
...
|**Codice**|Consente di ordinare **Attributo** in base alle chiavi dei membri dell'attributo in **Attributo di ordinamento**.|  
