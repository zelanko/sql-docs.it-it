...
|**Nome dell'assembly**|Consente di digitare il nome del riferimento all'assembly.<br /><br /> Nota: Modificando questo valore non si modifica il nome dell'assembly a cui si riferisce il riferimento all'assembly, bensì il nome utilizzato dall'istanza o dal database di [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] per indicare il riferimento all'assembly.|  
