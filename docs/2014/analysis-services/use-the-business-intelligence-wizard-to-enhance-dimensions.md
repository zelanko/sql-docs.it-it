...
-   [Impostare formule personalizzate membro per gli attributi in una dimensione](multidimensional-models/bi-wizard-custom-member-formulas-for-attributes-in-a-dimension.md)  
