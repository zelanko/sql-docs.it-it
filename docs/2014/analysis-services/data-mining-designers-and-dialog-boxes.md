...
# <a name="data-mining-designers-and-dialog-boxes"></a>Finestre di progettazione e finestre di dialogo per il data mining
  [!INCLUDE[msCoName](../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] fornisce strumenti di progettazione che è possibile utilizzare per creare, visualizzare, testare e creare stime da modelli [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] data mining.  
