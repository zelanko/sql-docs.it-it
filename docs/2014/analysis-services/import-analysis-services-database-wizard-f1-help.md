...
-   Selezionare l'istanza e il database di [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] dai quali generare il progetto [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] .  
