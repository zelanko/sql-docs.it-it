...
-   [Per creare una misura utilizzando una formula di aggregazione standard](#bkmk_create_stand)  
...
###  <a name="bkmk_create_stand"></a>Per creare una misura utilizzando una formula di aggregazione standard  
