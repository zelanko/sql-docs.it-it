...
##  <a name="bkmk_properties"></a>Proprietà colonna  
 **Base**  
...
|**Sort By Column**||Viene specificata un'altra colonna per ordinare i valori in questa colonna. Tra le due colonne deve esistere una relazione.<br /><br /> Questo valore deve essere il nome di una colonna esistente. Non è possibile specificare una formula o una misura.|  
...
###  <a name="bkmk_config_prop"></a>Per configurare le impostazioni delle proprietà delle colonne  
