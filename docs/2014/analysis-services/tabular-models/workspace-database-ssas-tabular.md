...
##  <a name="bkmk_ws_prop"></a>Proprietà database area di lavoro  
...
|-----------|-----------------|  
|[Proprietà del modello &#40;SSAS tabulare&#41;](model-properties-ssas-tabular.md)|Fornisce le descrizioni e i passaggi di configurazione per le proprietà del database dell'area di lavoro di un modello.|  
