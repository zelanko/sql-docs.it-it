...
# <a name="discretization-methods-data-mining"></a>Metodi di discretizzazione (data mining)
 ...
 In tali casi, è possibile discretizzare i dati nelle colonne in modo da poter utilizzare gli algoritmi per generare un modello di data mining. La *discretizzazione* è il processo di inserimento di valori in bucket in modo da avere un numero limitato di possibili stati. I bucket stessi vengono considerati come valori ordinati e discreti. È possibile discretizzare sia colonne numeriche che colonne stringa.  
...
|---------------------------|-----------------|  
|`AUTOMATIC`|
  [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] determina il metodo di discretizzazione da usare.|  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Distribuzioni di colonne &#40;&#41;di data mining](column-distributions-data-mining.md)  
