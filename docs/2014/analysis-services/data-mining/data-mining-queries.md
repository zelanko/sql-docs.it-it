...
##  <a name="bkmk_ModelTypes"></a>Query per tipi di modelli diversi  
...
-   **Funzioni di stima personalizzate:** Ogni tipo di modello fornisce un set di funzioni di stima progettate per lavorare con i modelli creati da tale algoritmo.  
...
-   **Statistiche generali:** Sono disponibili numerose funzioni che possono essere utilizzate con quasi tutti i tipi di modello, che restituiscono un set standard di statistiche descrittive, ad esempio la deviazione standard.  
...
-   **Statistiche personalizzate:** Per ogni tipo di modello vengono fornite funzioni di supporto aggiuntive per generare statistiche rilevanti per l'attività analitica specifica.  
...
-   **Funzioni di contenuto del modello:** Il *contenuto* di tutti i modelli viene rappresentato in un formato standardizzato che consente di recuperare informazioni con una semplice query. È possibile creare query sul contenuto del modello tramite DMX. È anche possibile ottenere alcuni tipi di contenuto del modello utilizzando i set di righe dello schema di data mining.  
...
|Acquisire ulteriori informazioni sulle query sul contenuto e visualizzare esempi|[Creare una query sul contenuto di un modello di data mining](create-a-content-query-on-a-mining-model.md)<br /><br /> [Eseguire query sui parametri utilizzati per creare un modello di data mining](query-the-parameters-used-to-create-a-mining-model.md)<br /><br /> [Query sul contenuto &#40;&#41;di data mining](content-queries-data-mining.md)|  
