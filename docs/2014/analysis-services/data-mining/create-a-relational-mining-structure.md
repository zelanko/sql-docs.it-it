...
# <a name="create-a-relational-mining-structure"></a>Creare una struttura di data mining relazionale
 ...
 [Processo per la creazione di una struttura di data mining relazionale](#BKMK_Relational_Structure)  
  
 [Come scegliere le origini dati](#BKMK_ChooseRelData)  
  
 [Come specificare il tipo di contenuto e il tipo di dati](#bkmk_ContentDataType)  
  
 [Perché e come creare un set di dati di dati di attesa](#bkmk_Holdout)  
  
 [Perché e come abilitare il drill-through](#BKMK_DrillThru)  
...
1.  **Selezionare il metodo di definizione**: qui è possibile selezionare un tipo di origine dati e scegliere **da database relazionale o data warehouse**.  
...
5.  **Specificare i dati di training**: in questa pagina si sceglie come *tabella del case*, ovvero la tabella che contiene i dati più importanti per l'analisi.  
...
6.  **Specificare il contenuto e i tipi di dati delle colonne**: per ogni colonna utilizzata nella struttura è necessario scegliere sia un tipo di *dati* che un *tipo di contenuto*.  
...
8.  **Completamento procedura guidata**: in questa pagina è possibile assegnare un nome alla nuova struttura di data mining e al modello di data mining associato, quindi salvare la struttura e il modello.  
...
##  <a name="BKMK_ChooseRelData"></a>Come scegliere dati relazionali  
...
##  <a name="bkmk_ContentDataType"></a>Come specificare il tipo di contenuto e il tipo di dati  
...
##  <a name="bkmk_Holdout"></a>Perché e come suddividere i dati in set di training e di testing  
...
##  <a name="BKMK_DrillThru"></a>Perché e come abilitare il drill-through  
