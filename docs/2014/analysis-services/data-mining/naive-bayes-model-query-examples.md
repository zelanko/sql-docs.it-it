 ...
 **Query sul contenuto**  
 ...
 [Recupero di un riepilogo dei dati di training](#bkmk_Query2)  
 ...
 **Query di stima**  
 ...
 [Stima di risultati mediante una query singleton](#bkmk_Query5)  
...
###  <a name="bkmk_Query5"></a>Esempio di query 5: stima di risultati mediante una query singleton  
