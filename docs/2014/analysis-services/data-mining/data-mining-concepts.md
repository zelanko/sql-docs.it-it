...
-   **Previsione**: stima delle vendite, stima di carichi del server o tempi di inattività del server  
  
-   **Rischio e probabilità**: scelta dei clienti migliori per i messaggi di posta elettronica mirati, determinazione del punto di pareggio probabile per scenari di rischio, assegnazione di probabilità a diagnosi o altri risultati  
  
-   **Indicazioni**: determinazione dei prodotti che probabilmente verranno venduti insieme e generazione di indicazioni  
  
-   **Ricerca di sequenze**: analisi delle selezioni dei clienti in un carrello acquisti e stima dei possibili eventi successivi  
...
5.  [Esplorazione e convalida di modelli](#ValidatingModels)  
  
6.  [Distribuzione e aggiornamento di modelli](#DeployingandUpdatingModels)  
...
##  <a name="BuildingModels"></a>Compilazione di modelli  
...
##  <a name="ValidatingModels"></a>Esplorazione e convalida di modelli  
...
##  <a name="DeployingandUpdatingModels"></a>Distribuzione e aggiornamento di modelli  
...
-   Usare i modelli per creare stime che è possibile usare per prendere decisioni aziendali. 
