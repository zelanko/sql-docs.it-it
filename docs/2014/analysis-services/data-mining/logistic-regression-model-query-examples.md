 ...
 **Query sul contenuto**  
 ...
 [Recupero di parametri di modello tramite il set di righe dello schema di data mining](#bkmk_Query1)  
...
##  <a name="bkmk_top"></a>Ottenere informazioni sul modello di regressione logistica  
...
###  <a name="bkmk_Query1"></a>Esempio di query 1: recupero di parametri di modello tramite il set di righe dello schema di data mining  
...
###  <a name="bkmk_Query3"></a>Esempio di query 3: esecuzione di stime per un valore continuo  
...
###  <a name="bkmk_Query4"></a>Esempio di query 4: esecuzione di stime per un valore discreto  
