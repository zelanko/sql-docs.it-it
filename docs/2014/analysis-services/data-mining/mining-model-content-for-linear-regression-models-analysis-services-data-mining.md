---
title: Contenuto del modello per modelli di regressione lineare di data mining (Analysis Services - Data Mining) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="model-content-for-a-linear-regression-model"></a>Contenuto di un modello di regressione lineare  
 ...
 Per informazioni sulle colonne generiche del set di righe dello schema, vedere [Mining Model Content &#40;Analysis Services - Data Mining&#41;](mining-model-content-analysis-services-data-mining.md).  
