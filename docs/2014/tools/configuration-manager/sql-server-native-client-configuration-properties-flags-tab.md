...
# <a name="sql-server-native-client-configuration-properties-flags-tab"></a>Proprietà - Configurazione SQL Server Native Client (scheda Flag)
  [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] i client su questo computer comunicano con [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] i server utilizzando i protocolli [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] forniti nel file della libreria di Native Client. Questa scheda consente di configurare il computer client in modo che richieda una connessione crittografata mediante SSL (Secure Sockets Layer). Se non è possibile ottenere una connessione crittografata, la connessione non viene stabilita.  
 ...
 **Certificato server attendibile**  
 ...
 Il **certificato server attendibile** è disponibile solo se **Forza crittografia protocollo** è impostata su **Sì**.  
