...
# <a name="nsltservice-namegt-properties-service-tab"></a>Proprietà NS$&lt;nome servizio&gt; (scheda Servizio)
  Questo servizio è il [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNS](../../includes/ssns-md.md)] servizio. I valori delle proprietà visualizzati in grigio chiaro non possono essere modificati con questa applicazione.  
