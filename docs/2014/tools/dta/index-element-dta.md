...
|Relazione|Elementi|  
|------------------|--------------|  
|**Elemento padre**|[Crea elemento &#40;DTA&#41;](create-element-dta.md)<br /><br /> `Drop`Elemento. Per ulteriori informazioni, vedere l'XML Schema di Ottimizzazione guidata motore di database.|  
|**Elementi figlio**|[Elemento Name per index &#40;DTA&#41;](name-element-for-index-dta.md)<br /><br /> [Elemento Column per index &#40;DTA&#41;](column-element-for-index-dta.md)<br /><br /> `PartitionScheme`Elemento. Per ulteriori informazioni, vedere l'XML Schema di Ottimizzazione guidata motore di database.<br /><br /> `PartitionColumn`Elemento. Per ulteriori informazioni, vedere l'XML Schema di Ottimizzazione guidata motore di database.<br /><br /> [Elemento filegroup per index &#40;DTA&#41;](filegroup-element-for-index-dta.md)<br /><br /> `NumberOfReferences`Elemento. Per ulteriori informazioni, vedere l'XML Schema di Ottimizzazione guidata motore di database.<br /><br /> `PercentUsage`Elemento. Per ulteriori informazioni, vedere l'XML Schema di Ottimizzazione guidata motore di database.|  
