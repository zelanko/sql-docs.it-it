 ...
 **-DelBkUps**\< *time_period* >  
 Per i backup su disco, specifica che tutti i file di backup nella directory di backup vengano eliminati se l'intervallo di tempo dopo la creazione del backup supera \<*time_period*> .  
