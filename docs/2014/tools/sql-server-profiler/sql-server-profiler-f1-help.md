...
# <a name="sql-server-profiler-f1-help"></a>Guida sensibile al contesto di SQL Server Profiler
 ...
 Nella sezione seguente sono inclusi gli argomenti della Guida sensibile al contesto di [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]. Per accedere a questi argomenti dall'interfaccia utente, premere F1 o fare clic su **?** nelle finestre di dialogo.  
