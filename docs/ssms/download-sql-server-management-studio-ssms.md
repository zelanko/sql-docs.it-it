...
## <a name="download-ssms-180-ga"></a>Scaricare SSMS 18.0 (GA)

**È ora disponibile SSMS 18.0 General Availability (GA), la nuova generazione di *SQL Server Management Studio* con supporto per [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)]** .

**[![download](../ssdt/media/download.png) Scaricare SQL Server Management Studio 18.0 (GA)](https://go.microsoft.com/fwlink/?linkid=2088649)**

SSMS 18.0 non è più disponibile in anteprima e questa è la prima versione di disponibilità generale (GA). Disinstallare un'eventuale versione in anteprima di SSMS 18.0 prima di installare SSMS 18.0 GA.

**Informazioni sulla versione**

- Numero di versione: 18.0 (GA)<br>
...
## <a name="available-languages-ssms-180-ga"></a>Lingue disponibili (SSMS 18.0 GA)
...
Nessuna opzione di aggiornamento disponibile attualmente. Disinstallare un'eventuale versione precedente di SSMS 18.0 Preview prima di installare SSMS 18.0 GA.
...
## <a name="new-in-this-release-ssms-180-ga"></a>Novità della versione (SSMS 18.0 GA)

SSMS 18.0 (GA) è la versione più recente di SQL Server Management Studio. La generazione 18.x di SSMS offre supporto per la maggior parte delle aree di funzionalità da SQL Server 2008 fino all'anteprima di SQL Server 2019.
...
## <a name="supported-sql-offerings-ssms-180-ga"></a>Offerte di SQL supportate (SSMS 18.0 GA)
...
## <a name="supported-operating-systems-ssms-180-ga"></a>Sistemi operativi supportati (SSMS 18.0 GA)
...
## <a name="release-notes-ssms-180-ga"></a>Note sulla versione (SSMS 18.0 GA)

- La **creazione guidata di SSIS Integration Runtime** mostra solo i database SQL in un unico tenant quando l'account del cliente appartiene a più tenant.
