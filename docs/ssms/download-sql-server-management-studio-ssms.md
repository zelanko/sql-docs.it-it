...
SSMS 18.2 è la versione disponibile a livello generale più recente di SSMS. Se si ha SSMS 18.2 (disponibilità generale) già installato, l'installazione di SSMS 18.2 esegue l'aggiornamento alla versione 18.2. Se si ha una versione *precedente* di SSMS 18.x, è necessario disinstallarla prima di installare SSMS 18.2.
...
| SMO  | Estensioni di valutazione. Vedere <we need a link to something> |
