...
[È ora disponibile SSMS 18.0 Release Candidate 1 (RC1)](#ssms-180-rc1), la nuova generazione di *SQL Server Management Studio* con supporto per [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)].
...
[![download](../ssdt/media/download.png) Scaricare il pacchetto di aggiornamento di SQL Server Management Studio 17.9.1 (aggiornamento dalla versione 17.x alla versione 17.9.1)](https://go.microsoft.com/fwlink/?linkid=2043430)
...
**È ora disponibile SSMS 18.0 Release Candidate 1 (RC1), la nuova generazione di *SQL Server Management Studio* con supporto per [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)].**

**[![download](../ssdt/media/download.png) Scaricare SQL Server Management Studio 18.0 (RC1)](https://go.microsoft.com/fwlink/?linkid=2085742)**

*RC1* è l'anteprima pubblica più recente di SSMS 18.0. Disinstallare un'eventuale versione precedente di SSMS 18.0 Preview prima di installare SSMS 18.0 RC1.

**Informazioni sulla versione**

- Numero di versione: 18.0 (RC1)<br>
...
## <a name="available-languages-ssms-180-rc1"></a>Lingue disponibili (SSMS 18.0 RC1)

Questa versione di SSMS può essere installata nelle lingue seguenti:

SQL Server Management Studio 18.0 (RC1):<br>
[Cinese (semplificato)](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x804) | [Cinese (tradizionale)](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x404) | [Inglese (Stati Uniti)](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x409) | [Francese](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x40c) | [Tedesco](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x407) | [Italiano](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x410) | [Giapponese](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x411) | [Coreano](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x412) | [Portoghese (Brasile)](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x416) | [Russo](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x419) | [Spagnolo](https://go.microsoft.com/fwlink/?linkid=2085742&clcid=0x40a)

Pacchetto di aggiornamento di SQL Server Management Studio 18.0 (aggiornamento alla versione 18.0):<br>
Nessuna opzione di aggiornamento disponibile attualmente. Disinstallare un'eventuale versione precedente di SSMS 18.0 Preview prima di installare SSMS 18.0 RC1.
...
## <a name="new-in-this-release-ssms-180-rc1"></a>Novità della versione (SSMS 18.0 RC1)
...
## <a name="supported-operating-systems-ssms-180-rc1"></a>Sistemi operativi supportati (SSMS 18.0 RC1)
...
<sup>*</sup> Richiede la versione 1607 (10.0.14939) o una versione successiva
...
## <a name="release-notes-ssms-180-rc1"></a>Note sulla versione (SSMS 18.0 RC1)
