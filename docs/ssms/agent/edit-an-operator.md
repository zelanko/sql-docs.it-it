---
description: Modifica di un operatore
...
Per altre informazioni, vedere [sp_update_operator (Transact-SQL)](../../relational-databases/system-stored-procedures/sp-update-operator-transact-sql.md).  
