...
7.  Nella finestra di dialogo **Proprietà** _SQL Server Agent\__ (nome**server)** nella scheda **Accesso** selezionare una delle seguenti opzioni in **Accedi come**:  
