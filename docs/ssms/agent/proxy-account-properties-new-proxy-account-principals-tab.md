---
title: Proprietà account proxy - Nuovo account proxy (scheda Entità) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
Usare questa pagina per visualizzare o modificare le entità che possono usare un account proxy di [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent nei passaggi di processo.  
