...
1.  Usare la stored procedure **sp_msx_enlist** .  Per altre informazioni, vedere [sp_msx_enlist (Transact-SQL)](../../relational-databases/system-stored-procedures/sp-msx-enlist-transact-sql.md)  
