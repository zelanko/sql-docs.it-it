---
description: Tasti di scelta rapida di SQL Server Management Studio
title: Tasti di scelta rapida di SQL Server Management Studio
...
|Visualizzare la finestra **Elenco attività**|CTRL+\\, T<br /><br /> oppure<br /><br /> CTRL+\\, CTRL+T|CTRL+ALT+K|  
...
|Visualizzare la finestra Elenco errori (solo editor[!INCLUDE[tsql](../includes/tsql-md.md)] )|CRTL+\\, CTRL+E<br /><br /> oppure<br /><br /> CTRL+\\, E|CRTL+\\, CTRL+E|  
...
|Spostare il cursore alla fine della riga|END|FINE|  
...
|Ripristinare la modifica annullata in precedenza|CTRL+MAIUSC+Z<br /><br /> oppure<br /><br /> CTRL+Y<br /><br /> oppure<br /><br /> ALT+MAIUSC+BACKSPACE|CTRL+MAIUSC+Z<br /><br /> oppure<br /><br /> CTRL+Y<br /><br /> oppure<br /><br /> ALT+MAIUSC+BACKSPACE|  
...
|Eseguire la parte selezionata dell'editor di query o, in assenza di selezione, l'intero editor di query|F5<br /><br /> oppure<br /><br /> CTRL+MAIUSC+E|F5<br /><br /> oppure<br /><br /> CTRL+E<br /><br /> oppure<br /><br /> ALT+X|  
...
|Eliminare un carattere a destra del cursore|Elimina|DELETE|  
...
|Visualizzare la finestra di dialogo **Controllo immediato**|CTRL+ALT+Q<br /><br /> oppure<br /><br /> MAIUSC+F9|CTRL+ALT+Q|  
...
|Action|[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Elencare i membri|CTRL+J|CTRL+BARRA SPAZIATRICE<br /><br /> oppure<br /><br /> CTRL+J|  
|Completare una parola|CTRL+BARRA SPAZIATRICE<br /><br /> oppure<br /><br /> ALT+FRECCIA DESTRA|ALT+FRECCIA DESTRA|  
...
|Action|[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Modalità schermo intero|MAIUSC+ALT+INVIO|MAIUSC+ALT+INVIO|  
...
|Action|[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Guida|F1<br /><br /> oppure<br /><br /> MAIUSC+F1|F1|  
...
|Action|[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Tagliare (eliminare l'elemento selezionato e metterlo negli Appunti)|CTRL+X<br /><br /> oppure<br /><br /> SHIFT+CANC|CTRL+X<br /><br /> oppure<br /><br /> MAIUSC+CANC|  
|Tagliare tutte le righe selezionate o la riga corrente se non viene selezionato nulla.|CTRL+L<br /><br /> oppure<br /><br /> CTRL+MAIUSC+L|Nessun equivalente|  
|Copiare negli Appunti|CTRL+C<br /><br /> oppure<br /><br /> CTRL+INS|CTRL+C<br /><br /> oppure<br /><br /> CTRL+INS|  
|Incollare il testo dagli Appunti nel punto di inserimento|CTRL+V<br /><br /> oppure<br /><br /> MAIUSC+INS|CTRL+V<br /><br /> oppure<br /><br /> MAIUSC+INS|  
