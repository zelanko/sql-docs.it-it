...
description: Informazioni su come trascinare il testo da un editor o Esplora oggetti e rilasciarlo in una posizione dell'editor o nel Cestino.
...
## <a name="see-also"></a>Vedere anche  
 [Spostarsi nel codice e nel testo](../../relational-databases/scripting/navigate-code-and-text.md)  
