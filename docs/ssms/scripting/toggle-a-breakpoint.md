...
description: Informazioni su come attivare/disattivare un punto di interruzione per evidenziare l'istruzione Transact-SQL associata e per eseguire varie azioni sull'istruzione, ad esempio la modifica.
