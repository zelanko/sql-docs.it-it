---
title: Modifica del percorso predefinito per i progetti
...
1.  Modificare il percorso predefinito aprendo o salvando un file o un progetto da un altro percorso. [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] archivia il percorso del progetto aperto precedentemente e lo usa per la successiva apertura o salvataggio di un progetto.  
