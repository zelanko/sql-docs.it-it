---
title: Soluzioni (SQL Server Management Studio)
...
|--------------------|---------|  
|Viene descritto come creare una nuova soluzione utilizzabile per contenere uno o più progetti.|[Creare una nuova soluzione](../../ssms/solution/create-a-new-solution.md)|  
