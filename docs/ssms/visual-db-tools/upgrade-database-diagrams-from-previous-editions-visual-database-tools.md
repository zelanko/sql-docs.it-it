---
description: Aggiornamento di diagrammi di database delle precedenti edizioni (Visual Database Tools)
title: Aggiornare diagrammi di database delle precedenti edizioni
...
[Informazioni sulla proprietà dei diagrammi di database](../../ssms/visual-db-tools/understand-database-diagram-ownership-visual-database-tools.md)  
