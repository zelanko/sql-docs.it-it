...
> [!TIP]
> Per visualizzare file contenuti in percorsi di rete o Web, specificare un URL o un percorso di rete nella casella **Nome file** . Ad esempio, se si digita `https://mywebsite` vengono visualizzati i file disponibili nel percorso Web "mywebsite", mentre se si digita "\\\myserver\myshare" vengono visualizzati i file disponibili nel percorso "myshare" del server "myserver".  
