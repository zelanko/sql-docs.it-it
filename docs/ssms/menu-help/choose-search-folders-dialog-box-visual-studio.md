---
description: Finestra di dialogo Seleziona cartelle di ricerca (Visual Studio)
title: Finestra di dialogo Seleziona cartelle di ricerca (Visual Studio)
