---
description: Opzioni (Ambiente - pagina Tastiera)
...
**Standard**  
Lo schema Standard è l'impostazione predefinita in [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ed è analogo allo schema dei tasti di scelta rapida di [!INCLUDE[msCoName](../../includes/msconame_md.md)] Visual Studio.  
