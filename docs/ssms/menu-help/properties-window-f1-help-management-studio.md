---
description: Guida sensibile al contesto della finestra Proprietà (Management Studio)
title: Guida sensibile al contesto della finestra Proprietà (Management Studio)
ms.prod: sql
...
- [Finestra proprietà in SQL Server Management Studio](../scripting/use-the-properties-window-in-management-studio.md)