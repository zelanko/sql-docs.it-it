...
description: Informazioni su come creare web part personalizzate che forniscono parametri e percorsi di report alla web part Visualizzatore report tramite connessioni web part.
ms.date: 03/04/2017
