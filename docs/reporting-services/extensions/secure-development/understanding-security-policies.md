...
description: Informazioni sui criteri di sicurezza di Reporting Services, che specificano le autorizzazioni per gli assembly, le estensioni e le espressioni del report in base ai gruppi di codice.
ms.date: 03/14/2017
