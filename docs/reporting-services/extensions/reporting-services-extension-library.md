...
description: Informazioni sulla libreria di estensioni di Reporting Services, un set di classi, interfacce e tipi di valori che forniscono l'accesso alle funzionalità del sistema.
ms.date: 03/14/2017
