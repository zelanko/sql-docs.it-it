...
description: Informazioni su come le estensioni per il recapito possono usare la classe Report, che archivia l'URL del report nel server di report, il nome del report e altre proprietà.
ms.date: 03/06/2017
