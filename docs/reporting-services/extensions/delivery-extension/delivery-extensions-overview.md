...
description: Panoramica delle estensioni per il recapito, che è possibile usare per recapitare i report Reporting Services in diversi modi, ad esempio tramite posta elettronica o condivisione di file.
ms.date: 03/14/2017
