...
2. In Filtrato per selezionare lo strumento di navigazione da usare per filtrare il misuratore.
   ...
   ![Screenshot delle opzioni di Valore principale espanse con l'opzione Filtrato per Elenco prodotti selezionata.](../../reporting-services/mobile-reports/media/mobile-report-gauge-navigator.png)
