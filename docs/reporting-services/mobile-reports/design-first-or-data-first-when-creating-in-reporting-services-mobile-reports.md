...
description: Mobile Report Publisher supporta gli approcci che iniziano con i dati o con la progettazione per la creazione di report. Importare prima tutti i dati o creare una progettazione e quindi importare i dati.
ms.date: 02/08/2016
