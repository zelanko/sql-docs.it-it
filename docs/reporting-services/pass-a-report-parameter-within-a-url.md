...
description: Informazioni su come passare parametri del report direttamente al motore di elaborazione dei report includendoli in un URL del report.
ms.date: 03/01/2017
