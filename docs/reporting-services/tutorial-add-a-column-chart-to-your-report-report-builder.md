...
![Screenshot che mostra un istogramma di Generatore report.](../reporting-services/media/report-builder-column-chart-tutorial.png)    
> [!NOTE]  
...
6.  Fare clic su **Fine**.  
    ...
    ![Screenshot di una colonna di Generatore report nella visualizzazione progettazione.](../reporting-services/media/report-builder-column-chart-1-design-view.png)
...
8.  Fare clic su **Esegui** per visualizzare l'anteprima del report.  
    ...
    ![Screenshot che mostra un'anteprima dell'istogramma di Generatore report.](../reporting-services/media/report-builder-column-chart-1-preview.png)
...
![Screenshot dell'istogramma di Generatore report che mostra il formato della data.](../reporting-services/media/report-builder-column-chart-2-preview.png)
...
8.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
    ...
    ![Screenshot dell'istogramma di Generatore report con il testo dell'asse x ruotato nella visualizzazione progettazione.](../reporting-services/media/report-builder-column-chart-rotate-x-axis.png)
  
9. Fare clic su **Esegui** per visualizzare l'anteprima del report.  
  
Nel grafico le etichette appaiono ruotate.  

![Screenshot che mostra un'anteprima dell'istogramma di Generatore report con il testo dell'asse x ruotato.](../reporting-services/media/report-builder-column-chart-rotate-x-axis-preview.png)
...
12. Fare clic su **Esegui** per visualizzare l'anteprima del report.  
    ...
    ![Screenshot che mostra un'anteprima del formato dell'istogramma di Generatore report con l'asse y etichettato correttamente.](../reporting-services/media/report-builder-column-chart-format-y-axis.png)
...
3. Nel riquadro Proprietà impostare LabelInterval su 1.
    ...
    ![Screenshot che mostra come impostare l'intervallo di etichette dell'istogramma di Generatore report.](../reporting-services/media/report-builder-column-chart-set-label-interval.png)
...
5.  Fare clic su **Esegui** per visualizzare l'anteprima del report.
    ...
    ![Screenshot che mostra un'anteprima dell'istogramma di Generatore report con l'intervallo di etichette impostato su uno.](../reporting-services/media/report-builder-column-chart-label-interval-one-preview.png)
...
3.  Fare clic con il pulsante destro del mouse sul campo **[Sum(Sales)]** disponibile nell'area **Valori** , quindi scegliere **Aggiungi serie calcolata**.  
     ...
     ![Screenshot che mostra come aggiungere una serie calcolata all'istogramma di Generatore report.](../reporting-services/media/report-builder-column-chart-add-calculated-series.png)
...
![Screenshot di un istogramma di Generatore report che illustra una media mobile.](../reporting-services/media/report-builder-column-chart-moving-average.png)
