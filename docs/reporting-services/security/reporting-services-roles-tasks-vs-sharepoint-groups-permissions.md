---
description: Ruoli-attività di Reporting Services e autorizzazioni-gruppi di SharePoint
...
|Creazione di report collegati|Elemento|Non supportata.|  
...
|Visualizzare le risorse|Elemento|Visualizzazione elementi.|  
||||  
