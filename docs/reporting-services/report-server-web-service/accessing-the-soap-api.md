...
description: Il servizio Web ReportServer usa SOAP su HTTP e funge da interfaccia di comunicazione tra i client e il server di report. Usare WSDL per chiamare il servizio.
ms.date: 03/14/2017
