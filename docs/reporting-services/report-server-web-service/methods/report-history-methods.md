...
description: In Reporting Services è possibile usare questi metodi di cronologia dei report per creare e gestire gli snapshot della cronologia degli elementi.
ms.date: 03/06/2017
