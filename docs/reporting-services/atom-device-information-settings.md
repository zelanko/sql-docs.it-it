...
description: Informazioni sulle impostazioni relative alle informazioni sul dispositivo per l'estensione per il rendering Atom che supportano l'invio del nome di un feed Atom e della codifica dei caratteri da usare.
ms.date: 03/16/2017
