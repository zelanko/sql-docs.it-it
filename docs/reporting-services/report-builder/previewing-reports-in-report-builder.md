...
description: Durante la creazione di un report impaginato di Reporting Services è possibile visualizzare l'anteprima del report per verificare che il contenuto visualizzato corrisponda a quanto desiderato.
ms.date: 01/09/2017
