...
description: Generatore report richiede di convertire alcuni elementi del report personalizzati, che hanno funzionalità non supportate, nel nuovo formato di definizione del report.
ms.date: 08/17/2018
