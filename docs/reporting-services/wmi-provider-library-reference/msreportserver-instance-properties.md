---
description: Proprietà di MSReportServer_Instance
...
|[Versione](../../reporting-services/wmi-provider-library-reference/msreportserver-instance-properties-version.md)|Restituisce la versione del server di report.|  
