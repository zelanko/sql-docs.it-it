...
description: Informazioni sulle finestre Progettazione query con interfaccia grafica di Reporting Services per la creazione di query MDL (Multidimensional Expression).
ms.date: 03/07/2017
...
|![Passaggio alla visualizzazione query MDX](../../reporting-services/report-data/media/rsqdicon-commandtypemdx.gif "Passaggio alla visualizzazione query MDX")|Consente di passare al tipo di comando MDX.|  
|![Passaggio alla visualizzazione linguaggio di query DMX](../../reporting-services/report-data/media/rsqdicon-commandtypedmx.gif "Passaggio alla visualizzazione linguaggio di query DMX")|Consente di passare al tipo di comando DMX.|  
