---
title: Aggiungere dati da origini dati esterne | Microsoft Docs
description: Informazioni sull'aggiunta di dati ai report da origini dati esterne e sul funzionamento dei report con tecnologie di accesso ai dati.
...
|[Tipo di connessione Azure SQL &#40;SSRS&#41;](../../reporting-services/report-data/sql-azure-connection-type-ssrs.md)|[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssSDS](../../includes/sssds-md.md)]|  
...
|[Creare stringhe di connessione dati - Generatore report e SSRS](../../reporting-services/report-data/data-connections-data-sources-and-connection-strings-report-builder-and-ssrs.md)|Vengono fornite informazioni sulle connessioni dati e sulle origini dati.|  
...
|[Panoramica delle estensioni per l'elaborazione dati](../../reporting-services/extensions/data-processing/data-processing-extensions-overview.md)|Vengono fornite informazioni dettagliate destinate agli utenti avanzati sulle estensioni per i dati.|  
