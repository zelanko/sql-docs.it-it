...
description: Informazioni su come usare la finestra Progettazione query con interfaccia grafica per esplorare i metadati, creare in modo interattivo una query e visualizzarne i relativi risultati.
ms.date: 03/14/2017
...
>  [!INCLUDE[ssDWCurrentFull](../../includes/ssdwcurrentfull-md.md)] non supporta stored procedure o funzioni con valori di tabella.  
 ...
 ![Finestra Progettazione query con interfaccia grafica](../../reporting-services/report-data/media/rsqd-relational-graphical.gif "Progettazione query con interfaccia grafica")  
 ...
 ![Stored procedure nella finestra Progettazione query con interfaccia grafica](../../reporting-services/report-data/media/rs-relational-graphical-sp.gif "Stored procedure nella finestra Progettazione query con interfaccia grafica")  
...
#### <a name="group-and-aggregate"></a>Raggruppa e aggrega  
 ...
 Per altre informazioni su [!INCLUDE[tsql](../../includes/tsql-md.md)], vedere [Guida di riferimento a Transact-SQL &#40;Motore di database&#41;](../../t-sql/language-reference.md).  
