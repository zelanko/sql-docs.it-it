---
title: Integrare usando l'accesso con URL
description: Una richiesta URL consente di accedere a un server di report specifico, nonché ai report, alle risorse e agli altri elementi presenti nel database del server di report.
ms.date: 03/14/2017
...
ms.locfileid: "74796828"
---
# <a name="integrate-reporting-services-using-url-access"></a>Integrare Reporting Services usando l'accesso con URL
