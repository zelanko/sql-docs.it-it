...
description: L'accesso con URL in Reporting Services è progettato in maniera specifica per consentire l'accesso ai singoli report in una rete.
ms.date: 03/16/2017
