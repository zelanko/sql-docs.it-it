...
description: Informazioni sugli eventi che determinano il riciclo di un dominio di applicazioni di Reporting Services per la risoluzione dei problemi.
ms.date: 03/20/2017
