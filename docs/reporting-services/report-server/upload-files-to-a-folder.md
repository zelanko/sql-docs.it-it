...
description: Informazioni su quanto avviene quando si caricano diversi tipi di file dal file system e li si archivia come elementi gestiti in un database del server di report in Reporting Services.
ms.date: 06/17/2019
