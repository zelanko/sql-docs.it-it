...
description: Informazioni su come usare la visualizzazione Progettazione di Progettazione report in Reporting Services per disporre gli elementi all'interno di un report.
ms.date: 05/31/2016
