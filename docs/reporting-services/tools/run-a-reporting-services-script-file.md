...
description: È possibile vedere esempi di come eseguire un file script di Reporting Services dal prompt dei comandi usando l'ambiente di script Reporting Services (RS.exe).
ms.date: 03/01/2017
