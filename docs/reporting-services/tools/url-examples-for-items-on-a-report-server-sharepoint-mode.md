...
description: È possibile visualizzare esempi di utilizzo di URL che specificano i percorsi della gerarchia Web di un sito SharePoint in un server di report.
ms.date: 03/14/2017
