...
description: Informazioni sull'utilità RS.exe che è possibile usare per amministrare un server di report a livello di codice usando script scritti con Microsoft Visual Basic.
ms.date: 03/14/2017
