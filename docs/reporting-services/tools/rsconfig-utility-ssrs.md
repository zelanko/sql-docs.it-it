---
title: Utilità rsconfig | Microsoft Docs
description: Informazioni sull'utilità rsconfig.exe, che consente di crittografare e archiviare i valori relativi alle connessioni e agli account del database del server di report nel file RSReportServer.config.
ms.date: 03/20/2017
