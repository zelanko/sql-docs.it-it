...
description: Informazioni su come impostare la lingua per i parametri del report in un URL tramite il parametro di accesso con URL rs:ParameterLanguage.
ms.date: 03/01/2017
