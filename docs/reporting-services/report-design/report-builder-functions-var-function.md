---
title: Funzione Var (Generatore report) | Microsoft Docs
description: Usare la funzione Var per restituire la varianza di tutti i valori numerici non Null specificati dall'espressione in Generatore report.
ms.date: 03/07/2017
