...
description: Pianificare e creare report con testo in formato RTF che illustra i dati delle vendite, le tendenze di marketing, i report operativi o i dashboard in Generatore report.
ms.date: 03/03/2017
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Concetti relativi a Reporting Services (SSRS)](../reporting-services-concepts-ssrs.md)[Esercitazioni di Generatore report](../../reporting-services/report-builder-tutorials.md)  
