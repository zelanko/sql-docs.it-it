---
title: Funzione StDevP (Generatore report) | Microsoft Docs
description: Informazioni su questa funzione, che restituisce la deviazione standard della popolazione di tutti i valori numerici non Null specificati da un'espressione.
ms.date: 03/07/2017
