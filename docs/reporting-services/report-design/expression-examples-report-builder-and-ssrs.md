...
description: Controllare il contenuto e l'aspetto del report usando funzioni predefinite, codice personalizzato, variabili di report e di gruppo e variabili definite dall'utente in Generatore report.
ms.date: 04/06/2017
