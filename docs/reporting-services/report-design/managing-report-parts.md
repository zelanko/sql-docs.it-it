...
description: Organizzare le parti di report per più utenti e report, con la possibilità di scegliere opzioni flessibili per la pubblicazione, le autorizzazioni e la sicurezza.
ms.date: 03/14/2017
