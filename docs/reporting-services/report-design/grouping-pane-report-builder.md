...
description: Visualizzare gruppi di righe e di colonne per un'area dati Tablix selezionata. Informazioni sul riquadro di raggruppamento in Generatore report.
ms.date: 08/17/2018
