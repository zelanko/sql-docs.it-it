...
description: Creando un'applicazione di servizio nella modalità SharePoint di SQL Server Reporting Services si rende disponibile il servizio e si genera il database dell'applicazione di servizio.
ms.date: 09/25/2017
