...
description: È possibile usare la web part Visualizzatore report per visualizzare report eseguiti in un server di SQL Server Reporting Services configurato per l'integrazione con SharePoint.
ms.date: 11/26/2018
