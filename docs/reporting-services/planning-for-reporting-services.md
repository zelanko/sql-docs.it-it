...
# <a name="planning-for-reporting-services"></a>Pianificazione per Reporting Services
 ...
 [Visualizzare i report Reporting Services su dispositivi Microsoft Surface e Apple iOS](https://docs.microsoft.com/sql/reporting-services/what-s-new-in-sql-server-reporting-services-ssrs)  
