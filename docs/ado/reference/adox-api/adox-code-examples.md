...
ms.locfileid: "66718989"
---
# <a name="adox-code-examples"></a>Esempi di codice ADOX
Usare gli esempi di codice seguente per informazioni su come usare gli oggetti ADOX, metodi, proprietà ed eventi.  
...
-   [Esempi di codice ADOX in Microsoft Visual Basic](../../../ado/reference/adox-api/adox-code-examples-in-microsoft-visual-basic.md)  
  
-   [Esempi di codice ADOX in Microsoft Visual C++](../../../ado/reference/adox-api/adox-code-examples-in-microsoft-visual-c.md)  
