---
description: Esempio dei metodi Append di Columns e Tables e della proprietà Name (VC++)
title: Metodi di Accodamento di colonne e tabelle, esempio di proprietà Name (VC + +) | Microsoft Docs
ms.prod: sql
