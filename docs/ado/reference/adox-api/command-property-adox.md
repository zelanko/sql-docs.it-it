---
title: Comando proprietà (ADOX) | Microsoft Docs
ms.prod: sql
...
## <a name="remarks"></a>Note  
 Si verificherà un errore durante il recupero e impostazione di questa proprietà se il provider non supporta comandi di persistenza.  
  
## <a name="applies-to"></a>Si applica a  
  
|||  
|-|-|  
|[Oggetto Procedure (ADOX)](../../../ado/reference/adox-api/procedure-object-adox.md)|[Oggetto View (ADOX)](../../../ado/reference/adox-api/view-object-adox.md)|  
