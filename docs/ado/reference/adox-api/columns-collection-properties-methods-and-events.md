---
title: Proprietà di raccolta di colonne, metodi ed eventi | Microsoft Docs
ms.prod: sql
...
## <a name="methods"></a>Metodi  
 [Append (metodo) (colonne)](../../../ado/reference/adox-api/append-method-adox-columns.md)  
