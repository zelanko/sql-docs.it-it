---
title: Proprietà dell'insieme di procedure, metodi ed eventi | Microsoft Docs
ms.prod: sql
...
## <a name="methods"></a>Metodi  
 [Append (metodo) (procedure)](../../../ado/reference/adox-api/append-method-adox-procedures.md)  
