---
description: Esempio di CubeDef (VBScript)
title: Esempio di CubeDef (VBScript) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88987042"
---
# <a name="cubedef-example-vbscript"></a>Esempio di CubeDef (VBScript)
In questo esempio vengono visualizzati i metadati del cubo in una pagina Web.  
