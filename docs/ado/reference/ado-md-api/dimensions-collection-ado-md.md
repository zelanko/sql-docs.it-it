---
title: Dimensioni di tipo raccolta (ADO MD) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "63280373"
---
# <a name="dimensions-collection-ado-md"></a>Raccolta Dimensions (ADO MD)
Contiene il [dimensione](../../../ado/reference/ado-md-api/dimension-object-ado-md.md) gli oggetti che costituiscono un cubo.  
  
## <a name="remarks"></a>Note  
 **Dimensioni** è un insieme standard di ADO. Con le proprietà e metodi di una raccolta, è possibile eseguire le operazioni seguenti:  
...
-   [Proprietà, metodi ed eventi](../../../ado/reference/ado-md-api/dimensions-collection-properties-methods-and-events.md)  
