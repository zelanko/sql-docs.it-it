---
title: I livelli di raccolta (ADO MD) | Microsoft Docs
ms.prod: sql
 ...
 **Livelli** è un insieme standard di ADO. Usando le proprietà e metodi di una raccolta, è possibile eseguire le operazioni seguenti:  
