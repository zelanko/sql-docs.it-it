---
title: Esempio di proprietà Name (VC + +) e gli attributi | Microsoft Docs
ms.prod: sql
...
---
# <a name="attributes-and-name-properties-example-vc"></a>Esempio di proprietà Name (VC + +) e attributi
