---
description: Esempio di proprietà AbsolutePage, PageCount e PageSize (JScript)
title: Esempio di proprietà AbsolutePage, PageCount e PageSize (JScript) | Microsoft Docs
ms.prod: sql
