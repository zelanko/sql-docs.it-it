---
description: Esempio del metodo Clone (VB)
title: Esempio di metodo Clone (VB) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88450973"
---
# <a name="clone-method-example-vb"></a>Esempio del metodo Clone (VB)
