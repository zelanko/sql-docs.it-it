---
title: Supporta l'esempio di metodo (Visual Basic) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "66710819"
---
# <a name="supports-method-example-vb"></a>Esempio del metodo Supports (VB)
Questo esempio Usa la [supporta](../../../ado/reference/ado-api/supports-method.md) metodo per visualizzare le opzioni supportate da un recordset aperta con diversi tipi di cursore. La funzione DisplaySupport è necessaria per eseguire questa procedura.  
