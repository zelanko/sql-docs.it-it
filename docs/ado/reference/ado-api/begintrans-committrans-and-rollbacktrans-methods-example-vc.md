---
description: Esempio di metodi BeginTrans, CommitTrans e RollbackTrans (VC + +)
title: Esempio di metodi BeginTrans, CommitTrans e RollbackTrans (VC + +) | Microsoft Docs
ms.prod: sql
