---
title: Modello a oggetti ADO | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "67920919"
---
# <a name="ado-object-model"></a>Modello a oggetti ADO
Nelle figure seguenti vengono illustrati gli oggetti ADO e le relative raccolte.  
  
 ![Modello a oggetti ADO](../../../ado/reference/ado-api/media/ado_object_model.gif "ADO_object_model")  
