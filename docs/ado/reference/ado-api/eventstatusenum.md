...
|**adStatusOK**|1|Indica che l'operazione che ha causato l'evento è riuscito.|  
|**adStatusUnwantedEvent**|5|Impedisce successive notifiche prima che il metodo dell'evento ha terminato l'esecuzione.|  
