---
description: Esempio delle proprietà Provider e DefaultDatabase (VC++)
title: Esempio di proprietà provider e DefaultDatabase (VC + +) | Microsoft Docs
ms.prod: sql
