---
title: Proprietà, metodi ed eventi della raccolta Errors | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "82765482"
---
# <a name="errors-collection-properties-methods-and-events"></a>Proprietà, metodi ed eventi della raccolta Errors
