---
description: 'Errore (Visual C++ indice della sintassi con #import)'
title: 'Errore (Visual C++ indice della sintassi con #import) | Microsoft Docs'
ms.prod: sql
