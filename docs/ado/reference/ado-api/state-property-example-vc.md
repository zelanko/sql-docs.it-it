---
description: Esempio della proprietà State (VC++)
title: Esempio di proprietà state (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88777330"
---
# <a name="state-property-example-vc"></a>Esempio della proprietà State (VC++)
