---
description: Recordset (sintassi ADO/WFC)
title: Recordset (sintassi ADO-WFC) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88442433"
---
# <a name="recordset-ado---wfc-syntax"></a>Recordset (sintassi ADO/WFC)
