---
title: Supporta l'esempio di metodo (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "66710697"
---
# <a name="supports-method-example-vc"></a>Esempio del metodo Supports (VC++)
Questo esempio Usa la [supporta](../../../ado/reference/ado-api/supports-method.md) metodo per visualizzare le opzioni supportate da un recordset aperta con diversi tipi di cursore. La funzione DisplaySupport è necessaria per eseguire questo esempio.  
