...
description: Consente di visualizzare informazioni sulle espressioni XQuery che includono descrizioni di ogni tipo di espressione e su come utilizzarle.
ms.custom: ''
ms.date: 08/10/2016
ms.prod: sql
ms.prod_service: sql
