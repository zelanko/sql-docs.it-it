...
description: "Informazioni sul modo in cui la funzione XQuery SQL: Column () può essere utilizzata per associare dati relazionali non XML all'interno di XML e per unire dati relazionali e XML."
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.prod_service: sql
