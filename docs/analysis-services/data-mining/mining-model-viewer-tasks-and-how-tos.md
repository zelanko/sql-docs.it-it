...
-   [Selezionare un modello di data mining e un visualizzatore data mining](../../analysis-services/data-mining/select-a-mining-model-and-a-data-mining-viewer.md)  
  
-   [Copiare una vista di un modello di data mining](../../analysis-services/data-mining/copy-a-view-of-a-mining-model.md)  
...
-   [Filtrare una regola in un modello Association Rules](../../analysis-services/data-mining/filter-a-rule-in-an-association-rules-model.md)  
  
-   [Filtrare un set di elementi in un modello Association Rules](../../analysis-services/data-mining/filter-an-itemset-in-an-association-rules-model.md)  
...
-   [Modificare i colori utilizzati nel visualizzatore data mining](../../analysis-services/data-mining/change-the-colors-used-in-the-data-mining-viewer.md)  
