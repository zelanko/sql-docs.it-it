...
-   Per il secondo filtro scegliere la dimensione Customer, selezionare l'attributo Gender e quindi "Female" dall'elenco di valori di attributo.  
 ...
 Dopo avere creato la struttura di data mining, è possibile modificare sia la definizione dei dati del cubo sia i criteri di filtro. Per altre informazioni, vedere [i filtri per i modelli di Data Mining](~/analysis-services/data-mining/filters-for-mining-models-analysis-services-data-mining.md).  
