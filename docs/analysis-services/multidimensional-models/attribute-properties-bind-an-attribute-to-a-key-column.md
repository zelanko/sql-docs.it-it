...
4.  Digitare il nuovo nome.  
    ...
    > [!NOTE]  
    >  È inoltre possibile impostare la proprietà **Name** di un attributo selezionato nella finestra **Proprietà** di [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)].  
