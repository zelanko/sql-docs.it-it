...
[Programmazione di Data Mining](../analysis-services/data-mining/data-mining-programming.md) vengono descritti gli approcci la creazione di soluzioni che includono oggetti di data mining.
