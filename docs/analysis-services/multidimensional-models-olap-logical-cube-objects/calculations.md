...
```  
 ...
 Per creare membri calcolati, usare il **calcolo**scheda in Progettazione cubi. Per altre informazioni, vedere [creare membri calcolati](../../analysis-services/multidimensional-models/create-calculated-members.md)  
