...
5.  Se si tratta di una build di debug della libreria che si intende usare per il debug di stored procedure, selezionare la **Includi informazioni di debug** casella di controllo. Per altre informazioni sul debug delle stored procedure, vedere [debug di Stored procedure](../../analysis-services/multidimensional-models-extending-olap-stored-procedures/debugging-stored-procedures.md).  
