...
Per altre informazioni, vedere [Dimensioni padre-figlio](../multidimensional-models/parent-child-dimension.md), [Attributi nelle gerarchie padre-figlio](../multidimensional-models/parent-child-dimension-attributes.md)  
...
10. ![Tabella pivot che mostra gerarchia Employees](../media/l4-employee-1.gif "tabella pivot che mostra gerarchia Employees")  
...
4.  Nella seconda riga, ovvero nella riga contenente **\***, digitare **Employee Level \*** nella colonna **Nome** e fare clic sulla terza riga.  
    ...
    ![Finestra di dialogo Modello denominazione livello](../media/l4-namingtemplate.gif "nella finestra di dialogo Modello denominazione livelli")  
...
5.  Trascinare la gerarchia **Employees** nell'area Etichette di riga.  
    ...
    ![Gerarchia Employees modificata](../media/l4-employee-2.png "gerarchia Employees modificata")  
...
[Dimensioni padre-figlio](../multidimensional-models/parent-child-dimension.md)  
