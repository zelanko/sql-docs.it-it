...
4.  Nella finestra Proprietà impostare il valore della proprietà **AttributeHierarchyEnabled** su **False** per gli attributi selezionati.  
    ...
    ![Proprietà AttributeHierarchyEnabled è impostata su False](../media/l4-hierarchyenabled-1.gif "proprietà AttributeHierarchyEnabled è impostata su False")  
...
4.  Nella finestra Proprietà impostare il valore della proprietà **AttributeHierarchyVisible** su **False** per gli attributi selezionati.  
    ...
    ![La proprietà AttributeHierarchyVisible impostata su False](../media/l4-hierarchyvisible-1.gif "proprietà AttributeHierarchyVisible impostata su False")  
