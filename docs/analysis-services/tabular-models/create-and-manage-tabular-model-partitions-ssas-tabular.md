...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]
  ...
  > [!NOTE]  
>  Partizioni nei modelli tabulari creati al livello di compatibilità 1400 vengono definite utilizzando un'istruzione di query M. Per altre informazioni, vedere [riferimento M](/powerquery-m/power-query-m-reference). 
>
