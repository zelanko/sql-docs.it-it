...
## <a name="remarks"></a>Note  
 ...
 Dopo aver ottenuto il set di punti, il **LinRegSlope** funzione restituisce l'inclinazione della retta di regressione (nell'equazione riportata sopra).  
