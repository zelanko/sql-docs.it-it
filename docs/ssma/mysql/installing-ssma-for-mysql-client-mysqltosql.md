...
-   Eseguire la migrazione [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] dei dati a o SQL Azure.  
...
1.  Fare doppio clic su SSMA per MySQL *n*. Installare. exe, dove *n* è il numero di Build.  
