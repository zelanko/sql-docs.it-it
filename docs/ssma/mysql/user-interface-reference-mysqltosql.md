---
title: Guida di riferimento all'interfaccia utente (MySQLToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
|[Connettersi al SQL Server](https://msdn.microsoft.com/d73abd3a-80df-4293-b973-1723069db049)|Utilizzare la finestra di dialogo **Connetti a SQL Server** per connettersi all'istanza di SQL Server in cui si desidera eseguire la migrazione.|  
...
|[Impostazioni progetto &#40;GUI&#41;  &#40;MySQLToSQL&#41;](../../ssma/mysql/project-settings-gui-mysqltosql.md)|Utilizzare la pagina GUI della finestra di dialogo **Impostazioni progetto** per specificare la quantità di dati da visualizzare nella scheda **dati** .|  
|[Impostazioni progetto &#40;sincronizzazione&#41; &#40;MySQLToSQL&#41;](../../ssma/mysql/project-settings-synchronization-mysqltosql.md)|Usare la pagina Migrazione della finestra di dialogo **Impostazioni progetto** per personalizzare il modo in cui SSMA per MySQL migra i dati da mysql a SQL Server.|  
|[Impostazioni progetto &#40;migrazione&#41; &#40;MySQLToSQL&#41;](../../ssma/mysql/project-settings-migration-mysqltosql.md)|Utilizzare la pagina sincronizzazione della finestra di dialogo **Impostazioni progetto** per personalizzare la modalità di creazione o modifica di oggetti di database migrati in SQL Server da parte di SSMA per MySQL.|  
|[Impostazioni progetto &#40;database SQL di Azure&#41; &#40;MySQLToSQL&#41;](../../ssma/mysql/project-settings-azure-sql-db-mysqltosql.md)|Utilizzare la pagina SQL Azure della finestra di dialogo **Impostazioni progetto** per personalizzare le impostazioni di connettività per la migrazione dei dati da MySQL a SQL Azure.|  
|[Impostazioni progetto &#40;mapping dei tipi&#41; &#40;MySQLToSQL&#41;](../../ssma/mysql/project-settings-type-mapping-mysqltosql.md)|Utilizzare la pagina mapping dei tipi della finestra di dialogo **Impostazioni progetto** per specificare i mapping dei tipi predefiniti per tutti i database e gli oggetti di database nel progetto SSMA per MySQL.|  
