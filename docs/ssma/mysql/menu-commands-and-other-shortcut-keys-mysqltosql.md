---
title: Comandi di menu e tasti di scelta rapida (MySQLToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "63311834"
---
# <a name="menu-commands-and-other-shortcut-keys-mysqltosql"></a>Comandi di menu e altri tasti di scelta rapida (MySQLToSQL)
Le sezioni seguenti descrivono i tasti di scelta rapida per accedere ai comandi di menu e tasti di scelta rapida usati in varie finestre di dialogo di SSMA per MySQL applicazione.  
...
|Visualizzare di connettersi o riconnettersi alla finestra di dialogo di MySQL.|ALT + F + T|  
...
|Aggiornare dal database MySQL.|ALT + T + R|  
...
|PER ESEGUIRE QUESTA OPERAZIONE|PREMERE|  
|--------------|---------|  
|Visualizzare su SSMA per MySQL, finestra di dialogo.|ALT + H + A|  
