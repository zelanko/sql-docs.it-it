...
Inoltre, SSMA per MySQL ora fornisce la clausola di `LIMIT` conversione per quando la destinazione è SQL Azure.
...
* Supporto per la conversione `LIMIT` di [!INCLUDE [ssSQL11](../../includes/sssql11-md.md)] `OFFSET`in.
