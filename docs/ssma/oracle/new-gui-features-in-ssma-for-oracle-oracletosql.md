---
title: Nuove funzionalità GUI in SSMA per Oracle (OracleToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "63209822"
---
# <a name="new-gui-features-in-ssma-for-oracle-oracletosql"></a>Nuove funzionalità GUI in SSMA per Oracle (OracleToSQL)
