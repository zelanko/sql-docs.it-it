---
title: Comandi di menu e tasti di scelta rapida (Oracle a SQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "63209899"
---
# <a name="menu-commands-and-other-shortcut-keysoracle-to-sql"></a>Comandi di menu e altri tasti di scelta rapida (OracleToSQL)
Le sezioni seguenti descrivono i tasti di scelta rapida per accedere ai comandi di menu e tasti di scelta rapida usati in varie finestre di dialogo di SSMA per Oracle applicazione.  
...
|Visualizzare di connettersi o riconnettersi alla finestra di dialogo Oracle.|ALT + F + T|  
...
|Aggiornare dal database Oracle.|ALT + T + R|  
...
|Sottomenu di gestione di backup di accesso Oracle.|ALT + S + B|  
...
|PER ESEGUIRE QUESTA OPERAZIONE|PREMERE|  
|--------------|---------|  
|Riportati su SSMA per la finestra di dialogo Oracle.|ALT + H + A|  
...
[Tasti di scelta rapida&#40;Oracle in SQL&#41;](../../ssma/oracle/shortcut-keys-oracle-to-sql.md)  
