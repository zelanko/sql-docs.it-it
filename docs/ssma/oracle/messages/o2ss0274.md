...
Quando si esegue il codice precedente in Oracle, viene creata una funzione `F_RETURN_CUR` con il nome. Questa funzione restituisce il cursore `refCursorValue`. Durante la migrazione di questa funzione, SSMA genera un messaggio di errore:
