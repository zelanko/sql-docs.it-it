---
description: Comandi di menu e altri tasti di scelta rapida (SybaseToSQL)
title: Comandi di menu e altri tasti di scelta rapida (Sybase to SQL) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
|Consente di visualizzare la finestra di dialogo Connetti o Riconnetti a Sybase.|ALT + F + T|  
...
|Accedere al sottomenu gestione backup Sybase.|ALT + S + B|  
|Visualizzare la finestra di dialogo Aggiungi tabelle al backup per Sybase.|ALT + S + B + B|  
|Visualizzare la finestra di dialogo Ripristina tabelle da backup per Sybase.|ALT + S + B + R|  
|Visualizzare la finestra di dialogo Gestisci contenuto di backup per Sybase.|ALT + S + B + C|  
...
|PER ESEGUIRE QUESTA OPERAZIONE|Premere|  
|--------------|---------|  
|Visualizzare informazioni sulla finestra di dialogo SSMA per Sybase.|ALT + H + A|  
