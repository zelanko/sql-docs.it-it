---
title: Comandi di menu e tasti di scelta rapida (Sybase To SQL) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "62705863"
---
# <a name="menu-commands-and-other-shortcut-keys-sybase-to-sql"></a>Comandi di menu e altri tasti di scelta rapida (SybaseToSQL)
Le sezioni seguenti descrivono i tasti di scelta rapida per accedere ai comandi di menu e tasti di scelta rapida usati in varie finestre di dialogo di SSMA per Sybase applicazione.  
...
|Visualizzare di connettersi o riconnettersi alla finestra di dialogo di Sybase.|ALT + F + T|  
...
## <a name="edit-menu-commands"></a>Comandi del menu Modifica  
...
## <a name="tools-menu-commands"></a>Comandi del menu Strumenti  
...
|Aggiornare dal database di Sybase.|ALT + T + R|  
...
Per accedere a Tester menu, tasti di scelta rapida usato sono ALT + S. La tabella seguente descrive la tastiera tasti di scelta rapida consente di accedere alle voci di menu nel menu di Tester.  
  
|PER ESEGUIRE QUESTA OPERAZIONE|PREMERE|  
|--------------|---------|  
|Visualizzare la finestra di dialogo Creazione guidata test case.|ALT + S + N|  
|Visualizzare il repository della finestra di dialogo di test case.|ALT + S + C|  
|Visualizzare il repository della finestra di dialogo dei risultati dei test.|ALT + S + R|  
|Accedere a Sybase sottomenu di gestione di backup.|ALT + S + B|  
|Visualizzazione aggiungere tabelle al backup per la finestra di dialogo di Sybase.|ALT + S + B + B|  
|Visualizzare le tabelle di ripristino da backup per la finestra di dialogo di Sybase.|ALT + S + B + R|  
|Visualizzazione di gestire contenuto di backup per la finestra di dialogo di Sybase.|ALT + S + B + C|  
|Accedere a sottomenu di gestione di backup di SQL Server.|ALT + S + M|  
...
|PER ESEGUIRE QUESTA OPERAZIONE|PREMERE|  
|--------------|---------|  
|Visualizzare su SSMA per Sybase, finestra di dialogo.|ALT + H + A|  
...
[Tasti di scelta rapida&#40;Sybase To SQL&#41;](../../ssma/sybase/shortcut-keys-sybase-to-sql.md)  
