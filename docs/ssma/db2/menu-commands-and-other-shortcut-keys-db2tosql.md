---
title: Comandi di menu e tasti di scelta rapida (DB2ToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
|Visualizzare di connettersi o riconnettersi alla finestra di dialogo di DB2.|ALT + F + T|  
...
|Aggiornare dal database di DB2.|ALT + T + R|  
...
|PER ESEGUIRE QUESTA OPERAZIONE|PREMERE|  
|--------------|---------|  
|Visualizzare su SSMA per DB2, finestra di dialogo.|ALT + H + A|  
