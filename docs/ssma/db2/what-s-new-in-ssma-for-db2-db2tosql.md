...
Questo articolo elenca SQL Server Migration Assistant (SSMA) per le modifiche di DB2 in ogni versione.

## <a name="ssma-v82"></a>SSMA v8.2

È stata migliorata con la versione v8.2 di SSMA per DB2 per risolvere i problemi con le connessioni al Database SQL di Azure dalla colonna COUNT_BIG mancante nella dichiarazione di visualizzazioni durante la conversione e lo strumento console SSMA. Inoltre, questa versione include un set specifico di correzioni progettati per migliorare la qualità e le metriche di conversione, nonché correzioni per:
...
La versione v8.1 di SSMA per DB2 è stata migliorata per fornire correzioni mirate che sono progettate per migliorare le metriche di qualità e la conversione.
...
La versione 8.0 di SSMA per DB2 è stata migliorata per fornire correzioni mirate progettate per migliorare la qualità e la conversione delle metriche. Questa versione offre anche le nuove funzionalità seguenti:
...
La versione 7.1 di SSMA per DB2 contiene le seguenti modifiche:
