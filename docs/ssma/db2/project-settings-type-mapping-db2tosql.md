...
La pagina mapping dei tipi della finestra di dialogo **Impostazioni progetto** contiene impostazioni che personalizzano il modo in cui SSMA [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] converte i tipi di dati DB2 in tipi di dati.  
...
Tipo di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] dati di destinazione per il tipo di dati DB2 specificato.  
...
|Tipo di dati DB2|Tipo [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] di dati predefinito|  
|-----------------|-------------------------------------------------------------------------|  
|BFILE|varbinary(max)|  
