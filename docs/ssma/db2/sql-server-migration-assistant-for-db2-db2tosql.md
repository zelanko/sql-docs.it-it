...
|[Riferimento &#40;all'interfaccia utente DB2ToSQL&#41;](../../ssma/db2/user-interface-reference-db2tosql.md)|Contiene la documentazione per le finestre di dialogo SSMA per DB2.|  
