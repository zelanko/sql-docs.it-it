...
|`Section`|Descrizione|  
|-----------|---------------|  
|[Novità di SSMA per DB2](https://msdn.microsoft.com/1cc38f85-3caa-42d0-8c76-a380c1d15c67)|Quali sono le novità in questa versione di SSMA per DB2|  
...
|[Uso di SSMA per DB2 Console](https://msdn.microsoft.com/29d8787c-632e-4ff7-9ccc-3f7ad40480ec)|Include documentazione sull'applicazione Console SSMA|  
|[Introduzione a SSMA per DB2 assistenza](https://go.microsoft.com/fwlink/?LinkID=708538&clcid=0x409)|Fornisce informazioni su come ottenere ulteriore assistenza.|  
