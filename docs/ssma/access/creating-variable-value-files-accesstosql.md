---
description: Creazione di file di valori di variabile (AccessToSQL)
...
[Creazione dei file di connessione del server (accesso)](./creating-the-server-connection-files-accesstosql.md)  
