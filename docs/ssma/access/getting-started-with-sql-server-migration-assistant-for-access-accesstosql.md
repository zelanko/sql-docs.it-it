...
[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Migration Assistant (SSMA) per l'accesso consente di convertire rapidamente oggetti di database di Access in oggetti di database [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQL di Azure, caricare gli oggetti risultanti in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] o nel database SQL di Azure ed eseguire la migrazione dei dati dall'accesso al database [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQL di Azure o. Se necessario, è anche possibile collegare le tabelle di accesso a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] tabelle di database SQL di Azure e in modo da poter continuare a usare le applicazioni front-end di accesso esistenti con [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] o il database SQL di Azure.  
...
Dopo l'installazione di SSMA, è possibile acquisire familiarità con l'interfaccia utente di SSMA prima di utilizzare lo strumento per eseguire la migrazione dei database di Access a o al database [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQL di Azure. Il diagramma seguente illustra l'interfaccia utente di SSMA, tra cui le finestre di esplorazione dei metadati, i metadati, le barre degli strumenti, il riquadro di output e l'elenco errori.  
...
- Esportazione di un inventario di oggetti di database di Access in o nel database [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQL di Azure.
...
Dopo aver caricato gli schemi convertiti in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] o nel database SQL di Azure, è possibile tornare ad accedere a Esplora metadati ed eseguire la migrazione dei dati dai database di Access ai [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] database di database SQL di Azure o. Se necessario, è anche possibile collegare le tabelle di accesso a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] o a tabelle di database SQL di Azure.  
...
SSMA contiene due esploratori di metadati che è possibile usare per esplorare ed eseguire azioni sull'accesso e sui [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] database SQL di Azure.  
...
La barra degli strumenti del progetto contiene pulsanti per l'utilizzo di progetti, l'aggiunta di file di database di Access e la connessione al database [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQL di Azure o. Questi pulsanti sono simili ai comandi del menu **file** .  
...
|Menu|Descrizione|  
|--------|---------------|  
|**File**|Contiene i comandi per la migrazione guidata, l'utilizzo di progetti, l'aggiunta e la rimozione di file di database di Access e la connessione a o al database [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQL di Azure.|  
