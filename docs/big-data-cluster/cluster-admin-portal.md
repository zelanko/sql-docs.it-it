...
> [!NOTE]
> Per CTP 2.4, è disponibile un avviso di sicurezza all'accesso alla pagina web poiché utilizza i certificati SSL generati automaticamente.
