...
| Connettore Spark MSSQL | Supporto per la lettura/scrittura alle tabelle esterne del pool di dati. Solo tabelle dell'istanza precedente le versioni supportate lettura/scrittura al server principale. |
