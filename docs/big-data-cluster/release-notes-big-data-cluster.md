...
Febbraio 2019 &nbsp; &nbsp;  /  &nbsp; &nbsp; server&#41 2019 &nbsp; &nbsp;  /  &nbsp; &nbsp; CTP2.3
...
| _Sicurezza_ i nomi degli endpoint sono stati modificati e consolidati. | _Endpoint precedenti:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-security-lb**<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-security-nodeport**<br/><br/>_Nuovo endpoint:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **endpoint-security** |
| _Proxy_ i nomi degli endpoint sono stati modificati e consolidati. | _Endpoint precedenti:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-proxy-lb**<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-proxy-nodeport**<br/><br/>_Nuovo endpoint:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **endpoint-service-proxy** |
| _Controller_ i nomi degli endpoint sono stati modificati e consolidati. | _Endpoint precedenti:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-mssql-controller-lb**<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-mssql-controller-nodeport**<br/><br/>_Nuovo endpoint:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **endpoint-controller** |
| &nbsp; | &nbsp; |

### <a name="known-issues-deployment"></a>Problemi noti: Distribuzione
...
### <a name="known-issues-kubeadm-deployments"></a>Problemi noti: le distribuzioni kubeadm
...
### <a id="mssqlctlctp23"></a> Problemi noti: mssqlctl
...
### <a name="known-issues-external-tables"></a>Problemi noti: Tabelle esterne
...
### <a name="known-issues-application-deployment"></a>Problemi noti: Distribuzione dell'applicazione

- Quando si chiama un'applicazione di R, Python o MLeap dall'API REST, la chiamata con timeout di 5 minuti.

### <a name="known-issues-spark-and-notebooks"></a>Problemi noti: Spark e notebook
...
### <a name="known-issues-hdfs"></a>Problemi noti: HDFS
...
### <a name="known-issues-security"></a>Problemi noti: Sicurezza
