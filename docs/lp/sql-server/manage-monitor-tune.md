...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Gestire, monitorare e ottimizzare</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gestione del ciclo di vita del database</h3>
                                                    <p>Un approccio completo per la gestione dello schema, dei dati e dei metadati del database per un'applicazione di database.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Funzionalità di SQL Server che facilita la compressione dei dati in modo che occupino meno spazio su disco. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Posta elettronica database</h3>
                                                    <p>Soluzione aziendale per l'invio di messaggi di posta elettronica dal motore di database di SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gestione basata su criteri</h3>
                                                    <p>Sistema basato su criteri per la gestione di una o più istanze di SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Piani di manutenzione</h3>
                                                    <p>Configurare piani automatizzati per gestire SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Funzionalità di SQL Server che esegue attività amministrative pianificate. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gestione de log delle transazioni</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Eventi estesi</h3>
                                                    <p>Sistema generale di gestione degli eventi per sistemi SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQLDiag</h3>
                                                    <p>Utilità generica che raccoglie log e dati da SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Profiler</h3>
                                                    <p>Creare, gestire, analizzare e sostituire le tracce raccolte delle attività di SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Ottimizzazione automatica</h3>
                                                    <p>Nuova funzionalità di SQL 2017 che rileva automaticamente i potenziali problemi di prestazioni. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Ottimizzazione guidata motore di database</h3>
                                                    <p>Consente di analizzare i carichi di lavoro e fornisce consigli per migliorare le prestazioni.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Stima della cardinalità</h3>
                                                    <p>Stima il numero di righe che verranno restituite da una query e usate per la creazione del piano di esecuzione.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Indici</h3>
                                                    <p>Struttura su disco associata a una tabella o a una vista che consente di velocizzare il recupero dei dati.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>OLTP in memoria</h3>
                                                    <p>Opzione di ottimizzazione delle prestazioni che lascia intere tabelle in memoria.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Partizioni</h3>
                                                    <p>Consente di distribuire i dati in varie unità, ad esempio gruppi di file. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Guide di piano</h3>
                                                    <p>Funzionalità di SQL Server che consente l'input manuale di un piano di esecuzione per una query specifica.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Specifica i limiti per le quantità di CPU, I/O e memoria che possono usare le richieste dell'applicazione. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Statistiche</h3>
                                                    <p>Indica al motore di SQL Server come sono distribuiti i dati e come vengono usati per la creazione di piani di esecuzione.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
