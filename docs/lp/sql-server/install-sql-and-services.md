...
layout: HubPage
hide_bc: true
title: SQL Server - Installazione e aggiornamento
description: Informazioni su come installare o aggiornare SQL Server e i servizi correlati.
ms.topic: hub-page
ms.prod: sql
author: MashaMSFT
ms.author: mathoma
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Installare o aggiornare</h1>
                    ...
                    <li class="panelItem" data-index="0">
                        ...
                        <ul class="cardsD panelContent singlePanelContent" id="products1" style="margin-top: 0px; display: flex;">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Installare SQL Server</h3>
                                                    <p>Panoramica delle diverse opzioni disponibili per l'installazione di SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Installare SQL Server Analysis Services (SSAS)</h3>
                                                    <p>Motore di dati analitici che rende disponibili modelli di dati semantici di livello aziendale per report aziendali e applicazioni client quali Power BI, Excel, Reporting Services e altri report di visualizzazione dei dati di terze parti. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Installare SQL Server Integration Services (SSIS)</h3>
                                                    <p> Usare Integration Services per risolvere problemi aziendali complessi, tramite operazioni di copia o download di file, caricamento di data warehouse, pulizia dei dati e data mining e gestione di oggetti e dati di SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Installare SQL Server Reporting Services (SSRS)</h3>
                                                    <p>Soluzione per la creazione, la pubblicazione e la gestione di report, in modo da inviarli agli utenti giusti in diversi modi, tramite visualizzazione nel Web browser, in un dispositivo mobile o come messaggio di posta elettronica nella casella di posta in arrivo. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Eseguire l'aggiornamento di SQL Server</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Eseguire l'aggiornamento di SQL Server Analysis Services (SSAS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Eseguire l'aggiornamento di SQL Server Integration Services (SSIS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Eseguire l'aggiornamento di SQL Server Reporting Services (SSRS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                             ...
                             <li class="fullSpan">
                                <div class="container intro">
                                <h2>Eseguire la migrazione a SQL Server</h2> 
                            </li>
                             <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Servizio Migrazione del database di Azure</h3>
                                                    <p>Consente migrazioni semplificate da più origini di database alle piattaforme di dati di Azure con tempi di inattività minimi.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rileva problemi di compatibilità, consiglia miglioramenti per l'ambiente di destinazione e sposta i database e i dati.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Consente di automatizzare la migrazione di database a SQL Server da Microsoft Access, DB2, MySQL, Oracle e SAP ASE.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
