...
description: Riepilogo delle risorse disponibili per acquisire familiarità con SQL Server e il database SQL di Azure. Sono incluse guide introduttive ed esercitazioni, Microsoft Learn e LinkedIn Learning.
ms.topic: hub-page
ms.prod: sql
author: MashaMSFT
ms.author: mathoma
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Centro formazione</h1>
        <h2>Guide introduttive</h2>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>SQL Server 2017 in una macchina virtuale Windows</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Esecuzione di SQL Server in Linux</p> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Database singolo di database SQL di Azure</p> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Istanza gestita di database SQL di Azure</p> 
                                        </div>
                                    </div>
                                </div>
                            </div>
         ...
         <ul class="cardsF panelContent singlePanelContent" style="display:flex!important;">
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Motore di database di SQL Server</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Uso del tipo di dati hierarchyid</p> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                             <p>Firmare stored procedure con un certificato</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Catene di proprietà e cambio di contesto</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Amministrazione di server tramite la gestione basata su criteri</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Backup e ripristino di SQL Server nel servizio di archiviazione BLOB di Azure</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Uso del servizio di archiviazione BLOB di Microsoft Azure con i database di SQL Server 2016</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Scrittura di codice Transact-SQL</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                   ...
                   <h2>Guide ai meccanismi interni di SQL</h2>
                   <ul class="cardsF panelContent singlePanelContent" style="display:flex!important;">
                        <li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Processo di pulizia di record fantasma</h3>
                                            <p>Offre una panoramica del processo in background per l'eliminazione dei record dalle pagine contrassegnate per l'eliminazione.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Architettura e progettazione di indici</h3>
                                            <p>Contiene informazioni sull'architettura degli indici e le procedure consigliate che consentono di progettare indici efficaci.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Architettura di gestione della memoria</h3>
                                            <p>Illustra come viene gestita la memoria in SQL Server, oltre all'utilizzo della memoria durante la lettura e scrittura di pagine.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Architettura di pagine ed extent</h3>
                                            <p>Descrive le strutture dei dati usate per gestire pagine ed extent in tutte le versioni di SQL Server.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Ottimizzazione e convalida post-migrazione</h3>
                                            <p>Panoramica di alcuni scenari comuni relativi alle prestazioni rilevati dopo la migrazione a SQL Server con indicazione di come risolverli.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Architettura di elaborazione delle query</h3>
                                            <p>Descrive l'elaborazione delle query e l'ottimizzazione del riutilizzo delle query in SQL Server tramite la memorizzazione nella cache dei piani di esecuzione.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Architettura e gestione del log delle transazioni</h3>
                                            <p>Informazioni sull'architettura fisica e logica del log delle transazioni.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Architettura dei thread e delle attività</h3>
                                            <p>Illustra come SQL Server gestisce i thread e le attività, che consentono di definire i percorsi per la logica e l'esecuzione dell'applicazione. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Controllo delle versioni delle righe e blocco delle transazioni</h3>
                                            <p>Descrive i meccanismi di controllo delle versioni delle righe e di blocco usati dal motore di database di SQL Server per garantire l'integrità fisica di ogni transazione.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="container centered pageFooter">
        ...
        <ul class="links">
           <li>
                <a href="https://aka.ms/editsqldocs" data-linktype="external"> Contribuire alla documentazione di SQL </a>
            </li>
           <li>
                <a href="https://aka.ms/sqldocsurvey" data-linktype="external"> Commenti e suggerimenti sulla documentazione di SQL </a>
            </li>
           <li>
