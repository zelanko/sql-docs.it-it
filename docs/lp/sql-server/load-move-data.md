...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Eseguire la migrazione, caricare e spostare i dati</h1>
                    ...
                    <li class="panelItem" data-index="0">
                        ...
                        <ul class="cardsD panelContent singlePanelContent" id="products1" style="margin-top: 0px; display: flex;">
                            <li class="fullSpan">
                                ...
                                <h2>Eseguire la migrazione di database in SQL</h2>
                            </li>
                                                         <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>BCP</h3>
                                                    <p>Copia bulk di dati tra un file di dati, in un formato specificato dall'utente, e il database SQL.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Procedura guidata Importa file flat</h3>
                                                    <p>Usare la procedura guidata per copiare facilmente i dati da un file flat (con estensione csv, txt) nel database SQL. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>importazione ed esportazione guidate</h3>
                                                    <p>Usare la procedura guidata per copiare facilmente i dati da un'ampia gamma di origini nel database SQL. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
