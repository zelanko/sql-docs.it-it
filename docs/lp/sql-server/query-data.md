...
layout: HubPage
hide_bc: true
title: SQL Server - Eseguire query sui dati
description: Esplorare le funzionalità che rendono più semplice eseguire query sui dati nel database di SQL Server.
ms.topic: hub-page
ms.prod: sql
author: MashaMSFT
ms.author: mathoma
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Eseguire query sui dati</h1>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gli indici full-text includono una o più colonne basate su caratteri in una tabella e la ricerca full-text consente di eseguire query su tali indici.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Join</h3>
                                                    <p>Informazioni sulle diverse operazioni di ordinamento, intersezione e unione eseguite da SQL Server quando si usano i join. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sottoquery:</h3>
                                                    <p> Una sottoquery è una query nidificata in un'istruzione SELECT, INSERT, UPDATE o DELETE o in un'altra sottoquery. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sinonimi</h3>
                                                    <p>Oggetto di database che fornisce un livello di astrazione per proteggere un'applicazione client dalle modifiche apportate al nome o alla posizione di un oggetto di base. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Funzioni definite dall'utente</h3> 
                                                    <p>Routine che accettano parametri, eseguono un'azione e restituiscono il risultato di tale azione sotto forma di valore. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Progettazione di database</h3>
