...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md-winonly](../includes/appliesto-ss-xxxx-xxxx-xxx-md-winonly.md)]
 ...
 SQL Server servizio Launchpad attendibile supporta l'esecuzione di script esterni per R e Python. In SQL Server 2016 R Services, SP1 fornisce il servizio. SQL Server 2017 include il servizio Launchpad come parte dell'installazione iniziale.
...
Per informazioni su come concedere a questo gruppo di utenti le autorizzazioni necessarie, vedere [Install SQL Server 2016 R Services](install/sql-r-services-windows-install.md).
