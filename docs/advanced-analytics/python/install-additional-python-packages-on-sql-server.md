...
Per altre informazioni sui percorsi di installazione e posizione del pacchetto, vedere [ottenere R o Python informazioni sul pacchetto](../package-management/installed-package-information.md).
