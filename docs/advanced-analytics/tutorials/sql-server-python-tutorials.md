...
|------|-------------|
| [Avvio rapido: Script di Python "Hello world" in SQL Server](quickstart-python-run-using-t-sql.md) | Informazioni di base di come chiamare Python in T-SQL. |
| [Avvio rapido: Creare, eseguire il training e usare un modello Python con le stored procedure in SQL Server](quickstart-python-train-score-in-tsql.md) | Illustra la meccanica dell'incorporamento di codice Python in una stored procedure, fornire gli input e l'esecuzione di stored procedure. |
