...
description: Introduzione alla libreria di funzioni MicrosoftML in SQL Server 2016 R Services e SQL Server Machine Learning Services con R.
ms.prod: sql
