...
|------------------------------------|---------------------------|--------------|
| [Usare i gestori di pacchetti R convenzionali](use-r-package-managers-on-sql-server.md)  | Admin | Local |
