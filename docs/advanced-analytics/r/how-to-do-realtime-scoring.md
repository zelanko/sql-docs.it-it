...
description: Usare rxPredict o sp_rxPredict per il punteggio in tempo reale oppure prevedere T-SQL per il Punteggio nativo per le stime e la previsione in R e Python in SQL Server Machine Learning.
ms.prod: sql
