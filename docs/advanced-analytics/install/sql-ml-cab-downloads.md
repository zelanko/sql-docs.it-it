...
## <a name="sql-server-2017-cabs"></a>File CAB per SQL Server 2017
...
| | Microsoft R Open | [SRO_3.3.3.1900_1033.cab](https://go.microsoft.com/fwlink/?LinkId=2106367&clcid=1033) | Correzione del bug a causa del quale viene visualizzato un messaggio di avviso quando `sp_execute_external_script` esegue uno script R |
| | R Server| [SRS_9.2.0.1900_1033.cab](https://go.microsoft.com/fwlink/?LinkId=2106460&clcid=1033) | Nessuna modifica rispetto alle versioni precedenti. |
| | Microsoft Python Open | [SPO_9.2.0.1400_1033.cab](https://go.microsoft.com/fwlink/?LinkId=2073897&clcid=1033) | Nessuna modifica rispetto alle versioni precedenti. |
| | Server Python | [SPS_9.2.0.1900_1033.cab](https://go.microsoft.com/fwlink/?LinkId=2106459&clcid=1033) | Correzione del bug a causa del quale quando `sp_execute_external_script` esegue uno script Python a volte si perdono dati quando viene restituito il tipo di dati varbinary o binary a SQL Server sotto forma di OutputDataSet. |
...
| | Microsoft Python Open     | [SPO_9.2.0.1400_1033.cab](https://go.microsoft.com/fwlink/?LinkId=2073897&clcid=1033)| I file binari all'interno del pacchetto sono ora firmati. |
...
| | R Server      |[SRS_9.2.0.1300_1033.cab](https://go.microsoft.com/fwlink/?LinkId=2038263&clcid=1033)| Contiene una correzione per l'aggiornamento di [R Server autonomo reso operativo](https://docs.microsoft.com/machine-learning-server/what-is-operationalization), in quanto installato tramite il programma di installazione di SQL Server. Usare i file CAB CU13 e seguire [queste istruzioni](sql-machine-learning-standalone-windows-install.md#apply-cu) per applicare l'aggiornamento. |
...
| | Server Python    |[SPS_9.2.0.1300_1033.cab](https://go.microsoft.com/fwlink/?LinkId=2038197&clcid=1033)| Contiene una correzione per l'aggiornamento di [Python Server autonomo reso operativo](https://docs.microsoft.com/machine-learning-server/what-is-operationalization), in quanto installato tramite il programma di installazione di SQL Server. Usare i file CAB CU13 e seguire [queste istruzioni](sql-machine-learning-standalone-windows-install.md#apply-cu) per applicare l'aggiornamento. |
...
| | Microsoft Python Open     | [SPO_9.2.0.24_1033.cab](https://go.microsoft.com/fwlink/?LinkId=851502)| Nessuna modifica rispetto alle versioni precedenti. |
| | Server Python    |[SPS_9.2.0.1000_1033.cab](https://go.microsoft.com/fwlink/?LinkId=2006805&clcid=1033)| Quando vengono rimossi i duplicati, rx_data_step di Python perde l'ordine delle righe. <br/>SPEE non riesce a rilevare il tipo di dati nell'indice columnstore cluster. <br/>Quando tutte le colonne contengono valori Null, restituisce una tabella vuota. |
...
| | Microsoft Python Open     |[SPO_9.2.0.24_1033.cab](https://go.microsoft.com/fwlink/?LinkId=851502)| Nessuna modifica rispetto alle versioni precedenti. |
| | Server Python    |[SPS_9.2.0.300_1033.cab](https://go.microsoft.com/fwlink/?LinkId=863892)| Serializzazione dei modelli Python in revoscalepy tramite la [funzione rx_serialize_model](https://docs.microsoft.com/machine-learning-server/python-reference/revoscalepy/rx-serialize-model).<br/>Supporto dell'[assegnazione dei punteggi nativa](../sql-native-scoring.md) e miglioramenti all'[assegnazione dei punteggi in tempo reale](../real-time-scoring.md). 
...
| | Microsoft Python Open     | [SPO_9.2.0.24_1033.cab](https://go.microsoft.com/fwlink/?LinkId=851502)| Nessuna modifica rispetto alle versioni precedenti. | 
| | Server Python    |[SPS_9.2.0.100_1033.cab](https://go.microsoft.com/fwlink/?LinkId=851500) | Aggiunge rx_create_col_info per la restituzione delle informazioni sullo schema. <br/>Miglioramenti a [rx_exec](https://docs.microsoft.com/machine-learning-server/python-reference/revoscalepy/rx-exec) per il supporto di scenari paralleli tramite il contesto di calcolo `RxLocalParallel`.|
|**Versione iniziale** |  |  |
...
Se si vuole visualizzare il codice sorgente di Microsoft R, tale codice è disponibile per il download come archivio in formato tar: [Scaricare i programmi di installazione di R Server](https://docs.microsoft.com/machine-learning-server/install/r-server-install-windows#download)
