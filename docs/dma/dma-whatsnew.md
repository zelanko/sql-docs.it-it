...
## <a name="dma-v44"></a>Versione 4.4 DMA

Il rilascio della versione 4.4 di DMA fornisce supporto per il caricamento delle valutazioni in Azure Migrate.

## <a name="dma-v43"></a>V4.3 DMA
