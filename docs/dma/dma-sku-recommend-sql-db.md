...
- Ottieni i prezzi più recenti 
    ...
    - **/ SkuRecommendationRegionName**: L'area assegnare un nome (ad esempio "Stati Uniti occidentali").
...
- **MetricName** : se è stata eseguita una metrica.
