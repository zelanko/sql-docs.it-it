...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Ottenere una macchina virtuale di Azure con SQL Server</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="screenReader">Documentazione di Microsoft SQL</h1>
        <ul class="pivots">
            <li>
                              ...
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              <h3>SQL Server in Windows</h3>
                                              <ul class="noBullet">
                                              <li><a class="barLink" href="/sql/sql-server/sql-server-technical-documentation?toc=..%2ftoc%2ftoc.json"><strong>In locale</strong></a></li>
                                              <li><a class="barLink" href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview/"> <strong>In una macchina virtuale di Azure</strong></a></li>
                                              <li><a class="barLink" href="/sql/sql-server/what-s-new-in-sql-server-ver15/"><strong>Novità</strong></a></li>
                                              </ul>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              <h3>SQL come servizio di Azure</h3>
                                              <ul class="noBullet">
                                                  <li><a class="barLink" href="/azure/sql-database/"><strong>Database SQL di Azure</strong></a></li>
                                                  ...
                                                  <li><a class="barLink" href="https://azure.microsoft.com/updates/?status=all&product=sql-database"><strong>Novità</strong></a></li>
                                              </ul>
                                          </div>
                                      </div>
                                  </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SQL Server in Linux</h3>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/sql/linux/sql-server-linux-overview/"><strong>In locale</strong></a></li>
                                                    <li><a class="barLink" href="/sql/linux/quickstart-install-connect-clouds/"><strong>In una macchina virtuale di Azure</strong></a></li>
                                                    <li><a class="barLink" href="/sql/linux/sql-server-linux-whats-new/"><strong>Novità</strong></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Installare o aggiornare</h3>
                                                          <p>Documentazione che illustra in dettaglio come installare e aggiornare sia SQL Server che i servizi associati.</p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Continuità aziendale</h3>
                                                          <p><b>Disponibilità elevata, ripristino di emergenza, gruppo di disponibilità Always On, istanza del cluster di failover Always On, mirroring del database, backup e ripristino</b></p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Security</h3>
                                                          <p><b>Autorizzazioni, gestione degli accessi, Always Encrypted, TDE, SSL</b></p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Eseguire la migrazione, caricare e spostare i dati</h3>
                                                          <p><b>Migration Assistant, Integration Services (SSIS), importazione/esportazione guidata, replica </b> </p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Informazioni su SQL Server</h3>
                                                          <p>Informazioni sugli elementi interni dell'architettura di SQL Server con una serie di guide ed esercitazioni. </p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                                  ...
                                                  <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                          <li><a class="barLink" href="/sql/relational-databases/database-features/">Concetti di database relazionali</a></li>
                                                            <li><a class="barLink" href="/sql/connect/homepage-sql-connection-programming/">Connettersi con applicazioni client in locale</a></li>
                                                            <li><a class="barLink" href="/azure/sql-database/sql-database-libraries">Librerie di connettività del database SQL di Azure</a></li>
                                                            <li><a class="barLink" href="https://docs.microsoft.com/azure/sql-database/sql-database-develop-overview">Applicazioni del database SQL di Azure</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                  <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            ...
                                                            <li><a class="barLink" href="/sql/tools/overview-sql-tools">Altri strumenti di SQL</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="cardSize">
                                            <div class="cardPadding">
                                                ...
                                                <ul class="noBullet">
                                                     <li><a class="barLink" href="/dotnet/api/?view=sqlserver-2017">API SQL .NET SDK</a></li>
                                                     <li><a class="barLink" href="/sql/t-sql/language-reference">Transact-SQL (T-SQL)</a></li>
                                                     <li><a class="barLink" href="/sql/samples/sql-samples-where-are/">Esempi di database</a></li>
                                                     <li><a class="barLink" href="/previous-versions/sql/">Contenuto archiviato (SQL 2005-2012)</a></li>
                                                </ul></td></tr></table>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                  <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            ...
                                                            <li><a class="barLink" href="/power-bi/service-get-started/">Servizio Power BI</a></li>
                                                            <li><a class="barLink" href="/power-bi/report-server/get-started/">Server di report di Power BI</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                  <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                        <li><a class="barLink" href="/sql/analytics-platform-system/">Piattaforma di strumenti analitici Microsoft</a></li>
                                                            ...
                                                            <li><a class="barLink" href="/sql/relational-databases/polybase/polybase-guide/">PolyBase</a></li>                                                            <li><a class="barLink" href="/sql/big-data-cluster/big-data-cluster-overview/">Cluster big data di SQL Server 2019</a></li>
                                                       </ul>
                                                    </div>
                                                </div>
                                            </div>
