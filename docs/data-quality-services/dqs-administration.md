...
|Viene descritto come configurare le impostazioni avanzate per la registrazione DQS.|[Configure Advanced Settings for DQS Log Files](../data-quality-services/configure-advanced-settings-for-dqs-log-files.md)|  
