---
title: Lo sviluppatore di dati SQL | Microsoft Docs
ms.custom: ''
ms.date: 03/28/2017
ms.prod: sql
...
* [I driver del Client SQL](sql-connection-libraries.md): driver di uso di SQL per la connessione, eseguire una query, aggiornare, inserire o eliminare i dati da un database SQL.
* [Entity Framework](https://msdn.microsoft.com/library/gg696172.aspx): utilizzo di Entity Framework per accedere facilmente ai database tramite LINQ, con accesso diretto a SQL Server e la possibilità di controllare il mapping tra Entity Data Model (EDM) e le strutture relazionali non elaborate. 
* [Windows Communication Foundation (WCF)](https://msdn.microsoft.com/library/dd456779.aspx): utilizzare i servizi dati per una soluzione praticamente pronta all'uso facilmente creare e utilizzare servizi OData in web e intranet
* [Framework di sincronizzazione](https://msdn.microsoft.com/library/jj839436.aspx): usare il Framework di sincronizzazione per consentire l'accesso offline per qualsiasi tipo di dati, qualsiasi archivio dati, un qualsiasi protocollo di trasferimento e qualsiasi topologia di rete.
* [Reactive Extensions](https://msdn.microsoft.com/library/hh242985.aspx): usare il Reactive Extension (Rx) per eseguire la programmazione flusso eventi e semplificare la programmazione asincrona utilizzando sequenze osservabili e operatori di query in stile LINQ.  Usare le estensioni reattive per JavaScript (RxJS) per semplificare la programmazione asincrona basato su callback e guidati da eventi sul web utilizzando sequenze osservabili.
...
* [SQLXML 4.0](../relational-databases/sqlxml/sqlxml-4-0-programming-concepts.md): usare SQLXML 4.0 per esportare i dati relazionali in XML.
