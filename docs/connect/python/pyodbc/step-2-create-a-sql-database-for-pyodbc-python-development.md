...
description: Il passaggio 2 di questa guida introduttiva prevede la creazione di un database in SQL Server o nel database SQL di Azure per questo esempio pyodbc.
ms.custom: ''
ms.date: 08/08/2017
ms.prod: sql
