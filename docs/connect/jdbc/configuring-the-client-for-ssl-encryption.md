...
description: Informazioni sulla crittografia lato client e sui certificati per garantire la sicurezza dei client che usano Microsoft JDBC Driver per SQL Server.
ms.custom: ''
ms.date: 09/12/2019
ms.prod: sql
