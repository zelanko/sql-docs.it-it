---
title: Informazioni sul Driver JDBC aggiuntive | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|Risorsa|Descrizione|  
|--------------|-----------------|  
|[Driver JDBC per il Repository GitHub SQL Server](https://github.com/microsoft/mssql-jdbc)|Questo repository contiene il codice sorgente per il Driver JDBC per SQL Server. Usare questo sito per interagire direttamente con i membri del team del driver JDBC. Qui è possibile registrare i problemi, inviare commenti e suggerimenti e contribuiscono direttamente al driver.|
...
|[Blog di JDBC](https://go.microsoft.com/fwlink/?LinkId=124746)|Questo blog è utilizzato per fornire informazioni sul [!INCLUDE[jdbcNoVersion](../../includes/jdbcnoversion_md.md)].|  
