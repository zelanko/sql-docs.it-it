...
description: Quando ci si connette al database usando Microsoft JDBC Driver per SQL Server, tutte le interazioni con il database passano attraverso l'oggetto SQLServerConnection.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
...
|[Connessione a un database SQL di Azure](../../connect/jdbc/connecting-to-an-azure-sql-database.md)|Vengono descritti i problemi di connettività per i database in Azure SQL.|  
