...
## <a name="remarks"></a>Remarks  
 ...
 Utilizzo di questo metodo per la **immagine**, **testo**, e **ntext** [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] i tipi di dati potrebbero compromettere le prestazioni.  
