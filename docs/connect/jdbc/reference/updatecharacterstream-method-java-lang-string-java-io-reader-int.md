---
description: Metodo updateCharacterStream (java.lang.String, java.io.Reader, int)
title: Metodo updateCharacterStream (java.lang.String, java.io.Reader, int)
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
