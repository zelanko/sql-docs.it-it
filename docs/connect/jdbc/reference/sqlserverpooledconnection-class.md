...
## <a name="remarks"></a>Osservazioni  
 La classe SQLServerPooledConnection fornisce metodi per la gestione del pool di connessioni con l'apposito strumento. In genere le applicazioni non creano direttamente un'istanza di queste connessioni.  
