...
## <a name="remarks"></a>Remarks  
 Questo metodo supportsCatalogInDataManipulation viene specificato dal metodo supportsCatalogInDataManipulation nell'interfaccia DatabaseMetaData.  
