...
## <a name="remarks"></a>Remarks  
 Questo metodo supportsResultSetHoldability viene specificato dal metodo supportsResultSetHoldability nell'interfaccia java. SQL. DatabaseMetaData.  
