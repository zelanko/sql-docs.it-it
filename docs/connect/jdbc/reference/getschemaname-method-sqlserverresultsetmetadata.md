---
title: Metodo getSchemaName (SQLServerResultSetMetaData) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Questo metodo getSchemaName viene specificato dal metodo getSchemaName nell'interfaccia ResultSetMetaData.  
