...
## <a name="remarks"></a>Osservazioni  
 Questo metodo supportsSchemasInPrivilegeDefinitions viene specificato dal metodo supportsSchemasInPrivilegeDefinitions nell'interfaccia java.sql.DatabaseMetaData.  
