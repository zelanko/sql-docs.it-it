...
ms.locfileid: "66772849"
---
# <a name="sqlservercallablestatement-methods"></a>Metodi di SQLServerCallableStatement
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Per informazioni sui membri di SQLServerCallableStatement, vedere [i membri di SQLServerCallableStatement](../../../connect/jdbc/reference/sqlservercallablestatement-members.md).  
