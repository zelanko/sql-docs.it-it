...
## <a name="remarks"></a>Remarks  
 Questo metodo supportsCatalogsInProcedureCalls viene specificato dal metodo supportsCatalogsInProcedureCalls nell'interfaccia DatabaseMetaData.  
