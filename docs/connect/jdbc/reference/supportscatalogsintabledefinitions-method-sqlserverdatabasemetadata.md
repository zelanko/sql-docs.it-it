...
## <a name="remarks"></a>Remarks  
 Questo metodo supportsCatalogsInTableDefinitions viene specificato dal metodo supportsCatalogsInTableDefinitions nell'interfaccia DatabaseMetaData.  
