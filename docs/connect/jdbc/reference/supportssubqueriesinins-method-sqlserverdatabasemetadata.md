...
## <a name="remarks"></a>Osservazioni  
 Questo metodo supportsSubqueriesInIns viene specificato dal metodo supportsSubqueriesInIns nell'interfaccia java.sql.DatabaseMetaData.  
