---
description: Metodo supportsCatalogsInPrivilegeDefinitions (SQLServerDatabaseMetaData)
...
## <a name="remarks"></a>Osservazioni  
 Questo metodo supportsCatalogsInPrivilegeDefinitions viene specificato dal metodo supportsCatalogsInPrivilegeDefinitions nell'interfaccia java.sql.DatabaseMetaData.  
