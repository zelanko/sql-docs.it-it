...
## <a name="remarks"></a>Remarks  
 Questo metodo supportsOrderByUnrelated viene specificato dal metodo supportsOrderByUnrelated nell'interfaccia java. SQL. DatabaseMetaData.  
