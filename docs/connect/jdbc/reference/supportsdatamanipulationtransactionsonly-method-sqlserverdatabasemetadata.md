...
## <a name="remarks"></a>Remarks  
 Questo metodo supportsDataManipulationTransactionsOnly viene specificato dal metodo supportsDataManipulationTransactionsOnly nell'interfaccia DatabaseMetaData.  
