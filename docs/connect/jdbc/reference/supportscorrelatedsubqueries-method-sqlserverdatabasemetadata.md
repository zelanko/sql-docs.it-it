...
## <a name="remarks"></a>Osservazioni  
 Questo metodo supportsCorrelatedSubqueries viene specificato dal metodo supportsCorrelatedSubqueries nell'interfaccia java.sql.DatabaseMetaData.  
