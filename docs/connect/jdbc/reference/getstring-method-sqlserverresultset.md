---
title: Metodo getString (SQLServerResultSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "67979387"
---
# <a name="getstring-method-sqlserverresultset"></a>Metodo getString (SQLServerResultSet)
...
|nome|Descrizione|  
|----------|-----------------|  
|[getString (int)](../../../connect/jdbc/reference/getstring-method-int-sqlserverresultset.md)|Recupera il valore dell'indice di colonna designato nella riga corrente di questo oggetto [SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) come **String** nel linguaggio di programmazione Java.|  
