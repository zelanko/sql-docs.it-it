---
description: Metodo setBinaryStream (int, java.io.InputStream, int)
title: Metodo setBinaryStream (int, java.io.InputStream, int) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 *length*  
 ...
 Valore **int** che indica il numero di byte.  
