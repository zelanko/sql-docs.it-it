---
title: Membri di SQLServerResource | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Nelle tabelle seguenti sono elencati i membri esposti dalla classe [SQLServerResource](../../../connect/jdbc/reference/sqlserverresource-class.md).  
