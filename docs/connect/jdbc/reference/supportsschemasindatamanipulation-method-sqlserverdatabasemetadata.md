...
## <a name="remarks"></a>Remarks  
 Questo metodo supportsSchemasInDataManipulation viene specificato dal metodo supportsSchemasInDataManipulation nell'interfaccia java. SQL. DatabaseMetaData.  
