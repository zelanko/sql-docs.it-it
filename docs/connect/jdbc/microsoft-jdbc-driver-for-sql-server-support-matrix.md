...
|-|-|-|-|  
|Microsoft JDBC Driver 8.2 per SQL Server|8.2|mssql-jdbc-8.2.1.jre13.jar<br> mssql-jdbc-8.2.1.jre11.jar<br> mssql-jdbc-8.2.1.jre8.jar|26 febbraio 2025|
