---
title: Diagnosi dei problemi relativi al driver JDBC
description: Informazioni su come diagnosticare e risolvere problemi come la gestione degli errori, il controllo della versione del driver e la traccia.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
...
|-----------|-----------------|  
|[Gestione degli errori](../../connect/jdbc/handling-errors.md)|Descrive come gestire gli errori restituiti da [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|  
...
|[Creazione di tracce](../../connect/jdbc/tracing-driver-operation.md)|Viene descritto come abilitare la traccia quando si utilizza il driver JDBC.|  
