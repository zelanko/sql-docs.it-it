...
* [Passaggio 1: Configurare l'ambiente di sviluppo per lo sviluppo Java](../../connect/jdbc/step-1-configure-development-environment-for-java-development.md)  
* [Passaggio 2: Creare un database SQL per lo sviluppo Java](../../connect/jdbc/step-2-create-a-sql-database-for-java-development.md)  
