---
title: Informazioni sulle differenze tra i tipi di dati
description: Informazioni sulle differenze tra i tipi di dati del linguaggio di programmazione Java e i tipi di dati di SQL Server e su come JDBC Driver per SQL Server rende più semplici le conversioni.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
