...
description: Informazioni sulla connettività JDBC e su come risolvere i potenziali problemi di connessione quando si usa Microsoft JDBC Driver per SQL Server.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
