---
title: Always Encrypted con enclave sicure | Microsoft Docs
ms.custom: ''
ms.date: 01/29/2020
ms.prod: sql
...
ms.locfileid: "77004710"
---
# <a name="using-always-encrypted-with-the-secure-enclaves"></a>Uso di Always Encrypted con enclave sicure
