---
description: Informazioni sui tipi di cursore
...
|Set di risultati<br /><br /> risultati (cursore)|Tipo di cursore di SQL Server|Caratteristiche|Proprietà<br /><br /> Metodo|response<br /><br /> responseBuffering|Descrizione|  
|------------------------------------|----------------------------|---------------------|-----------------------|----------------------------|-----------------|  
...
|TYPE_SCROLL_INSENSITIVE|Static|Scorrevole, non aggiornabile<br /><br /> Gli aggiornamenti, gli inserimenti e le eliminazioni di righe eseguiti esternamente non sono visibili.|N/D|N/D|L'applicazione richiede uno snapshot del database. Il set di risultati non è aggiornabile. È supportato solo CONCUR_READ_ONLY.  Tutti gli altri tipi di concorrenza generano un'eccezione, se utilizzati con questo tipo di cursore.<br /><br /> Le righe vengono recuperate dal server in blocchi specificati dalla dimensione di recupero.|  
...
|TYPE_SS_SCROLL_STATIC|Static|Gli aggiornamenti di altri utenti non vengono riflessi.|N/D|N/D|Valore intero = 1004. L'applicazione richiede uno snapshot del database. Si tratta del sinonimo specifico di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] per il tipo JDBC TYPE_SCROLL_INSENSITIVE ed è caratterizzato dallo stesso comportamento dell'impostazione di concorrenza.<br /><br /> Le righe vengono recuperate dal server in blocchi specificati dalla dimensione di recupero.|  
