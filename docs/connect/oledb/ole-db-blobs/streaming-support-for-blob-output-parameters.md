---
title: Supporto del flusso per parametri di output BLOB (OLE DB driver)
description: Informazioni sul supporto del flusso in OLE DB Driver per SQL Server per i parametri di output BLOB. Questo esempio associa parametri BLOB come ISequentialStreams.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
