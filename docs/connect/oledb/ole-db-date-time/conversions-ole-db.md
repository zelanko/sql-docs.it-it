...
description: Informazioni su come OLE DB Driver per SQL Server esegue la conversione tra i valori datetime e datetimeoffset. Vi sono diverse regole di conversione generali.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
