...
description: Informazioni sulle notifiche delle query che consentono di comunicare alle applicazioni che i dati sono stati modificati in OLE DB Driver per SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
