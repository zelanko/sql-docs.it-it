...
description: Informazioni sulle modalità di supporto delle colonne di tipo sparse in OLE DB Driver per SQL Server e sulle colonne di tipo sparse in SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
