...
description: Informazioni sui tipi di dati XML con OLE DB Driver per SQL Server, che consentono di archiviare documenti e frammenti XML in un database SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
