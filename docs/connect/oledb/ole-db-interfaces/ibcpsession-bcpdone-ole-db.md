...
description: Informazioni su come il metodo IBCPSession::BCPDone consente di eseguire il commit delle righe rimanenti da inviare a SQL Server in OLE DB Driver per SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
