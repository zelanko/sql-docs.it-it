...
description: Informazioni sui vantaggi della chiamata di una stored procedure nell'origine dati e sui meccanismi offerti da OLE DB Driver per SQL Server per la restituzione dei dati.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
