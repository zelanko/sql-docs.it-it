...
description: Il set di righe LINKEDSERVERS enumera le origini dati dell'organizzazione che possono partecipare alle query distribuite di OLE DB Driver per SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
