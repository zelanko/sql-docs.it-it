...
description: Informazioni sul supporto offerto da OLE DB Driver per SQL Server per le colonne di tipo sparse, che sono colonne ottimizzate per l'archiviazione dei valori null.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
