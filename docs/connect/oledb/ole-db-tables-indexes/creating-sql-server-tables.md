...
description: Creazione di tabelle SQL Server tramite OLE DB driver per SQL Server
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
## <a name="dbcolumndesc-usage"></a>Utilizzo di DBCOLUMNDESC  
 Il consumer può indicare un tipo di dati della colonna tramite il membro *pwszTypeName* o il membro *wType*. Se il consumer specifica il tipo di dati in *pwszTypeName*, il driver OLE DB per SQL Server ignora il valore di *wType*.  
 ...
 Il driver OLE DB per SQL Server riconosce un subset di valori DBTYPE enumerati OLE DB nel membro *wType* . Per altre informazioni, vedere [mapping dei tipi di dati in ITableDefinition](../../oledb/ole-db-data-types/data-type-mapping-in-itabledefinition.md).  
