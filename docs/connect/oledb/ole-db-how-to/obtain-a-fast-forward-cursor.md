---
title: Ottenere un cursore FAST_FORWARD (OLE DB Driver)
description: Informazioni ed esempi su come impostare le proprietà del set di righe per ottenere un cursore FAST_FORWARD usando OLE DB Driver per SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
