...
description: Informazioni su come i dati di grandi dimensioni possono essere associati o recuperati usando l'interfaccia ISequentialStream in OLE DB Driver per SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
3.  Recuperare i dati delle colonne usando **IRow::Open()** o **IRow::GetColumns()** .  
