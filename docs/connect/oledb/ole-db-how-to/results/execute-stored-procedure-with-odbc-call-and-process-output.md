...
description: Informazioni su come elaborare i codici restituiti e i parametri di output in OLE DB Driver per SQL Server, che vengono ricevuti nel pacchetto finale dopo il rilascio del set di righe.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
