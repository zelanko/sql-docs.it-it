...
description: Informazioni ed esempi su come eseguire stored procedure di SQL Server con RPC ed elaborare i codici restituiti e i parametri di output.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
