---
title: Recuperare righe usando segnalibri (OLE DB Driver)
description: Informazioni ed esempi su come i consumer possono recuperare le righe usando i segnalibri in OLE DB Driver per SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
