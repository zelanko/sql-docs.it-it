...
description: Informazioni su come usare un'interfaccia ISequentialStream associata a un parametro ICommandText per inviare una quantità di dati compresa tra 4 MB e 4 GB a una colonna FileStream con questo esempio.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
