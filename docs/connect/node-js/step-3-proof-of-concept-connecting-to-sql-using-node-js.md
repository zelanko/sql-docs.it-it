---
title: 'Passaggio 3: Connessione a SQL tramite Node.js'
description: Questo esempio deve essere considerato come un modello di verifica che illustra come connettersi a SQL tramite node.js ed è semplificato per chiarezza.
ms.custom: ''
ms.date: 07/23/2019
ms.prod: sql
