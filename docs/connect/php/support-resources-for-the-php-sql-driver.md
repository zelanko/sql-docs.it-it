...
La documentazione di SQL Server e Transact-SQL è reperibile in [Documentazione di SQL Server](../../sql-server/sql-server-technical-documentation.md).  
