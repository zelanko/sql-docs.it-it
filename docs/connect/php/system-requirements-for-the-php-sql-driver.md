...
|PHP per la versione del driver SQL Server&#8594;<br />&#8595;Versione del Driver ODBC|5.6|5.3|5.2|4.3|4.0|3.2|3.1|
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
|php_sqlsrv_73_ts.dll 32 bit <br />php_pdo_sqlsrv_73_ts.dll 32 bit |7.3|sì|php7ts.dll 32 bit|  
