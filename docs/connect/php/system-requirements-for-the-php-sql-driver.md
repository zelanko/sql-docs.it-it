...
|PHP per la versione del driver SQL Server&#8594;<br />&#8595; Versione PHP|5.6|5.3|5.2|4.3|4.0|3.2|3.1|
|:---:|---|---|---|---|---|---|---|
|7.3|7.3.0+ | | | | | | |
...
-   È necessario un server Web. Il server Web deve essere configurato per eseguire PHP. Per informazioni sull'hosting di applicazioni PHP con IIS, vedere la [esercitazione sul sito web di PHP](http://docs.php.net/manual/da/install.windows.iis7.php).
...
|PHP per la versione del driver SQL Server&#8594;<br />&#8595; Versione driver ODBC|5.6|5.3|5.2|4.3|4.0|3.2|3.1|
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
|PHP per la versione del driver SQL Server&#8594;<br />&#8595; Versione di SQL Server|5.6|5.3|5.2|4.3|4.0|3.2|3.1|
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
Come indicato di seguito sono riportati i sistemi operativi supportati per ogni versione del driver:

|PHP per la versione del driver SQL Server&#8594;<br />&#8595; Sistema operativo|5.6|5.3|5.2|4.3|4.0|3.2|3.1|
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
|php_sqlsrv_71_ts.dll 32 bit <br />php_pdo_sqlsrv_71_ts.dll a 32 bit |7.1|sì|php7ts.dll 32 bit|  
...
|php_sqlsrv_72_ts.dll 32 bit <br />php_pdo_sqlsrv_72_ts.dll a 32 bit |7.2|sì|php7ts.dll 32 bit|  
...
|php_sqlsrv_73_nts.dll 32 bit<br />php_pdo_sqlsrv_73_nts.dll 32 bit|7.3|no |php7.dll 32 bit|  
|php_sqlsrv_73_ts.dll 32 bit <br />php_pdo_sqlsrv_73_ts.dll a 32 bit |7.3|sì|php7ts.dll 32 bit|  
...
|php_sqlsrv_7_ts.dll 32 bit  <br />php_pdo_sqlsrv_7_ts.dll a 32 bit  |7.0|sì|php7ts.dll 32 bit|
