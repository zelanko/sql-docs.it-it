---
title: Uso di Always Encrypted con i driver PHP per SQL Server
description: Informazioni su come usare Always Encrypted con i driver PHP per SQL Server per proteggere i dati sensibili nell'applicazione.
ms.date: 12/12/2019
ms.prod: sql
