---
title: sqlsrv_errors
description: Informazioni di riferimento sulle API per la funzione sqlsrv_errors nel driver Microsoft SQLSRV per PHP per SQL Server.
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
