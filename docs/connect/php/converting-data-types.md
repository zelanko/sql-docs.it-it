...
|---------|---------------|  
|[Tipi di dati di SQL Server predefiniti](../../connect/php/default-sql-server-data-types.md)|Vengono fornite informazioni sui tipi di dati predefiniti di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] per l'invio di dati al server.|  
