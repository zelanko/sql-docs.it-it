---
title: 'Procedura: Gestire errori e avvisi usando il driver SQLSRV'
description: Informazioni su come gestire gli errori e gli avvisi quando si usa il driver Microsoft SQLSRV per PHP per SQL Server
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
