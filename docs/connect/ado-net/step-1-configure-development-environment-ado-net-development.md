...
- :::image type="icon" source="../../ssms/media/download-icon.png"::: [Per scaricare e installare .NET Framework, incluso ADO.NET](../sql-connection-libraries.md#anchor-20-drivers-relational-access)
...
- :::image type="icon" source="../../ssms/media/download-icon.png"::: [Per scaricare e installare .NET Core](../sql-connection-libraries.md#anchor-20-drivers-relational-access)
