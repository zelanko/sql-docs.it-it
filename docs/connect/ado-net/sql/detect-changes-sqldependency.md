...
description: Viene illustrato come rilevare il momento in cui i risultati della query si differenziano da quelli ricevuti in origine.
ms.date: 09/30/2019
dev_langs:
- csharp
