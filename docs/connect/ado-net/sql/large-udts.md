...
description: Viene illustrato come recuperare i dati dai tipi definiti dall'utente con valori di grandi dimensioni introdotti in SQL Server 2008.
ms.date: 08/15/2019
dev_langs:
- csharp
