...
description: Viene descritto come eseguire più operazioni di copia bulk dei dati in un'istanza di SQL Server utilizzando la classe SqlBulkCopy.
ms.date: 08/15/2019
dev_langs:
- csharp
