...
description: L'applicazione di esempio C++ dimostra come usare le API ODBC per connettersi e accedere a un database SQL.
ms.custom: ''
ms.date: 07/08/2019
ms.prod: sql
...
## <a name="c-odbcsqlsln-code"></a>C. Codice odbcsql.sln
...
## <a name="d-odbcsqlvcxproj-code"></a>D. Codice odbcsql.vcxproj
