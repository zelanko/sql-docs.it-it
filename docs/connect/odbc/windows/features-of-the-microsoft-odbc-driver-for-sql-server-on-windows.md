---
title: Funzionalità di Microsoft ODBC Driver
description: Informazioni sulle diverse funzionalità supportate da Microsoft ODBC Driver for SQL Server in Windows.
ms.custom: ''
ms.date: 05/06/2020
ms.prod: sql
...
Il driver ODBC per [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] supporta il [pool di connessioni compatibile con il driver](../../../odbc/reference/develop-app/driver-aware-connection-pooling.md). Per altre informazioni, vedere [Pool di connessioni compatibile con il driver nel driver ODBC per SQL Server | Microsoft Docs](driver-aware-connection-pooling-in-the-odbc-driver-for-sql-server.md).  
  
### <a name="asynchronous-execution-notification-method"></a>Esecuzione asincrona (metodo di notifica)  
ODBC Driver for [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] supporta l'[esecuzione asincrona (metodo di notifica)](../../../odbc/reference/develop-app/asynchronous-execution-notification-method.md). Per un esempio d'uso, vedere [Asynchronous Execution &#40;Notification Method&#41; Sample](asynchronous-execution-notification-method-sample.md) (Esempio di esecuzione asincrona - metodo di notifica).  
  
### <a name="connection-resiliency"></a>Resilienza della connessione
Per garantire che le applicazioni rimangano connesse a un database SQL di Microsoft Azure, il driver ODBC in Windows può ripristinare le connessioni inattive. Per altre informazioni, vedere [Resilienza di connessione nel driver ODBC di Windows](connection-resiliency-in-the-windows-odbc-driver.md).  
...
[Microsoft ODBC Driver for SQL Server in Windows](microsoft-odbc-driver-for-sql-server-on-windows.md)  
