...
Il driver ODBC 13 e 13,1 per [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], oltre a quello precedente, supporta SQL Server 2016. 
...
-   Windows Vista SP2 *(solo driver ODBC 11)*  
-   Windows 7  
-   Windows 8
-   Windows 8.1
-   Windows 10
