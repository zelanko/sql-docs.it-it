...
|ActiveDirectoryMsi|SQL_AU_AD_MSI|Autenticazione tramite identità gestite di Azure Active Directory. Per l'identità assegnata dall'utente, UID è impostato sull'ID oggetto dell'identità utente. |
