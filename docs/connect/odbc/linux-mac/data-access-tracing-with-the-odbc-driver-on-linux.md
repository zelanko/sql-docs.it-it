---
title: Traccia di accesso ai dati con il driver ODBC in Linux e macOS
description: Informazioni su come abilitare la traccia in Linux e macOS con Microsoft ODBC Driver for SQL Server per l'output di un file di log durante la risoluzione dei problemi di comportamento dell'applicazione.
ms.custom: ''
ms.date: 09/01/2020
ms.prod: sql
