...
- [Sicurezza SQL Server: Forum MSDN](https://social.msdn.microsoft.com/Forums/en-US/home?forum=sqlsecurity&filter=alltypes&sort=lastpostdesc)
- [Exchange Stack DBA (tag SQL-Server): porre domande SQL Server](https://dba.stackexchange.com/questions/tagged/sql-server)
- [Stack Overflow (tag SQL-Server): risposte alle domande sullo sviluppo SQL](https://stackoverflow.com/questions/tagged/sql-server) 
- [Reddit: discussione generale sulle SQL Server](https://www.reddit.com/r/SQLServer/)
