...
[!INCLUDE[name-sos](../includes/name-sos-short.md)] fornisce anche funzionalità per creare frammenti di codice T-SQL personalizzati. Per altre informazioni, vedere [creazione e uso di frammenti di codice](code-snippets.md).
