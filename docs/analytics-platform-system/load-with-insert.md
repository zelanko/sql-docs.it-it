...
|Tipo di valore letterale|Formato|Regole di conversione|  
|----------------|----------|--------------------|  
|Valore letterale stringa|Formato: "carattere stringa'<br /><br />Esempio: 'abc'| Nessuna|  
|Valore letterale stringa Unicode|Formato: Stringa N'character'<br /><br />Esempio: N'abc'|  Nessuna |  
|Valore letterale integer|Formato: nnnnnnnnnnn<br /><br />Esempio: 321312313123| Nessuna |  
|Valore letterale decimale|Formato: nnnnnn.nnnnnnn<br /><br />Esempio: 12344.34455| Nessuna |  
