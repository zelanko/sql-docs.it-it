---
title: Nomi di database riservati
description: Nomi di database riservati nella piattaforma Analytics System Parallel data warehouse.
author: mzaman1
ms.prod: sql
...
Un nome di database riservato è un nome che non può essere assegnato a un database utente in SQL Server PDW.  
  
Elenco dei nomi di database riservati:  
