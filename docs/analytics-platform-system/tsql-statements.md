...
* [FORMATO DI TRASCINAMENTO DEI FILE ESTERNI](../t-sql/statements/drop-external-file-format-transact-sql.md)
...
* [Uso di PIVOT e UNPIVOT](../t-sql/queries/from-using-pivot-and-unpivot.md)
...
* [MODIFICA UTENTE](../t-sql/statements/alter-user-transact-sql.md)
...
Per altre informazioni, vedere [elementi del linguaggio T-SQL](tsql-language-elements.md) e [viste di sistema T-SQL](tsql-system-views.md).
