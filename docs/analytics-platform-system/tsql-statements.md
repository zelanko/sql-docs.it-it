...
* [CREA INDICE COLUMNSTORE](../t-sql/statements/create-columnstore-index-transact-sql.md)
* [CREA DATABASE](../t-sql/statements/create-database-azure-sql-data-warehouse.md)
* [CREA CREDENZIALI CON AMBITO DATABASE](../t-sql/statements/create-database-scoped-credential-transact-sql.md)
* [CREARE UN'ORIGINE DATI ESTERNA](../t-sql/statements/create-external-data-source-transact-sql.md)
* [CREA FORMATO FILE ESTERNO](../t-sql/statements/create-external-file-format-transact-sql.md)
* [CREA TABELLA ESTERNA](../t-sql/statements/create-external-table-transact-sql.md)
* [CREATE (FUNZIONE)](../t-sql/statements/create-function-sql-data-warehouse.md)
* [CREA INDICE](../t-sql/statements/create-index-transact-sql.md)
* [CREA PROCEDURA](../t-sql/statements/create-procedure-transact-sql.md)
* [CREA SCHEMA](../t-sql/statements/create-schema-transact-sql.md)
...
* [CREA VISTA](../t-sql/statements/create-view-transact-sql.md)
...
* [RINOMINARE](../t-sql/statements/rename-transact-sql.md)
* [TRUNCATE TABLE](../t-sql/statements/truncate-table-transact-sql.md)
* [AGGIORNA STATISTICHE](../t-sql/statements/update-statistics-transact-sql.md)

## <a name="data-manipulation-language-dml-statements"></a>Istruzioni DML (Data Manipulation Language)
* [ELIMINARE](../t-sql/statements/delete-transact-sql.md)
* [INSERIRE](../t-sql/statements/insert-transact-sql.md)
* [AGGIORNAMENTO](../t-sql/queries/update-transact-sql.md)
...
* [Selezionare](../t-sql/queries/select-transact-sql.md)
...
* [ILLUSTRANO](../t-sql/queries/explain-transact-sql.md)
* [Da](../t-sql/queries/from-transact-sql.md)
...
* [IN cui](../t-sql/queries/where-transact-sql.md)
* [In alto](../t-sql/queries/top-transact-sql.md)
...
* [CHIUDI CHIAVE MASTER](../t-sql/statements/close-master-key-transact-sql.md)
...
* [ELIMINA CHIAVE MASTER](../t-sql/statements/drop-master-key-transact-sql.md)
* [RILASCIA RUOLO](../t-sql/statements/drop-role-transact-sql.md)
* [ELIMINA UTENTE](../t-sql/statements/drop-user-transact-sql.md)
* [APRI CHIAVE MASTER](../t-sql/statements/open-master-key-transact-sql.md)
