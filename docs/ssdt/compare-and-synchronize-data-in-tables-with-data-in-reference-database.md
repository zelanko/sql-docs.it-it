...
description: Informazioni su come confrontare i dati di due database diversi. Scoprire come sincronizzare i dati e come visualizzare lo script usato per il processo di sincronizzazione.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
