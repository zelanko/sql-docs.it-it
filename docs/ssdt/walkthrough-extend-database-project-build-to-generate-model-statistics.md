...
-   Definire una classe denominata ModelStatistics che erediti da [BuildContributor](https://msdn.microsoft.com/library/microsoft.sqlserver.dac.deployment.buildcontributor.aspx).  
