---
title: Compatibilità di Framework applicazione livello dati | Microsoft Docs
ms.custom:
- SSDT
ms.date: 02/09/2017
ms.prod: sql
...
È possibile scaricare una versione più recente di SSDT da [Installare la versione più recente di SQL Server Data Tools](https://docs.microsoft.com/sql/ssdt/download-sql-server-data-tools-ssdt).  
