...
### <a name="a-generate-dump-files-for-errors"></a>R. Generare file di dump per gli errori
...
### <a name="b-generate-dump-files-for-events"></a>B. Generare file di dump per gli eventi
