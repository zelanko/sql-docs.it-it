---
description: Guida (F1) di Microsoft Connector for SAP BW
...
-   [Editor gestione connessione SAP BW](./connection-manager/sap-bw-connection-manager.md)  
