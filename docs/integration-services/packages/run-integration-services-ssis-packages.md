---
description: Eseguire pacchetti di Integration Services (SSIS)
...
## <a name="execute-package-dialog-box"></a><a name="execute_package_dialog"></a> Finestra di dialogo Esecuzione pacchetto
