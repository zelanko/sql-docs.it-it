---
description: Guida di riferimento ai messaggi e agli errori di Integration Services
...
>|0xC0010009|-1073676279|DTS_E_ELEMENTNOTFOUND|Impossibile trovare l'elemento in una raccolta. Questo errore si verifica quando si prova a recuperare un elemento da una raccolta in un contenitore durante l'esecuzione del pacchetto e l'elemento non esiste.|  
...
>|0xC0202010|-1071636464|DTS_E_DESTINATIONFLATFILEREQUIRED|Nessun nome di file flat di destinazione specificato. Verificare che per la gestione connessione file flat sia configurata una stringa di connessione. Se la gestione connessione file flat è utilizzata da più componenti, verificare che la stringa di connessione includa un numero sufficiente di nomi di file.|  
...
>|0xC0208030|-1071611856|DTS_E_IMAGEDATATYPENOTSUPPORTED|Il tipo di dati per "%1" è DT_IMAGE e non è supportato. Utilizzare in alternativa il tipo di dati DT_TEXT o DT_NTEXT e convertire i dati dal o al tipo DT_IMAGE utilizzando il componente per la conversione dei dati.|  
...
>|0x8001F205|-2147356155|DTS_W_LOGPROVIDERNOTDEFINED|Copia del file eseguibile "%1" completata. Tuttavia, un provider di log associato al file eseguibile non è stato trovato nella raccolta "LogProviders".  Il file eseguibile è stato copiato senza le informazioni sul provider di log.|  
...
>|0x80208375|-2145352843|DTS_W_XMLSRCOUTPUTCOLUMNLENGTHSETTODEFAULT|Lunghezza massima non specificata per %1 con tipo di dati esterno %2. Verrà utilizzato il tipo di dati "%3" dell'attività Flusso di dati SSIS con una lunghezza di %4!d! .|  
