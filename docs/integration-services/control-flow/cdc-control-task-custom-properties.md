...
|OperationParameter|Stringa|Proprietà attualmente usata con l'operazione **MarkCdcStart** . Questo parametro ammette input aggiuntivo necessario per l'operazione specifica, ad esempio il numero LSN necessario per l'operazione **MarkCdcStart** .|  
