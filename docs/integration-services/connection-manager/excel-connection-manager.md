...
-   Indicare se la prima riga nei fogli di lavoro o negli intervalli selezionati contiene i nomi delle colonne.  
 ...
 Per altre informazioni sulle proprietà che è possibile impostare in Progettazione [!INCLUDE[ssIS](../../includes/ssis-md.md)] , vedere [Editor gestione connessione Excel]().  
