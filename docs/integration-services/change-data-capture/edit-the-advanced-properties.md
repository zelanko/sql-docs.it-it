...
2.  Digitare un valore valido per la proprietà nella colonna **Value** .  
 ...
 Per una descrizione delle proprietà che è possibile immettere, vedere la tabella delle opzioni disponibili in [cdc.xdbcdc_config](../../integration-services/change-data-capture/the-oracle-cdc-databases.md#BKMK_cdcxdbcdc_config).  
