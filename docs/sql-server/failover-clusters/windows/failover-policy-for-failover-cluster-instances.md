---
title: Criteri di failover per istanze del cluster di failover
description: Descrizione dei diversi criteri di failover disponibili per un'istanza del cluster di failover di SQL Server.
