...
- [Aggiungere funzionalità a un'istanza di SQL Server 2016 (programma di installazione)](../../../database-engine/install-windows/add-features-to-an-instance-of-sql-server-setup.md)