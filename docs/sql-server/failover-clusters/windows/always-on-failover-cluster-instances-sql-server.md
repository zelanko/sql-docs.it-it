...
description: Informazioni sulle istanze del cluster di failover Always On che forniscono disponibilità elevata locale tramite ridondanza a livello di istanza di server in SQL Server.
