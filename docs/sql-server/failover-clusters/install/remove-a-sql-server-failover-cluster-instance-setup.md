...
description: Usare questa procedura per disinstallare un'istanza del cluster di failover di SQL Server. Questo articolo include importanti considerazioni di cui tenere conto prima di procedere.
