---
description: Inviare tramite posta elettronica un file di query collegamento (componente aggiuntivo MDS per Excel)
title: Inviare tramite posta elettronica un file di query collegamento
