...
description: Informazioni su come aggiungere un utente all'elenco utenti in Gestione dati master. È necessario aggiungere un utente per iniziare il processo di assegnazione dell'autorizzazione all'applicazione Web.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
