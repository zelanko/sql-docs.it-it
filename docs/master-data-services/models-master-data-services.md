---
title: Modelli
description: Un modello definisce la struttura di dati nella soluzione di gestione dati master. I modelli rappresentano il livello più elevato di organizzazione dei dati in Master Data Services.
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
ms.prod_service: mds
