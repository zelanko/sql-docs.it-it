...
description: Utilizzare una gerarchia esplicita per organizzare i membri da un'entità Master Data Services nel modo desiderato, anziché in base a relazioni tra attributi basati su dominio.
ms.custom: ''
ms.date: 04/01/2016
ms.prod: sql
ms.prod_service: mds
