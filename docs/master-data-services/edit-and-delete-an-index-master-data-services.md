---
description: Modificare ed eliminare un indice (Master Data Services)
title: Modificare ed eliminare un indice
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
...
1.  Nella pagina **Gestisci modello** selezionare un modello dalla griglia e quindi fare clic su **entità**.  
