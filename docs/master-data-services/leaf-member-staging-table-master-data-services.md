...
---
# <a name="leaf-member-staging-table-master-data-services"></a>Leaf Member Staging Table (Master Data Services)
...
|**ErrorCode**|Visualizza un codice di errore. Per tutti i record con **ImportStatus_ID** di **2**, vedere [Staging Process Errors &#40;Master Data Services&#41;](../master-data-services/staging-process-errors-master-data-services.md).||  
