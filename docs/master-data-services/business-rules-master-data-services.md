...
description: Informazioni sulle regole business in Master Data Services, che consente di aggiornare i dati, inviare messaggi di posta elettronica o avviare un processo di business o un flusso di lavoro.
ms.custom: ''
ms.date: 03/18/2017
ms.prod: sql
ms.prod_service: mds
